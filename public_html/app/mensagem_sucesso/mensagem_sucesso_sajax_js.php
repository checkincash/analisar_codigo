  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_mensagem_sucesso" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate cnpj
  function do_ajax_mensagem_sucesso_validate_cnpj()
  {
    var nomeCampo_cnpj = "cnpj";
    var var_cnpj = scAjaxGetFieldHidden(nomeCampo_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_mensagem_sucesso_validate_cnpj(var_cnpj, var_script_case_init, do_ajax_mensagem_sucesso_validate_cnpj_cb);
  } // do_ajax_mensagem_sucesso_validate_cnpj

  function do_ajax_mensagem_sucesso_validate_cnpj_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_mensagem_sucesso_validate_cnpj_cb

  // ---------- Validate razao
  function do_ajax_mensagem_sucesso_validate_razao()
  {
    var nomeCampo_razao = "razao";
    var var_razao = scAjaxGetFieldText(nomeCampo_razao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_mensagem_sucesso_validate_razao(var_razao, var_script_case_init, do_ajax_mensagem_sucesso_validate_razao_cb);
  } // do_ajax_mensagem_sucesso_validate_razao

  function do_ajax_mensagem_sucesso_validate_razao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "razao";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_mensagem_sucesso_validate_razao_cb

  // ---------- Validate email
  function do_ajax_mensagem_sucesso_validate_email()
  {
  } // do_ajax_mensagem_sucesso_validate_email

  function do_ajax_mensagem_sucesso_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "email";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_mensagem_sucesso_validate_email_cb

  // ---------- Validate msg
  function do_ajax_mensagem_sucesso_validate_msg()
  {
  } // do_ajax_mensagem_sucesso_validate_msg

  function do_ajax_mensagem_sucesso_validate_msg_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "msg";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_mensagem_sucesso_validate_msg_cb
  // ---------- Form
  function do_ajax_mensagem_sucesso_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_mensagem_sucesso_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_mensagem_sucesso_submit_form(var_cnpj, var_razao, var_email, var_msg, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_mensagem_sucesso_submit_form_cb);
  } // do_ajax_mensagem_sucesso_submit_form

  function do_ajax_mensagem_sucesso_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_mensagem_sucesso_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_mensagem_sucesso_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_mensagem_sucesso_navigate_form(var_pk_contrato, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_mensagem_sucesso_navigate_form_cb);
  } // do_ajax_mensagem_sucesso_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['mensagem_sucesso']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_mensagem_sucesso_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_mensagem_sucesso_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_mensagem_sucesso_navigate_form_cb
  function sc_hide_mensagem_sucesso_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_mensagem_sucesso_form
