...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["msg" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["msg" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["msg" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_cnpj' + iSeqRow).bind('blur', function() { sc_mensagem_sucesso_cnpj_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_mensagem_sucesso_cnpj_onfocus(this, iSeqRow) });
  $('#id_sc_field_razao' + iSeqRow).bind('blur', function() { sc_mensagem_sucesso_razao_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_mensagem_sucesso_razao_onfocus(this, iSeqRow) });
  $('#id_sc_field_email' + iSeqRow).bind('blur', function() { sc_mensagem_sucesso_email_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_mensagem_sucesso_email_onfocus(this, iSeqRow) });
  $('#id_sc_field_msg' + iSeqRow).bind('blur', function() { sc_mensagem_sucesso_msg_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_mensagem_sucesso_msg_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_mensagem_sucesso_cnpj_onblur(oThis, iSeqRow) {
  do_ajax_mensagem_sucesso_mob_validate_cnpj();
  scCssBlur(oThis);
}

function sc_mensagem_sucesso_cnpj_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_mensagem_sucesso_razao_onblur(oThis, iSeqRow) {
  do_ajax_mensagem_sucesso_mob_validate_razao();
  scCssBlur(oThis);
}

function sc_mensagem_sucesso_razao_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_mensagem_sucesso_email_onblur(oThis, iSeqRow) {
  do_ajax_mensagem_sucesso_mob_validate_email();
  scCssBlur(oThis);
}

function sc_mensagem_sucesso_email_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_mensagem_sucesso_msg_onblur(oThis, iSeqRow) {
  do_ajax_mensagem_sucesso_mob_validate_msg();
  scCssBlur(oThis);
}

function sc_mensagem_sucesso_msg_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
