...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'cidade':
      case 'estado':
        sc_exib_ocult_pag('form_ap_contrato_publicador_reserva_mob_form0');
        break;
      case 'pdesconto':
      case 'destaque':
      case 'foto_publicacao':
      case 'texto_publicacao':
        sc_exib_ocult_pag('form_ap_contrato_publicador_reserva_mob_form1');
        break;
    }
  }
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_foto_publicacao" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_ap_contrato_publicador_reserva_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
