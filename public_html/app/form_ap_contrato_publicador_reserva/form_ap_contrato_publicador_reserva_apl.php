<?php
//
class form_ap_contrato_publicador_reserva_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->usr_cnpj)) 
          {
              $_SESSION['usr_cnpj'] = $this->usr_cnpj;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_ap_contrato_publicador_reserva_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['initialize'])
          {
              $_SESSION['scriptcase']['form_ap_contrato_publicador_reserva']['contr_erro'] = 'on';
         ?>
...
$_SESSION['scriptcase']['form_ap_contrato_publicador_reserva']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_publicador_reserva']['upload_field_info']['foto_publicacao'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_ap_contrato_publicador_reserva',
      ...
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_ap_contrato_publicador_reserva']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_ap_contrato_publicador_reserva'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_ap_contrato_publicador_reserva']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_ap_contrato_publicador_reserva']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_ap_contrato_publicador_reserva') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_ap_contrato_publicador_reserva']['label'] = "CHECK-IN cash ";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_ap_contrato_publicador_reserva")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_ap_contrato_publicador_reserva']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_ap_contrato_publicador_reserva'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['upload_field_ul_name'][$this->foto_publicacao_ul_name]))
          {
              $this->NM_ajax_info['param']['foto_publicacao_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['upload_field_ul_name'][$this->foto_publicacao_ul_name];
          }
      ...
      elseif (isset($this->foto_publicacao_ul_name) && '' != $this->foto_publicacao_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['upload_field_ul_name'][$this->foto_publicacao_ul_name]))
          {
              $this->foto_publicacao_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['upload_field_ul_name'][$this->foto_publicacao_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_orig'] = " where fk_contrato = ( select pk_contrato from ap_contrato where cnpj = '" . $_SESSION['usr_cnpj'] . "')";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_pesq'] = " where fk_contrato = ( select pk_contrato from ap_contrato where cnpj = '" . $_SESSION['usr_cnpj'] . "')";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_publicador_reserva']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_ap_contrato_publicador_reserva'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_ap_contrato_publicador_reserva'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_ap_contrato_publicador_reserva", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_ap_contrato_publicador_reserva/form_ap_contrato_publicador_reserva_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_ap_contrato_publicador_reserva_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_ap_contrato_publicador_reserva_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_ap_contrato_publicador_reserva_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_ap_contrato_publicador_reserva/form_ap_contrato_publicador_reserva_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_ap_contrato_publicador_reserva_erro.class.php"); 
      }
      $this->Erro      = new form_ap_contrato_publicador_reserva_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['opcao']))
         { 
             if ($this->pk_publicador != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_publicador_reserva']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['final'];
      }
      else
      {
      }
...
$_SESSION['scriptcase']['form_ap_contrato_publicador_reserva']['contr_erro'] = 'off'; 
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['recarga'] = $this->nmgp_opcao;
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_ap_contrato_publicador_reserva']) || !is_array($this->NM_ajax_info['errList']['geral_form_ap_contrato_publicador_reserva']))
              {
                  $this->NM_ajax_info['errList']['geral_form_ap_contrato_publicador_reserva'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_ap_contrato_publicador_reserva'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_ap_contrato_publicador_reserva' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_ap_contrato_publicador_reserva']['contr_erro'] = 'off'; 
    ...
    function ValidateField_nomenclatura(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['php_cmp_required']['nomenclatura']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['php_cmp_required']['nomenclatura'] == "on")) 
      { 
    ...
    function ValidateField_cep(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['php_cmp_required']['cep']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['php_cmp_required']['cep'] == "on") 
           { 
              $Campos_Falta[] = "Cep" ; 
              if (!isset($Campos_Erros['cep']))
              {
    ...
    function ValidateField_bairro(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['php_cmp_required']['bairro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['php_cmp_required']['bairro'] == "on")) 
      { 
          if ($this->bairro == "")  
          { 
              $Campos_Falta[] =  "Bairro" ; 
    ...
    function ValidateField_rua(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['php_cmp_required']['rua']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['php_cmp_required']['rua'] == "on")) 
      { 
          if ($this->rua == "")  
          { 
              $Campos_Falta[] =  "Rua" ; 
    ...
    function ValidateField_numero(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['php_cmp_required']['numero']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['php_cmp_required']['numero'] == "on")) 
      { 
          if ($this->numero == "")  
          { 
              $Campos_Falta[] =  "Numero" ; 
    ...
    function ValidateField_cidade(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['php_cmp_required']['cidade']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['php_cmp_required']['cidade'] == "on")) 
      { 
          if ($this->cidade == "")  
          { 
              $Campos_Falta[] =  "Cidade" ; 
    ...
    function ValidateField_estado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['php_cmp_required']['estado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['php_cmp_required']['estado'] == "on")) 
      { 
          if ($this->estado == "")  
          { 
              $Campos_Falta[] =  "Estado" ; 
    ...
    function ValidateField_pdesconto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['php_cmp_required']['pdesconto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['php_cmp_required']['pdesconto'] == "on") 
           { 
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'form_ap_contrato_publicador_reserva_doc_name.php';
              }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['pk_publicador']['keyVal'] = form_ap_contrato_publicador_reserva_pack_protect_string($this->nmgp_dados_form['pk_publicador']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_ap_contrato_publicador_reserva_pack_protect_string('0') => form_ap_contrato_publicador_reserva_pack_protect_string("Ativo"));
$aLookup[] = array(form_ap_contrato_publicador_reserva_pack_protect_string('1') => form_ap_contrato_publicador_reserva_pack_protect_string("Inativo"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['Lookup_situacao'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['Lookup_situacao'][] = '1';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['situacao']['valList'][$i] = form_ap_contrato_publicador_reserva_pack_protect_string($v);
          }
...
$aLookup[] = array(form_ap_contrato_publicador_reserva_pack_protect_string('1') => form_ap_contrato_publicador_reserva_pack_protect_string("Em Destaque"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['Lookup_destaque'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['destaque']['valList'][$i] = form_ap_contrato_publicador_reserva_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_texto_publicacao($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
$_SESSION['scriptcase']['form_ap_contrato_publicador_reserva']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $this->longitude = $this->longitude_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['db_changed'] = true;
              ...
              $this->nmgp_refresh_fields = array_diff(array('situacao', 'data_criacao', 'nomenclatura', 'cep', 'bairro', 'rua', 'numero', 'complemento', 'cidade', 'estado', 'pdesconto', 'destaque', 'texto_publicacao'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['parms'] = "pk_publicador?#?$this->pk_publicador?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      ...
      { 
          ...
          $qt_geral_reg_form_ap_contrato_publicador_reserva = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['total'] = $qt_geral_reg_form_ap_contrato_publicador_reserva;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->pk_publicador))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_ap_contrato_publicador_reserva = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['reg_start'] > $qt_geral_reg_form_ap_contrato_publicador_reserva)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['reg_start'] = $qt_geral_reg_form_ap_contrato_publicador_reserva; 
          }
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['reg_start'] = 0;
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['parms'] = "pk_publicador?#?$this->pk_publicador?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['sub_dir'][0]  = "" . $_SESSION['pastacliente'];
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['reg_start'] < $qt_geral_reg_form_ap_contrato_publicador_reserva;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['opcao']   = '';
          }
      } 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out1_foto_publicacao))
       {
        ...
        include_once("form_ap_contrato_publicador_reserva_form0.php");
        include_once("form_ap_contrato_publicador_reserva_form1.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_filter_form'] . " and (fk_contrato = ( select pk_contrato from ap_contrato where cnpj = '" . $_SESSION['usr_cnpj'] . "')) and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_ap_contrato_publicador_reserva = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['total'] = $qt_geral_reg_form_ap_contrato_publicador_reserva;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_ap_contrato_publicador_reserva_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_ap_contrato_publicador_reserva_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_ap_contrato_publicador_reserva_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['masterValue']))
{
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_reserva']['retorno_edit'] = "";
   }
