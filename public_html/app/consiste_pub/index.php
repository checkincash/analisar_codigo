<?php
   include_once('consiste_pub_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['consiste_pub']['glo_nm_perfil']          = "conn_checkin";
   $_SESSION['scriptcase']['consiste_pub']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['consiste_pub']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['consiste_pub']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['consiste_pub']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['consiste_pub']['glo_nm_path_doc']        = "";
//
class consiste_pub_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['decimal_db'] = "."; 

      $this->nm_cod_apl      = "consiste_pub"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20170903"; 
      $this->nm_hr_criacao   = "105442"; 
...
// 
      ...
      //check prod
      if(empty($_SESSION['scriptcase']['consiste_pub']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['consiste_pub']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
      //check img
      if(empty($_SESSION['scriptcase']['consiste_pub']['glo_nm_path_imagens']))
      {
              /*check img*/$_SESSION['scriptcase']['consiste_pub']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
      }
      //check tmp
      if(empty($_SESSION['scriptcase']['consiste_pub']['glo_nm_path_imag_temp']))
      {
              /*check tmp*/$_SESSION['scriptcase']['consiste_pub']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
      }
      //check doc
      if(empty($_SESSION['scriptcase']['consiste_pub']['glo_nm_path_doc']))
      {
              /*check doc*/$_SESSION['scriptcase']['consiste_pub']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
      }
      //end check publication with the prod
      $this->sc_site_ssl     = (isset($_SERVER['HTTP_REFERER']) && strtolower(substr($_SERVER['HTTP_REFERER'], 0, 5)) == 'https') ? true : false;
      $this->sc_protocolo    = ($this->sc_site_ssl) ? 'https://' : 'http://';
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['consiste_pub']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['consiste_pub']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['consiste_pub']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['consiste_pub']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['consiste_pub']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/consiste_pub';
      ...
      {
          include_once("consiste_pub_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['consiste_pub']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['compact_mode']    = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["consiste_pub"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["consiste_pub"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['consiste_pub']['glo_nm_conexao']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['consiste_pub']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['consiste_pub']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['consiste_pub']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "consiste_pub_erro.class.php"); 
      $this->Erro = new consiste_pub_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('consiste_pub'); 
// 
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['consiste_pub']['glo_nm_conexao']) && $_SESSION['scriptcase']['consiste_pub']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['consiste_pub']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['consiste_pub']['glo_nm_perfil']) && $_SESSION['scriptcase']['consiste_pub']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['consiste_pub']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['consiste_pub']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['consiste_pub']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['consiste_pub']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['consiste_pub']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['consiste_pub']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['consiste_pub']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['consiste_pub']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['consiste_pub']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['consiste_pub']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['consiste_pub']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['consiste_pub']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['consiste_pub']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['consiste_pub']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['consiste_pub']['glo_nm_conexao'], $this->root . $this->path_prod, 'CheckIn'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['consiste_pub']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new consiste_pub_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consiste_pub']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['consiste_pub']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['consiste_pub']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['consiste_pub'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['consiste_pub']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['consiste_pub']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('consiste_pub') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['consiste_pub']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['consiste_pub']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['consiste_pub']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['consiste_pub']['exit'];
      }
      $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "consiste_pub_erro.class.php"); 
      $this->Erro      = new consiste_pub_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['scriptcase']['consiste_pub']['contr_erro'] = 'on';
if (!isset($_SESSION['usr_cnpj'])) {$_SESSION['usr_cnpj'] = "";}
...
$check_where = "fk_contrato =  (select pk_contrato from ap_contrato where cnpj = '". $this->sc_temp_usr_cnpj ."' )"; 
...
else
{
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('form_ap_contrato_publicador_cliente') . "/", $this->nm_location, "","_self", 440, 630, "ret_self");
 };

}
if (isset($this->sc_temp_usr_cnpj)) {$_SESSION['usr_cnpj'] = $this->sc_temp_usr_cnpj;}
$_SESSION['scriptcase']['consiste_pub']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
if (!isset($this->sc_temp_usr_cnpj)) {$this->sc_temp_usr_cnpj = (isset($_SESSION['usr_cnpj'])) ? $_SESSION['usr_cnpj'] : "";}
			...
			$check_sql = "SELECT pk_contrato "
			   . " FROM ap_contrato "
			   . " WHERE cnpj = '" . $this->sc_temp_usr_cnpj . "'";
...
;
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('form_ap_contrato_publicador_cliente') . "/", $this->nm_location, "","_self", 440, 630);
 };
if (isset($this->sc_temp_usr_cnpj)) {$_SESSION['usr_cnpj'] = $this->sc_temp_usr_cnpj;}
$_SESSION['scriptcase']['consiste_pub']['contr_erro'] = 'off';
}
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['consiste_pub'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['consiste_pub']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['consiste_pub']['iframe_print'] )
      {
          $target = "_parent";
      }
   ?>
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_consiste_pub($nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if (isset($_POST["usr_cnpj"])) 
   {
       ...
       nm_limpa_str_consiste_pub($_SESSION["usr_cnpj"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['consiste_pub']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['consiste_pub']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['consiste_pub']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "consiste_pub";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'consiste_pub' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['consiste_pub']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['consiste_pub']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['consiste_pub']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['consiste_pub']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['consiste_pub']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('consiste_pub' == $sReferer || 'consiste_pub_' == substr($sReferer, 0, 13))
       {
           $_SESSION['sc_session'][$script_case_init]['consiste_pub']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'consiste_pub')
   {
       $_SESSION['sc_session'][$script_case_init]['consiste_pub']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['consiste_pub']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/consiste_pub_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_consiste_pub($cadapar[1]);
   ...
   $contr_consiste_pub = new consiste_pub_apl();
   $contr_consiste_pub->controle();
//
   function nm_limpa_str_consiste_pub(&$str)
   {
