<?php
  ...
  $this->arr_buttons['bcalendarimport']['image'] = 'scriptcase__NM__nm_ScriptCase6_SoftOrange_bcalendarimport.gif';
  ...
  $this->arr_buttons['bcalendarcancel']['image'] = 'scriptcase__NM__nm_ScriptCase6_SoftOrange_bcalendarcancel.gif';
