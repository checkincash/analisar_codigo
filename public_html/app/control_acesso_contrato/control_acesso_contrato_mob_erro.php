...
$old_error_handler = set_error_handler("control_acesso_contrato_mob_scriptcase_error_handler");

function control_acesso_contrato_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['control_acesso_contrato_mob']['contr_erro']) && $_SESSION['scriptcase']['control_acesso_contrato_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_acesso_contrato_mob->contr_control_acesso_contrato_mob->Apl_com_erro = true;
            if ($inicial_control_acesso_contrato_mob->contr_control_acesso_contrato_mob->NM_ajax_flag)
            {
                $inicial_control_acesso_contrato_mob->contr_control_acesso_contrato_mob->NM_ajax_info['errList']['geral_control_acesso_contrato_mob'][] = $msg;
                return;
            }
            control_acesso_contrato_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_acesso_contrato_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_acesso_contrato_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['control_acesso_contrato_mob'])  ? $_SESSION['scriptcase']['error_icon']['control_acesso_contrato_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_acesso_contrato_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['control_acesso_contrato_mob']) ? $_SESSION['scriptcase']['error_span_title']['control_acesso_contrato_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_acesso_contrato_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_acesso_contrato_mob']) ? $_SESSION['scriptcase']['error_icon_title']['control_acesso_contrato_mob'] : '';
?>
