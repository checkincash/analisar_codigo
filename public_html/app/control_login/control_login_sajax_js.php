...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate cnpj
  function do_ajax_control_login_validate_cnpj()
  {
    var nomeCampo_cnpj = "cnpj";
    var var_cnpj = scAjaxGetFieldText(nomeCampo_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_login_validate_cnpj(var_cnpj, var_script_case_init, do_ajax_control_login_validate_cnpj_cb);
  } // do_ajax_control_login_validate_cnpj

  function do_ajax_control_login_validate_cnpj_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_login_validate_cnpj_cb
  ...
  // ---------- Validate esqueci
  function do_ajax_control_login_validate_esqueci()
  {
    var nomeCampo_esqueci = "esqueci";
    var var_esqueci = scAjaxGetFieldText(nomeCampo_esqueci);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_login_validate_esqueci(var_esqueci, var_script_case_init, do_ajax_control_login_validate_esqueci_cb);
  } // do_ajax_control_login_validate_esqueci

  function do_ajax_control_login_validate_esqueci_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "esqueci";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_login_validate_esqueci_cb
  // ---------- Form
  function do_ajax_control_login_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_control_login_submit_form(var_cnpj, var_senha, var_esqueci, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_captcha_code, var_csrf_token, do_ajax_control_login_submit_form_cb);
...
?>
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_login']['dashboard_info']['parent_widget'] ?>";
