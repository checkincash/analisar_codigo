...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate cnpj
  function do_ajax_control_login_mob_validate_cnpj()
  {
    var nomeCampo_cnpj = "cnpj";
    var var_cnpj = scAjaxGetFieldText(nomeCampo_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_login_mob_validate_cnpj(var_cnpj, var_script_case_init, do_ajax_control_login_mob_validate_cnpj_cb);
  } // do_ajax_control_login_mob_validate_cnpj

  function do_ajax_control_login_mob_validate_cnpj_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_login_mob_validate_cnpj_cb
  ...
  // ---------- Validate esqueci
  function do_ajax_control_login_mob_validate_esqueci()
  {
    var nomeCampo_esqueci = "esqueci";
    var var_esqueci = scAjaxGetFieldText(nomeCampo_esqueci);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_login_mob_validate_esqueci(var_esqueci, var_script_case_init, do_ajax_control_login_mob_validate_esqueci_cb);
  } // do_ajax_control_login_mob_validate_esqueci

  function do_ajax_control_login_mob_validate_esqueci_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "esqueci";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_login_mob_validate_esqueci_cb
  // ---------- Form
  function do_ajax_control_login_mob_submit_form()
  {
    ...
    var var_esqueci = scAjaxGetFieldText("esqueci");
    ...
    scAjaxProcOn();
    x_ajax_control_login_mob_submit_form(var_cnpj, var_senha, var_esqueci, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_captcha_code, var_csrf_token, do_ajax_control_login_mob_submit_form_cb);
...
?>
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_login_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  ...
  ajax_field_list[2] = "esqueci";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "cnpj": {"label": "<h4>CNPJ/CPF</h4>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "senha": {"label": "<h4>SENHA</h4>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "esqueci": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["esqueci"][1] = "esqueci";
  ...
  var ajax_field_id = {
    ...
    "esqueci": new Array("hidden_field_label_esqueci", "hidden_field_data_esqueci")
  };
