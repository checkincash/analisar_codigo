<?php
//
class form_ap_contrato_updt_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['classificacao1']))
          {
              $this->classificacao1 = $this->NM_ajax_info['param']['classificacao1'];
          }
          if (isset($this->NM_ajax_info['param']['classificacao2']))
          {
              $this->classificacao2 = $this->NM_ajax_info['param']['classificacao2'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['retype_senha']))
          {
              $this->retype_senha = $this->NM_ajax_info['param']['retype_senha'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['website']))
          {
              $this->website = $this->NM_ajax_info['param']['website'];
          }
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->usr_cnpj)) 
          {
              $_SESSION['usr_cnpj'] = $this->usr_cnpj;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_ap_contrato_updt_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['initialize'])
          {
              $_SESSION['scriptcase']['form_ap_contrato_updt_mob']['contr_erro'] = 'on';
             ?>
...
$_SESSION['scriptcase']['form_ap_contrato_updt_mob']['contr_erro'] = 'off';
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob'][$I_conf]  = $Conf_opt;
              }
          }
          }
          $this->Ini->init2();
      ...
      $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt_mob']['upload_field_info']['fachada'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_ap_contrato_updt_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
          'upload_type'        => 'single',
          'upload_allowed_type'  => '/\.(jpg|png)$/i',
          'upload_max_size'  => null,
          'upload_file_height' => '325',
          'upload_file_width'  => '325',
          'upload_file_aspect' => 'S',
          'upload_file_type'   => 'I',
      );

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_ap_contrato_updt_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_ap_contrato_updt_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_ap_contrato_updt_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_ap_contrato_updt_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_ap_contrato_updt_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_ap_contrato_updt_mob']['label'] = "CHECK-IN CASH | REGISTRO DE CONTRATO";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_ap_contrato_updt_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_ap_contrato_updt_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_ap_contrato_updt_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['upload_field_ul_name'][$this->fachada_ul_name]))
          {
              $this->NM_ajax_info['param']['fachada_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['upload_field_ul_name'][$this->fachada_ul_name];
          }
      ...
      elseif (isset($this->fachada_ul_name) && '' != $this->fachada_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['upload_field_ul_name'][$this->fachada_ul_name]))
          {
              $this->fachada_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['upload_field_ul_name'][$this->fachada_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_orig'] = " where cnpj = '" . $_SESSION['usr_cnpj'] . "'";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_pesq'] = " where cnpj = '" . $_SESSION['usr_cnpj'] . "'";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_ap_contrato_updt_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_ap_contrato_updt_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_form'];
          ...
          if ($this->nmgp_opcao == "incluir" && $this->nmgp_dados_form['razao'] != "null"){$this->razao = $this->nmgp_dados_form['razao'];} 
          if (!isset($this->datacadastro)){$this->datacadastro = $this->nmgp_dados_form['datacadastro'];} 
          if ($this->nmgp_opcao == "incluir" && $this->nmgp_dados_form['cidade'] != "null"){$this->cidade = $this->nmgp_dados_form['cidade'];} 
          if ($this->nmgp_opcao == "incluir" && $this->nmgp_dados_form['estado'] != "null"){$this->estado = $this->nmgp_dados_form['estado'];} 
          if ($this->nmgp_opcao == "incluir" && $this->nmgp_dados_form['bairro'] != "null"){$this->bairro = $this->nmgp_dados_form['bairro'];} 
          if ($this->nmgp_opcao == "incluir" && $this->nmgp_dados_form['rua'] != "null"){$this->rua = $this->nmgp_dados_form['rua'];} 
          if ($this->nmgp_opcao == "incluir" && $this->nmgp_dados_form['complemento'] != "null"){$this->complemento = $this->nmgp_dados_form['complemento'];} 
          if ($this->nmgp_opcao == "incluir" && $this->nmgp_dados_form['numero'] != "null"){$this->numero = $this->nmgp_dados_form['numero'];} 
          if ($this->nmgp_opcao == "incluir" && $this->nmgp_dados_form['cep'] != "null"){$this->cep = $this->nmgp_dados_form['cep'];} 
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_ap_contrato_updt_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_ap_contrato_updt_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_ap_contrato_updt_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_ap_contrato_updt/form_ap_contrato_updt_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_ap_contrato_updt_mob_erro.class.php"); 
      }
      $this->Erro      = new form_ap_contrato_updt_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['opcao']))
         { 
             if ($this->pk_contrato != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      if (isset($this->classificacao1)) { $this->nm_limpa_alfa($this->classificacao1); }
      if (isset($this->classificacao2)) { $this->nm_limpa_alfa($this->classificacao2); }
      ...
      if (isset($this->senha_usuario)) { $this->nm_limpa_alfa($this->senha_usuario); }
      if (isset($this->nome_contato)) { $this->nm_limpa_alfa($this->nome_contato); }
      if (isset($this->ativo)) { $this->nm_limpa_alfa($this->ativo); }
      if (isset($this->website)) { $this->nm_limpa_alfa($this->website); }
      $Campos_Crit       = "";
      $Campos_erro       = "";
      $Campos_Falta      = array();
      $Campos_Erros      = array();
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      $this->field_config['seg_m_de']['date_display'] = "hhii";
      ...
      $this->field_config['seg_m_ate']['date_display'] = "hhii";
      ...
      $this->field_config['seg_t_de']['date_display'] = "hhii";
      ...
      $this->field_config['seg_t_ate']['date_display'] = "hhii";
      ...
      $this->field_config['ter_m_de']['date_display'] = "hhii";
      ...
      $this->field_config['ter_m_ate']['date_display'] = "hhii";
      ...
      $this->field_config['ter_t_de']['date_display'] = "hhii";
      ...
      $this->field_config['ter_t_ate']['date_display'] = "hhii";
      ...
      $this->field_config['qua_m_de']['date_display'] = "hhii";
      ...
      $this->field_config['qua_m_ate']['date_display'] = "hhii";
      ...
      $this->field_config['qua_t_de']['date_display'] = "hhii";
      ...
      $this->field_config['qua_t_ate']['date_display'] = "hhii";
      ...
      $this->field_config['qui_m_de']['date_display'] = "hhii";
      ...
      $this->field_config['qui_m_ate']['date_display'] = "hhii";
      ...
      $this->field_config['qui_t_de']['date_display'] = "hhii";
      ...
      $this->field_config['qui_t_ate']['date_display'] = "hhii";
      ...
      $this->field_config['sex_m_de']['date_display'] = "hhii";
      ...
      $this->field_config['sex_m_ate']['date_display'] = "hhii";
      ...
      $this->field_config['sex_t_de']['date_display'] = "hhii";
      ...
      $this->field_config['sex_t_ate']['date_display'] = "hhii";
      ...
      $this->field_config['sab_m_de']['date_display'] = "hhii";
      ...
      $this->field_config['sab_m_ate']['date_display'] = "hhii";
      ...
      $this->field_config['sab_t_de']['date_display'] = "hhii";
      ...
      $this->field_config['sab_t_ate']['date_display'] = "hhii";
      ...
      $this->field_config['dom_m_de']['date_display'] = "hhii";
      ...
      $this->field_config['dom_m_ate']['date_display'] = "hhii";
      ...
      $this->field_config['dom_t_de']['date_display'] = "hhii";
      ...
      $this->field_config['dom_t_ate']['date_display'] = "hhii";
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_retype_senha' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'retype_senha');
          }
          ...
          if ('validate_classificacao1' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'classificacao1');
          }
          if ('validate_classificacao2' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'classificacao2');
          }
          ...
          if ('validate_website' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'website');
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['cnpj']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cnpj = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['cnpj'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['razao']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->razao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['razao'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['cep']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cep = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['cep'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['cidade']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cidade = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['cidade'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['estado']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->estado = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['estado'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['bairro']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->bairro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['bairro'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['rua']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->rua = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['rua'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['complemento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->complemento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['complemento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['numero']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->numero = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']['numero'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['recarga'] = $this->nmgp_opcao;
      }
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_ap_contrato_updt_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_ap_contrato_updt_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_ap_contrato_updt_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_ap_contrato_updt_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ('' == $filtro || 'retype_senha' == $filtro)
        $this->ValidateField_retype_senha($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ('' == $filtro || 'classificacao1' == $filtro)
        $this->ValidateField_classificacao1($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'classificacao2' == $filtro)
        $this->ValidateField_classificacao2($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ('' == $filtro || 'website' == $filtro)
        $this->ValidateField_website($Campos_Crit, $Campos_Falta, $Campos_Erros);
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    $original_retype_senha = $this->retype_senha;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_ap_contrato_updt_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
if ($this->senha_usuario  <> $this->retype_senha )
	{
	
	
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= 'SENHA NÃO CONFERE';
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6))
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_ap_contrato_updt_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
  $this->NM_ajax_info['errList'][$sErrorIndex][] = 'SENHA NÃO CONFERE';
 }
;
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_retype_senha != $this->retype_senha || (isset($bFlagRead_retype_senha) && $bFlagRead_retype_senha)))
    {
        $this->ajax_return_values_retype_senha(true);
    }
...
$_SESSION['scriptcase']['form_ap_contrato_updt_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_cnpj(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['cnpj']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['cnpj'] == "on") 
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['razao']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['razao'] == "on")) 
      { 
          if ($this->razao == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['fantasia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['fantasia'] == "on")) 
      { 
          if ($this->fantasia == "")  
          { 
      ...
      { 
          ...
          { 
              $Campos_Crit .= "Nome Fantasia " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 80 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['fantasia']))
              {
                  $Campos_Erros['fantasia'] = array();
              }
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['senha_usuario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['senha_usuario'] == "on")) 
      { 
          if ($this->senha_usuario == "")  
          { 
              $Campos_Falta[] =  "Senha Usuario" ; 
              if (!isset($Campos_Erros['senha_usuario']))
              {
                  $Campos_Erros['senha_usuario'] = array();
              }
              $Campos_Erros['senha_usuario'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  ...
                  $this->NM_ajax_info['errList']['senha_usuario'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          } 
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->senha_usuario) > 45) 
          { 
              $Campos_Crit .= "Senha Usuario " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['senha_usuario']))
              {
                  $Campos_Erros['senha_usuario'] = array();
              }
              $Campos_Erros['senha_usuario'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['senha_usuario']) || !is_array($this->NM_ajax_info['errList']['senha_usuario']))
              {
                  $this->NM_ajax_info['errList']['senha_usuario'] = array();
              }
              $this->NM_ajax_info['errList']['senha_usuario'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_senha_usuario

    function ValidateField_retype_senha(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['retype_senha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['retype_senha'] == "on")) 
      { 
          if ($this->retype_senha == "")  
          { 
              $Campos_Falta[] =  "Redigite a Senha" ; 
              if (!isset($Campos_Erros['retype_senha']))
              {
                  $Campos_Erros['retype_senha'] = array();
              }
              $Campos_Erros['retype_senha'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['retype_senha']) || !is_array($this->NM_ajax_info['errList']['retype_senha']))
                  {
                      $this->NM_ajax_info['errList']['retype_senha'] = array();
                  }
                  $this->NM_ajax_info['errList']['retype_senha'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          } 
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->retype_senha) > 20) 
          { 
              $Campos_Crit .= "Redigite a Senha " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['retype_senha']))
              {
                  $Campos_Erros['retype_senha'] = array();
              }
              $Campos_Erros['retype_senha'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['retype_senha']) || !is_array($this->NM_ajax_info['errList']['retype_senha']))
              {
                  $this->NM_ajax_info['errList']['retype_senha'] = array();
              }
              $this->NM_ajax_info['errList']['retype_senha'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_retype_senha
    ...
    function ValidateField_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['email'] == "on") 
          { 
              $Campos_Falta[] = "Email" ; 
              if (!isset($Campos_Erros['email']))
              {
    ...
    {
        global $teste_validade;
      if ($this->fk_classificacao == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['fk_classificacao']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['fk_classificacao'] == "on"))
      {
          ...
          if (!empty($this->fk_classificacao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['Lookup_fk_classificacao']) && !in_array($this->fk_classificacao, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['Lookup_fk_classificacao']))
          {
    ...
    function ValidateField_classificacao1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      $this->classificacao1 = sc_strtoupper($this->classificacao1); 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->classificacao1) > 70) 
          { 
              $Campos_Crit .= "Classificação 1 " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 70 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['classificacao1']))
              {
                  $Campos_Erros['classificacao1'] = array();
              }
              $Campos_Erros['classificacao1'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 70 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['classificacao1']) || !is_array($this->NM_ajax_info['errList']['classificacao1']))
              {
                  $this->NM_ajax_info['errList']['classificacao1'] = array();
              }
              $this->NM_ajax_info['errList']['classificacao1'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 70 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_classificacao1

    function ValidateField_classificacao2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      $this->classificacao2 = sc_strtoupper($this->classificacao2); 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->classificacao2) > 70) 
          { 
              $Campos_Crit .= "Classificação 2 " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 70 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['classificacao2']))
              {
                  $Campos_Erros['classificacao2'] = array();
              }
              $Campos_Erros['classificacao2'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 70 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['classificacao2']) || !is_array($this->NM_ajax_info['errList']['classificacao2']))
              {
                  $this->NM_ajax_info['errList']['classificacao2'] = array();
              }
              $this->NM_ajax_info['errList']['classificacao2'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 70 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_classificacao2

    function ValidateField_nome_contato(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['nome_contato']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['nome_contato'] == "on")) 
      { 
    ...
    function ValidateField_telefone(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          if (!$this->nm_validate_mask($this->telefone, explode(';', "(99) 9999-9999")))  
          { 
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
      ...
      $this->nm_tira_mask($this->telefone, "(99) 9999-9999", "(){}[].,;:-+/ "); 
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['telefone']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['telefone'] == "on")) 
      { 
          if ($this->telefone == "")  
          { 
    ...
    function ValidateField_cep(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['cep']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['cep'] == "on") 
           { 
              $Campos_Falta[] = "CEP" ; 
              if (!isset($Campos_Erros['cep']))
              {
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['cidade']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['cidade'] == "on")) 
      { 
          if ($this->cidade == "")  
          { 
              $Campos_Falta[] =  "Cidade" ; 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['estado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['estado'] == "on")) 
      { 
          if ($this->estado == "")  
          { 
              $Campos_Falta[] =  "Estado" ; 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['bairro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['bairro'] == "on")) 
      { 
          if ($this->bairro == "")  
          { 
              $Campos_Falta[] =  "Bairro" ; 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['rua']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['rua'] == "on")) 
      { 
          if ($this->rua == "")  
          { 
              $Campos_Falta[] =  "Rua" ; 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['numero']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['numero'] == "on")) 
      { 
          if ($this->numero == "")  
          { 
              $Campos_Falta[] =  "Numero" ; 
    ...
    function ValidateField_website(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['website']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['website'] == "on")) 
      { 
          if ($this->website == "")  
          { 
              $Campos_Falta[] =  "Site na Web" ; 
              if (!isset($Campos_Erros['website']))
              {
                  $Campos_Erros['website'] = array();
              }
              $Campos_Erros['website'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['website']) || !is_array($this->NM_ajax_info['errList']['website']))
                  {
                      $this->NM_ajax_info['errList']['website'] = array();
                  }
                  $this->NM_ajax_info['errList']['website'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          } 
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->website) > 120) 
          { 
              $Campos_Crit .= "Site na Web " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['website']))
              {
                  $Campos_Erros['website'] = array();
              }
              $Campos_Erros['website'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['website']) || !is_array($this->NM_ajax_info['errList']['website']))
              {
                  $this->NM_ajax_info['errList']['website'] = array();
              }
              $this->NM_ajax_info['errList']['website'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_website
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'form_ap_contrato_updt_mob_doc_name.php';
              }
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['classificacao1'] = $this->classificacao1;
    $this->nmgp_dados_form['classificacao2'] = $this->classificacao2;
    $this->nmgp_dados_form['nome_contato'] = $this->nome_contato;
    $this->nmgp_dados_form['telefone'] = $this->telefone;
    $this->nmgp_dados_form['seg_m_de'] = (strlen(trim($this->seg_m_de)) > 19) ? str_replace(".", ":", $this->seg_m_de) : trim($this->seg_m_de);
    $this->nmgp_dados_form['seg_m_ate'] = (strlen(trim($this->seg_m_ate)) > 19) ? str_replace(".", ":", $this->seg_m_ate) : trim($this->seg_m_ate);
    $this->nmgp_dados_form['seg_t_de'] = (strlen(trim($this->seg_t_de)) > 19) ? str_replace(".", ":", $this->seg_t_de) : trim($this->seg_t_de);
    $this->nmgp_dados_form['seg_t_ate'] = (strlen(trim($this->seg_t_ate)) > 19) ? str_replace(".", ":", $this->seg_t_ate) : trim($this->seg_t_ate);
    $this->nmgp_dados_form['ter_m_de'] = (strlen(trim($this->ter_m_de)) > 19) ? str_replace(".", ":", $this->ter_m_de) : trim($this->ter_m_de);
    $this->nmgp_dados_form['ter_m_ate'] = (strlen(trim($this->ter_m_ate)) > 19) ? str_replace(".", ":", $this->ter_m_ate) : trim($this->ter_m_ate);
    $this->nmgp_dados_form['ter_t_de'] = (strlen(trim($this->ter_t_de)) > 19) ? str_replace(".", ":", $this->ter_t_de) : trim($this->ter_t_de);
    $this->nmgp_dados_form['ter_t_ate'] = (strlen(trim($this->ter_t_ate)) > 19) ? str_replace(".", ":", $this->ter_t_ate) : trim($this->ter_t_ate);
    $this->nmgp_dados_form['qua_m_de'] = (strlen(trim($this->qua_m_de)) > 19) ? str_replace(".", ":", $this->qua_m_de) : trim($this->qua_m_de);
    $this->nmgp_dados_form['qua_m_ate'] = (strlen(trim($this->qua_m_ate)) > 19) ? str_replace(".", ":", $this->qua_m_ate) : trim($this->qua_m_ate);
    $this->nmgp_dados_form['qua_t_de'] = (strlen(trim($this->qua_t_de)) > 19) ? str_replace(".", ":", $this->qua_t_de) : trim($this->qua_t_de);
    $this->nmgp_dados_form['qua_t_ate'] = (strlen(trim($this->qua_t_ate)) > 19) ? str_replace(".", ":", $this->qua_t_ate) : trim($this->qua_t_ate);
    $this->nmgp_dados_form['qui_m_de'] = (strlen(trim($this->qui_m_de)) > 19) ? str_replace(".", ":", $this->qui_m_de) : trim($this->qui_m_de);
    $this->nmgp_dados_form['qui_m_ate'] = (strlen(trim($this->qui_m_ate)) > 19) ? str_replace(".", ":", $this->qui_m_ate) : trim($this->qui_m_ate);
    $this->nmgp_dados_form['qui_t_de'] = (strlen(trim($this->qui_t_de)) > 19) ? str_replace(".", ":", $this->qui_t_de) : trim($this->qui_t_de);
    $this->nmgp_dados_form['qui_t_ate'] = (strlen(trim($this->qui_t_ate)) > 19) ? str_replace(".", ":", $this->qui_t_ate) : trim($this->qui_t_ate);
    $this->nmgp_dados_form['sex_m_de'] = (strlen(trim($this->sex_m_de)) > 19) ? str_replace(".", ":", $this->sex_m_de) : trim($this->sex_m_de);
    $this->nmgp_dados_form['sex_m_ate'] = (strlen(trim($this->sex_m_ate)) > 19) ? str_replace(".", ":", $this->sex_m_ate) : trim($this->sex_m_ate);
    $this->nmgp_dados_form['sex_t_de'] = (strlen(trim($this->sex_t_de)) > 19) ? str_replace(".", ":", $this->sex_t_de) : trim($this->sex_t_de);
    $this->nmgp_dados_form['sex_t_ate'] = (strlen(trim($this->sex_t_ate)) > 19) ? str_replace(".", ":", $this->sex_t_ate) : trim($this->sex_t_ate);
    $this->nmgp_dados_form['sab_m_de'] = (strlen(trim($this->sab_m_de)) > 19) ? str_replace(".", ":", $this->sab_m_de) : trim($this->sab_m_de);
    $this->nmgp_dados_form['sab_m_ate'] = (strlen(trim($this->sab_m_ate)) > 19) ? str_replace(".", ":", $this->sab_m_ate) : trim($this->sab_m_ate);
    $this->nmgp_dados_form['sab_t_de'] = (strlen(trim($this->sab_t_de)) > 19) ? str_replace(".", ":", $this->sab_t_de) : trim($this->sab_t_de);
    $this->nmgp_dados_form['sab_t_ate'] = (strlen(trim($this->sab_t_ate)) > 19) ? str_replace(".", ":", $this->sab_t_ate) : trim($this->sab_t_ate);
    $this->nmgp_dados_form['dom_m_de'] = (strlen(trim($this->dom_m_de)) > 19) ? str_replace(".", ":", $this->dom_m_de) : trim($this->dom_m_de);
    $this->nmgp_dados_form['dom_m_ate'] = (strlen(trim($this->dom_m_ate)) > 19) ? str_replace(".", ":", $this->dom_m_ate) : trim($this->dom_m_ate);
    $this->nmgp_dados_form['dom_t_de'] = (strlen(trim($this->dom_t_de)) > 19) ? str_replace(".", ":", $this->dom_t_de) : trim($this->dom_t_de);
    $this->nmgp_dados_form['dom_t_ate'] = (strlen(trim($this->dom_t_ate)) > 19) ? str_replace(".", ":", $this->dom_t_ate) : trim($this->dom_t_ate);
    ...
    $this->nmgp_dados_form['activate_date'] = (strlen(trim($this->activate_date)) > 19) ? str_replace(".", ":", $this->activate_date) : trim($this->activate_date);
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      {
          $this->nm_gera_mask($this->telefone, "(99) 9999-9999"); 
      }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_retype_senha();
          $this->ajax_return_values_email();
          $this->ajax_return_values_retype_email();
          $this->ajax_return_values_fk_classificacao();
          $this->ajax_return_values_classificacao1();
          $this->ajax_return_values_classificacao2();
          ...
          $this->ajax_return_values_website();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['pk_contrato']['keyVal'] = form_ap_contrato_updt_mob_pack_protect_string($this->nmgp_dados_form['pk_contrato']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_ap_contrato_updt_mob_pack_protect_string('1') => form_ap_contrato_updt_mob_pack_protect_string("SIM"));
$aLookup[] = array(form_ap_contrato_updt_mob_pack_protect_string('0') => form_ap_contrato_updt_mob_pack_protect_string("NÃO"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['Lookup_ativo'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['Lookup_ativo'][] = '0';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"ativo\"";
          ...
          {
              $this->NM_ajax_info['fldList']['ativo']['valList'][$i] = form_ap_contrato_updt_mob_pack_protect_string($v);
          }
   ...
   function ajax_return_values_senha_usuario($bForce = false)
   {
          ...
          //----- retype_senha
   function ajax_return_values_retype_senha($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("retype_senha", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->retype_senha);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['retype_senha'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array(''),
              );
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['Lookup_fk_classificacao']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['Lookup_fk_classificacao'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['Lookup_fk_classificacao']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['Lookup_fk_classificacao'] = array(); 
}
$aLookup[] = array(form_ap_contrato_updt_mob_pack_protect_string('') => form_ap_contrato_updt_mob_pack_protect_string('SELECIONE'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['Lookup_fk_classificacao'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_ap_contrato_updt_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_ap_contrato_updt_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['Lookup_fk_classificacao'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fk_classificacao']['valList'][$i] = form_ap_contrato_updt_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
          ...
          //----- classificacao1
   function ajax_return_values_classificacao1($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("classificacao1", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->classificacao1);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['classificacao1'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- classificacao2
   function ajax_return_values_classificacao2($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("classificacao2", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->classificacao2);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['classificacao2'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
   ...
   function ajax_return_values_numero($bForce = false)
   {
          ...
          //----- website
   function ajax_return_values_website($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("website", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->website);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['website'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
   ...
   { 
       ...
       { 
           ...
           $out_fachada = $this->Ini->path_imag_temp . "/sc_fachada_325325" . $md5_fachada . ".gif" ;  
           if (is_file($this->Ini->root . $out_fachada))  
           { 
               $NM_img_time = filemtime($this->Ini->root . $out_fachada) + 0; 
               if ($this->Ini->nm_timestamp < $NM_img_time)  
           ...
           { 
               ...
               { 
                   ...
                   $sc_obj_img->setWidth(325);
                   $sc_obj_img->setHeight(325);
   ...
   function ajax_return_values_pk_contrato($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
$this->retype_senha  = $this->senha_usuario ;
...
$_SESSION['scriptcase']['form_ap_contrato_updt_mob']['contr_erro'] = 'off'; 
      ...
      $NM_val_form['classificacao1'] = $this->classificacao1;
      $NM_val_form['classificacao2'] = $this->classificacao2;
      ...
      {
          $this->classificacao1_before_qstr = $this->classificacao1;
          $this->classificacao1 = substr($this->Db->qstr($this->classificacao1), 1, -1); 
          if ($this->classificacao1 == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->classificacao1 = "null"; 
              $NM_val_null[] = "classificacao1";
          } 
          $this->classificacao2_before_qstr = $this->classificacao2;
          $this->classificacao2 = substr($this->Db->qstr($this->classificacao2), 1, -1); 
          if ($this->classificacao2 == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->classificacao2 = "null"; 
              $NM_val_null[] = "classificacao2";
          } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET fk_classificacao = $this->fk_classificacao, classificacao1 = '$this->classificacao1', classificacao2 = '$this->classificacao2', cnpj = '$this->cnpj', inscricao = '$this->inscricao', razao = '$this->razao', fantasia = '$this->fantasia', cidade = '$this->cidade', estado = '$this->estado', bairro = '$this->bairro', rua = '$this->rua', complemento = '$this->complemento', numero = '$this->numero', cep = '$this->cep', email = '$this->email', telefone = '$this->telefone', nome_contato = '$this->nome_contato', ativo = $this->ativo, seg_m_de = #$this->seg_m_de#, seg_m_ate = #$this->seg_m_ate#, seg_t_de = #$this->seg_t_de#, seg_t_ate = #$this->seg_t_ate#, ter_m_de = #$this->ter_m_de#, ter_m_ate = #$this->ter_m_ate#, ter_t_de = #$this->ter_t_de#, ter_t_ate = #$this->ter_t_ate#, qua_m_de = #$this->qua_m_de#, qua_m_ate = #$this->qua_m_ate#, qua_t_de = #$this->qua_t_de#, qua_t_ate = #$this->qua_t_ate#, qui_m_de = #$this->qui_m_de#, qui_m_ate = #$this->qui_m_ate#, qui_t_de = #$this->qui_t_de#, qui_t_ate = #$this->qui_t_ate#, sex_m_de = #$this->sex_m_de#, sex_m_ate = #$this->sex_m_ate#, sex_t_de = #$this->sex_t_de#, sex_t_ate = #$this->sex_t_ate#, sab_m_de = #$this->sab_m_de#, sab_m_ate = #$this->sab_m_ate#, sab_t_de = #$this->sab_t_de#, sab_t_ate = #$this->sab_t_ate#, dom_m_de = #$this->dom_m_de#, dom_m_ate = #$this->dom_m_ate#, dom_t_de = #$this->dom_t_de#, dom_t_ate = #$this->dom_t_ate#, website = '$this->website'";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET fk_classificacao = $this->fk_classificacao, classificacao1 = '$this->classificacao1', classificacao2 = '$this->classificacao2', cnpj = '$this->cnpj', inscricao = '$this->inscricao', razao = '$this->razao', fantasia = '$this->fantasia', cidade = '$this->cidade', estado = '$this->estado', bairro = '$this->bairro', rua = '$this->rua', complemento = '$this->complemento', numero = '$this->numero', cep = '$this->cep', email = '$this->email', telefone = '$this->telefone', nome_contato = '$this->nome_contato', ativo = $this->ativo, seg_m_de = " . $this->Ini->date_delim . $this->seg_m_de . $this->Ini->date_delim1 . ", seg_m_ate = " . $this->Ini->date_delim . $this->seg_m_ate . $this->Ini->date_delim1 . ", seg_t_de = " . $this->Ini->date_delim . $this->seg_t_de . $this->Ini->date_delim1 . ", seg_t_ate = " . $this->Ini->date_delim . $this->seg_t_ate . $this->Ini->date_delim1 . ", ter_m_de = " . $this->Ini->date_delim . $this->ter_m_de . $this->Ini->date_delim1 . ", ter_m_ate = " . $this->Ini->date_delim . $this->ter_m_ate . $this->Ini->date_delim1 . ", ter_t_de = " . $this->Ini->date_delim . $this->ter_t_de . $this->Ini->date_delim1 . ", ter_t_ate = " . $this->Ini->date_delim . $this->ter_t_ate . $this->Ini->date_delim1 . ", qua_m_de = " . $this->Ini->date_delim . $this->qua_m_de . $this->Ini->date_delim1 . ", qua_m_ate = " . $this->Ini->date_delim . $this->qua_m_ate . $this->Ini->date_delim1 . ", qua_t_de = " . $this->Ini->date_delim . $this->qua_t_de . $this->Ini->date_delim1 . ", qua_t_ate = " . $this->Ini->date_delim . $this->qua_t_ate . $this->Ini->date_delim1 . ", qui_m_de = " . $this->Ini->date_delim . $this->qui_m_de . $this->Ini->date_delim1 . ", qui_m_ate = " . $this->Ini->date_delim . $this->qui_m_ate . $this->Ini->date_delim1 . ", qui_t_de = " . $this->Ini->date_delim . $this->qui_t_de . $this->Ini->date_delim1 . ", qui_t_ate = " . $this->Ini->date_delim . $this->qui_t_ate . $this->Ini->date_delim1 . ", sex_m_de = " . $this->Ini->date_delim . $this->sex_m_de . $this->Ini->date_delim1 . ", sex_m_ate = " . $this->Ini->date_delim . $this->sex_m_ate . $this->Ini->date_delim1 . ", sex_t_de = " . $this->Ini->date_delim . $this->sex_t_de . $this->Ini->date_delim1 . ", sex_t_ate = " . $this->Ini->date_delim . $this->sex_t_ate . $this->Ini->date_delim1 . ", sab_m_de = " . $this->Ini->date_delim . $this->sab_m_de . $this->Ini->date_delim1 . ", sab_m_ate = " . $this->Ini->date_delim . $this->sab_m_ate . $this->Ini->date_delim1 . ", sab_t_de = " . $this->Ini->date_delim . $this->sab_t_de . $this->Ini->date_delim1 . ", sab_t_ate = " . $this->Ini->date_delim . $this->sab_t_ate . $this->Ini->date_delim1 . ", dom_m_de = " . $this->Ini->date_delim . $this->dom_m_de . $this->Ini->date_delim1 . ", dom_m_ate = " . $this->Ini->date_delim . $this->dom_m_ate . $this->Ini->date_delim1 . ", dom_t_de = " . $this->Ini->date_delim . $this->dom_t_de . $this->Ini->date_delim1 . ", dom_t_ate = " . $this->Ini->date_delim . $this->dom_t_ate . $this->Ini->date_delim1 . ", website = '$this->website'";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET fk_classificacao = $this->fk_classificacao, classificacao1 = '$this->classificacao1', classificacao2 = '$this->classificacao2', cnpj = '$this->cnpj', inscricao = '$this->inscricao', razao = '$this->razao', fantasia = '$this->fantasia', cidade = '$this->cidade', estado = '$this->estado', bairro = '$this->bairro', rua = '$this->rua', complemento = '$this->complemento', numero = '$this->numero', cep = '$this->cep', email = '$this->email', telefone = '$this->telefone', nome_contato = '$this->nome_contato', ativo = $this->ativo, seg_m_de = " . $this->Ini->date_delim . $this->seg_m_de . $this->Ini->date_delim1 . ", seg_m_ate = " . $this->Ini->date_delim . $this->seg_m_ate . $this->Ini->date_delim1 . ", seg_t_de = " . $this->Ini->date_delim . $this->seg_t_de . $this->Ini->date_delim1 . ", seg_t_ate = " . $this->Ini->date_delim . $this->seg_t_ate . $this->Ini->date_delim1 . ", ter_m_de = " . $this->Ini->date_delim . $this->ter_m_de . $this->Ini->date_delim1 . ", ter_m_ate = " . $this->Ini->date_delim . $this->ter_m_ate . $this->Ini->date_delim1 . ", ter_t_de = " . $this->Ini->date_delim . $this->ter_t_de . $this->Ini->date_delim1 . ", ter_t_ate = " . $this->Ini->date_delim . $this->ter_t_ate . $this->Ini->date_delim1 . ", qua_m_de = " . $this->Ini->date_delim . $this->qua_m_de . $this->Ini->date_delim1 . ", qua_m_ate = " . $this->Ini->date_delim . $this->qua_m_ate . $this->Ini->date_delim1 . ", qua_t_de = " . $this->Ini->date_delim . $this->qua_t_de . $this->Ini->date_delim1 . ", qua_t_ate = " . $this->Ini->date_delim . $this->qua_t_ate . $this->Ini->date_delim1 . ", qui_m_de = " . $this->Ini->date_delim . $this->qui_m_de . $this->Ini->date_delim1 . ", qui_m_ate = " . $this->Ini->date_delim . $this->qui_m_ate . $this->Ini->date_delim1 . ", qui_t_de = " . $this->Ini->date_delim . $this->qui_t_de . $this->Ini->date_delim1 . ", qui_t_ate = " . $this->Ini->date_delim . $this->qui_t_ate . $this->Ini->date_delim1 . ", sex_m_de = " . $this->Ini->date_delim . $this->sex_m_de . $this->Ini->date_delim1 . ", sex_m_ate = " . $this->Ini->date_delim . $this->sex_m_ate . $this->Ini->date_delim1 . ", sex_t_de = " . $this->Ini->date_delim . $this->sex_t_de . $this->Ini->date_delim1 . ", sex_t_ate = " . $this->Ini->date_delim . $this->sex_t_ate . $this->Ini->date_delim1 . ", sab_m_de = " . $this->Ini->date_delim . $this->sab_m_de . $this->Ini->date_delim1 . ", sab_m_ate = " . $this->Ini->date_delim . $this->sab_m_ate . $this->Ini->date_delim1 . ", sab_t_de = " . $this->Ini->date_delim . $this->sab_t_de . $this->Ini->date_delim1 . ", sab_t_ate = " . $this->Ini->date_delim . $this->sab_t_ate . $this->Ini->date_delim1 . ", dom_m_de = " . $this->Ini->date_delim . $this->dom_m_de . $this->Ini->date_delim1 . ", dom_m_ate = " . $this->Ini->date_delim . $this->dom_m_ate . $this->Ini->date_delim1 . ", dom_t_de = " . $this->Ini->date_delim . $this->dom_t_de . $this->Ini->date_delim1 . ", dom_t_ate = " . $this->Ini->date_delim . $this->dom_t_ate . $this->Ini->date_delim1 . ", website = '$this->website'";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET fk_classificacao = $this->fk_classificacao, classificacao1 = '$this->classificacao1', classificacao2 = '$this->classificacao2', cnpj = '$this->cnpj', inscricao = '$this->inscricao', razao = '$this->razao', fantasia = '$this->fantasia', cidade = '$this->cidade', estado = '$this->estado', bairro = '$this->bairro', rua = '$this->rua', complemento = '$this->complemento', numero = '$this->numero', cep = '$this->cep', email = '$this->email', telefone = '$this->telefone', nome_contato = '$this->nome_contato', ativo = $this->ativo, seg_m_de = " . $this->Ini->date_delim . $this->seg_m_de . $this->Ini->date_delim1 . ", seg_m_ate = " . $this->Ini->date_delim . $this->seg_m_ate . $this->Ini->date_delim1 . ", seg_t_de = " . $this->Ini->date_delim . $this->seg_t_de . $this->Ini->date_delim1 . ", seg_t_ate = " . $this->Ini->date_delim . $this->seg_t_ate . $this->Ini->date_delim1 . ", ter_m_de = " . $this->Ini->date_delim . $this->ter_m_de . $this->Ini->date_delim1 . ", ter_m_ate = " . $this->Ini->date_delim . $this->ter_m_ate . $this->Ini->date_delim1 . ", ter_t_de = " . $this->Ini->date_delim . $this->ter_t_de . $this->Ini->date_delim1 . ", ter_t_ate = " . $this->Ini->date_delim . $this->ter_t_ate . $this->Ini->date_delim1 . ", qua_m_de = " . $this->Ini->date_delim . $this->qua_m_de . $this->Ini->date_delim1 . ", qua_m_ate = " . $this->Ini->date_delim . $this->qua_m_ate . $this->Ini->date_delim1 . ", qua_t_de = " . $this->Ini->date_delim . $this->qua_t_de . $this->Ini->date_delim1 . ", qua_t_ate = " . $this->Ini->date_delim . $this->qua_t_ate . $this->Ini->date_delim1 . ", qui_m_de = " . $this->Ini->date_delim . $this->qui_m_de . $this->Ini->date_delim1 . ", qui_m_ate = " . $this->Ini->date_delim . $this->qui_m_ate . $this->Ini->date_delim1 . ", qui_t_de = " . $this->Ini->date_delim . $this->qui_t_de . $this->Ini->date_delim1 . ", qui_t_ate = " . $this->Ini->date_delim . $this->qui_t_ate . $this->Ini->date_delim1 . ", sex_m_de = " . $this->Ini->date_delim . $this->sex_m_de . $this->Ini->date_delim1 . ", sex_m_ate = " . $this->Ini->date_delim . $this->sex_m_ate . $this->Ini->date_delim1 . ", sex_t_de = " . $this->Ini->date_delim . $this->sex_t_de . $this->Ini->date_delim1 . ", sex_t_ate = " . $this->Ini->date_delim . $this->sex_t_ate . $this->Ini->date_delim1 . ", sab_m_de = " . $this->Ini->date_delim . $this->sab_m_de . $this->Ini->date_delim1 . ", sab_m_ate = " . $this->Ini->date_delim . $this->sab_m_ate . $this->Ini->date_delim1 . ", sab_t_de = " . $this->Ini->date_delim . $this->sab_t_de . $this->Ini->date_delim1 . ", sab_t_ate = " . $this->Ini->date_delim . $this->sab_t_ate . $this->Ini->date_delim1 . ", dom_m_de = " . $this->Ini->date_delim . $this->dom_m_de . $this->Ini->date_delim1 . ", dom_m_ate = " . $this->Ini->date_delim . $this->dom_m_ate . $this->Ini->date_delim1 . ", dom_t_de = " . $this->Ini->date_delim . $this->dom_t_de . $this->Ini->date_delim1 . ", dom_t_ate = " . $this->Ini->date_delim . $this->dom_t_ate . $this->Ini->date_delim1 . ", website = '$this->website'";  
              ...
              { 
                  ...
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
                  { 
                      $comando        .= " datacadastro = #$this->datacadastro#"; 
                  } 
                  else 
                  { 
                      $comando        .= " datacadastro = " . $this->Ini->date_delim . $this->datacadastro . $this->Ini->date_delim1 . ""; 
                  } 
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
                  { 
                      $comando_oracle        .= " datacadastro = EXTEND('" . $this->datacadastro . "', YEAR TO DAY)"; 
                  } 
                  else
                  { 
                      $comando_oracle        .= " datacadastro = " . $this->Ini->date_delim . $this->datacadastro . $this->Ini->date_delim1 . ""; 
                  } 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
          ...
          $this->classificacao1 = $this->classificacao1_before_qstr;
          $this->classificacao2 = $this->classificacao2_before_qstr;
          ...
          $this->website = $this->website_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['db_changed'] = true;
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['classificacao1'])) { $this->classificacao1 = $NM_val_form['classificacao1']; }
              elseif (isset($this->classificacao1)) { $this->nm_limpa_alfa($this->classificacao1); }
              if     (isset($NM_val_form) && isset($NM_val_form['classificacao2'])) { $this->classificacao2 = $NM_val_form['classificacao2']; }
              elseif (isset($this->classificacao2)) { $this->nm_limpa_alfa($this->classificacao2); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['senha_usuario'])) { $this->senha_usuario = $NM_val_form['senha_usuario']; }
              elseif (isset($this->senha_usuario)) { $this->nm_limpa_alfa($this->senha_usuario); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['website'])) { $this->website = $NM_val_form['website']; }
              elseif (isset($this->website)) { $this->nm_limpa_alfa($this->website); }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (fk_classificacao, classificacao1, classificacao2, cnpj, inscricao, razao, fantasia, datacadastro, cidade, estado, bairro, rua, complemento, numero, cep, fachada, latitude, longitude, email, telefone, senha_usuario, nome_contato, ativo, rash, activate_code, activate_date, seg_m_de, seg_m_ate, seg_t_de, seg_t_ate, ter_m_de, ter_m_ate, ter_t_de, ter_t_ate, qua_m_de, qua_m_ate, qua_t_de, qua_t_ate, qui_m_de, qui_m_ate, qui_t_de, qui_t_ate, sex_m_de, sex_m_ate, sex_t_de, sex_t_ate, sab_m_de, sab_m_ate, sab_t_de, sab_t_ate, dom_m_de, dom_m_ate, dom_t_de, dom_t_ate, website) VALUES ($this->fk_classificacao, '$this->classificacao1', '$this->classificacao2', '$this->cnpj', '$this->inscricao', '$this->razao', '$this->fantasia', #$this->datacadastro#, '$this->cidade', '$this->estado', '$this->bairro', '$this->rua', '$this->complemento', '$this->numero', '$this->cep', '$this->fachada', '$this->latitude', '$this->longitude', '$this->email', '$this->telefone', '$this->senha_usuario', '$this->nome_contato', $this->ativo, '$this->rash', '$this->activate_code', #$this->activate_date#, #$this->seg_m_de#, #$this->seg_m_ate#, #$this->seg_t_de#, #$this->seg_t_ate#, #$this->ter_m_de#, #$this->ter_m_ate#, #$this->ter_t_de#, #$this->ter_t_ate#, #$this->qua_m_de#, #$this->qua_m_ate#, #$this->qua_t_de#, #$this->qua_t_ate#, #$this->qui_m_de#, #$this->qui_m_ate#, #$this->qui_t_de#, #$this->qui_t_ate#, #$this->sex_m_de#, #$this->sex_m_ate#, #$this->sex_t_de#, #$this->sex_t_ate#, #$this->sab_m_de#, #$this->sab_m_ate#, #$this->sab_t_de#, #$this->sab_t_ate#, #$this->dom_m_de#, #$this->dom_m_ate#, #$this->dom_t_de#, #$this->dom_t_ate#, '$this->website')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "fk_classificacao, classificacao1, classificacao2, cnpj, inscricao, razao, fantasia, datacadastro, cidade, estado, bairro, rua, complemento, numero, cep, fachada, latitude, longitude, email, telefone, senha_usuario, nome_contato, ativo, rash, activate_code, activate_date, seg_m_de, seg_m_ate, seg_t_de, seg_t_ate, ter_m_de, ter_m_ate, ter_t_de, ter_t_ate, qua_m_de, qua_m_ate, qua_t_de, qua_t_ate, qui_m_de, qui_m_ate, qui_t_de, qui_t_ate, sex_m_de, sex_m_ate, sex_t_de, sex_t_ate, sab_m_de, sab_m_ate, sab_t_de, sab_t_ate, dom_m_de, dom_m_ate, dom_t_de, dom_t_ate, website) VALUES (" . $NM_seq_auto . "$this->fk_classificacao, '$this->classificacao1', '$this->classificacao2', '$this->cnpj', '$this->inscricao', '$this->razao', '$this->fantasia', " . $this->Ini->date_delim . $this->datacadastro . $this->Ini->date_delim1 . ", '$this->cidade', '$this->estado', '$this->bairro', '$this->rua', '$this->complemento', '$this->numero', '$this->cep', '$this->fachada', '$this->latitude', '$this->longitude', '$this->email', '$this->telefone', '$this->senha_usuario', '$this->nome_contato', $this->ativo, '$this->rash', '$this->activate_code', " . $this->Ini->date_delim . $this->activate_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->seg_m_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->seg_m_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->seg_t_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->seg_t_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->ter_m_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->ter_m_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->ter_t_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->ter_t_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->qua_m_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->qua_m_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->qua_t_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->qua_t_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->qui_m_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->qui_m_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->qui_t_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->qui_t_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->sex_m_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->sex_m_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->sex_t_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->sex_t_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->sab_m_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->sab_m_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->sab_t_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->sab_t_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->dom_m_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->dom_m_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->dom_t_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->dom_t_ate . $this->Ini->date_delim1 . ", '$this->website')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "fk_classificacao, classificacao1, classificacao2, cnpj, inscricao, razao, fantasia, datacadastro, cidade, estado, bairro, rua, complemento, numero, cep, fachada, latitude, longitude, email, telefone, senha_usuario, nome_contato, ativo, rash, activate_code, activate_date, seg_m_de, seg_m_ate, seg_t_de, seg_t_ate, ter_m_de, ter_m_ate, ter_t_de, ter_t_ate, qua_m_de, qua_m_ate, qua_t_de, qua_t_ate, qui_m_de, qui_m_ate, qui_t_de, qui_t_ate, sex_m_de, sex_m_ate, sex_t_de, sex_t_ate, sab_m_de, sab_m_ate, sab_t_de, sab_t_ate, dom_m_de, dom_m_ate, dom_t_de, dom_t_ate, website) VALUES (" . $NM_seq_auto . "$this->fk_classificacao, '$this->classificacao1', '$this->classificacao2', '$this->cnpj', '$this->inscricao', '$this->razao', '$this->fantasia', " . $this->Ini->date_delim . $this->datacadastro . $this->Ini->date_delim1 . ", '$this->cidade', '$this->estado', '$this->bairro', '$this->rua', '$this->complemento', '$this->numero', '$this->cep', '$this->fachada', '$this->latitude', '$this->longitude', '$this->email', '$this->telefone', '$this->senha_usuario', '$this->nome_contato', $this->ativo, '$this->rash', '$this->activate_code', " . $this->Ini->date_delim . $this->activate_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->seg_m_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->seg_m_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->seg_t_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->seg_t_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->ter_m_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->ter_m_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->ter_t_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->ter_t_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->qua_m_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->qua_m_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->qua_t_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->qua_t_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->qui_m_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->qui_m_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->qui_t_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->qui_t_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->sex_m_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->sex_m_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->sex_t_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->sex_t_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->sab_m_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->sab_m_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->sab_t_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->sab_t_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->dom_m_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->dom_m_ate . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->dom_t_de . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->dom_t_ate . $this->Ini->date_delim1 . ", '$this->website')"; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['parms'] = "pk_contrato?#?$this->pk_contrato?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("cnpj = '" . $_SESSION['usr_cnpj'] . "'");
      ...
      { 
          ...
          $qt_geral_reg_form_ap_contrato_updt_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['total'] = $qt_geral_reg_form_ap_contrato_updt_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->pk_contrato))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_ap_contrato_updt_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start'] > $qt_geral_reg_form_ap_contrato_updt_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start'] = $qt_geral_reg_form_ap_contrato_updt_mob; 
          }
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['total'] + 1; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      if ($this->nmgp_opcao != "novo" && $this->nmgp_opcao != "nada" && $this->nmgp_opcao != "refresh_insert") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              $this->classificacao1 = $rs->fields[2] ; 
              $this->nmgp_dados_select['classificacao1'] = $this->classificacao1;
              $this->classificacao2 = $rs->fields[3] ; 
              $this->nmgp_dados_select['classificacao2'] = $this->classificacao2;
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['parms'] = "pk_contrato?#?$this->pk_contrato?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['sub_dir'][0]  = "" . $_SESSION['pastacliente'];
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start'] < $qt_geral_reg_form_ap_contrato_updt_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dados_select'];
                  $this->fk_classificacao = $this->nmgp_dados_select['fk_classificacao'];  
                  $this->classificacao1 = $this->nmgp_dados_select['classificacao1'];  
                  $this->classificacao2 = $this->nmgp_dados_select['classificacao2'];  
                  ...
                  $this->website = $this->nmgp_dados_select['website'];  
              }
          }
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['foreign_key']))
          {
...
function cep_onChange($complemento)
{
$_SESSION['scriptcase']['form_ap_contrato_updt_mob']['contr_erro'] = 'on';
...
switch($resultado_busca['resultado']){
   case '2':
      $this->cidade  =$this->act_retiraAcento ( $resultado_busca['cidade'] );
      $this->estado  = $resultado_busca['uf'];
   break;
   case '1':
   $this->rua  =$this->act_retiraAcento ( $resultado_busca['logradouro'] );
   $this->bairro  =$this->act_retiraAcento ( $resultado_busca['bairro'] );
   $this->cidade  =$this->act_retiraAcento ( $resultado_busca['cidade'] );
   $this->estado  = $resultado_busca['uf'];
   break;   
   default:
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
    ...
    include_once("form_ap_contrato_updt_mob_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['empty_filter']);
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "classificacao1", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "classificacao2", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "nome_contato", $arg_search, $data_search);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_filter_form'] . " and (cnpj = '" . $_SESSION['usr_cnpj'] . "') and (" . $comando . ")";
      }
      else
      {
          $sc_where = " where cnpj = '" . $_SESSION['usr_cnpj'] . "' and (" . $comando . ")";
      }
      $nmgp_select = "SELECT count(*) from " . $this->Ini->nm_tabela . $sc_where; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
      $rt = $this->Db->Execute($nmgp_select) ; 
      ...
      $qt_geral_reg_form_ap_contrato_updt_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['total'] = $qt_geral_reg_form_ap_contrato_updt_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_ap_contrato_updt_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_ap_contrato_updt_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_ap_contrato_updt_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
