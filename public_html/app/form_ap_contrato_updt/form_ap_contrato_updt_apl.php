<?php
//
class form_ap_contrato_updt_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->usr_cnpj)) 
          {
              $_SESSION['usr_cnpj'] = $this->usr_cnpj;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_ap_contrato_updt_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['initialize'])
          {
              $_SESSION['scriptcase']['form_ap_contrato_updt']['contr_erro'] = 'on';
             ?>
...
$_SESSION['scriptcase']['form_ap_contrato_updt']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_ap_contrato_updt']['upload_field_info']['fachada'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_ap_contrato_updt',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_ap_contrato_updt']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_ap_contrato_updt'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_ap_contrato_updt']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_ap_contrato_updt']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_ap_contrato_updt') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_ap_contrato_updt']['label'] = "CHECK-IN CASH | REGISTRO DE CONTRATO";
      ...
      $_SESSION['scriptcase']['error_icon']['form_ap_contrato_updt']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_ap_contrato_updt'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['upload_field_ul_name'][$this->fachada_ul_name]))
          {
              $this->NM_ajax_info['param']['fachada_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['upload_field_ul_name'][$this->fachada_ul_name];
          }
      ...
      elseif (isset($this->fachada_ul_name) && '' != $this->fachada_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['upload_field_ul_name'][$this->fachada_ul_name]))
          {
              $this->fachada_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['upload_field_ul_name'][$this->fachada_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_orig'] = " where cnpj = '" . $_SESSION['usr_cnpj'] . "'";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_pesq'] = " where cnpj = '" . $_SESSION['usr_cnpj'] . "'";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_contrato_updt']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_ap_contrato_updt'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_ap_contrato_updt'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_ap_contrato_updt", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_ap_contrato_updt_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_ap_contrato_updt_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_ap_contrato_updt/form_ap_contrato_updt_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_ap_contrato_updt_erro.class.php"); 
      }
      $this->Erro      = new form_ap_contrato_updt_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['opcao']))
         { 
             if ($this->pk_contrato != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_contrato_updt']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['cnpj']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cnpj = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['cnpj'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['razao']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->razao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['razao'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['cep']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cep = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['cep'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['cidade']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cidade = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['cidade'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['estado']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->estado = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['estado'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['bairro']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->bairro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['bairro'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['rua']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->rua = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['rua'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['complemento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->complemento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['complemento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['numero']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->numero = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select']['numero'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['sc_redir_atualiz'] == "ok")
          {
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_ap_contrato_updt']) || !is_array($this->NM_ajax_info['errList']['geral_form_ap_contrato_updt']))
              {
                  $this->NM_ajax_info['errList']['geral_form_ap_contrato_updt'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_ap_contrato_updt'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_ap_contrato_updt' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_ap_contrato_updt']['contr_erro'] = 'off'; 
    ...
    function ValidateField_cnpj(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['cnpj']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['cnpj'] == "on") 
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['razao']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['razao'] == "on")) 
      { 
          if ($this->razao == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['fantasia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['fantasia'] == "on")) 
      { 
          if ($this->fantasia == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['senha_usuario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['senha_usuario'] == "on")) 
      { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['retype_senha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['retype_senha'] == "on")) 
      { 
    ...
    function ValidateField_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['email'] == "on") 
          { 
              $Campos_Falta[] = "Email" ; 
              if (!isset($Campos_Erros['email']))
              {
    ...
    {
        global $teste_validade;
      if ($this->fk_classificacao == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['fk_classificacao']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['fk_classificacao'] == "on"))
      {
          ...
          if (!empty($this->fk_classificacao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['Lookup_fk_classificacao']) && !in_array($this->fk_classificacao, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['Lookup_fk_classificacao']))
          {
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['nome_contato']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['nome_contato'] == "on")) 
      { 
    ...
    function ValidateField_telefone(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['telefone']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['telefone'] == "on")) 
      { 
          if ($this->telefone == "")  
          { 
    ...
    function ValidateField_cep(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['cep']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['cep'] == "on") 
           { 
              $Campos_Falta[] = "CEP" ; 
              if (!isset($Campos_Erros['cep']))
              {
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['cidade']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['cidade'] == "on")) 
      { 
          if ($this->cidade == "")  
          { 
              $Campos_Falta[] =  "Cidade" ; 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['estado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['estado'] == "on")) 
      { 
          if ($this->estado == "")  
          { 
              $Campos_Falta[] =  "Estado" ; 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['bairro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['bairro'] == "on")) 
      { 
          if ($this->bairro == "")  
          { 
              $Campos_Falta[] =  "Bairro" ; 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['rua']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['rua'] == "on")) 
      { 
          if ($this->rua == "")  
          { 
              $Campos_Falta[] =  "Rua" ; 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['numero']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['numero'] == "on")) 
      { 
          if ($this->numero == "")  
          { 
              $Campos_Falta[] =  "Numero" ; 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['website']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['php_cmp_required']['website'] == "on")) 
      { 
          if ($this->website == "")  
          { 
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'form_ap_contrato_updt_doc_name.php';
              }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['pk_contrato']['keyVal'] = form_ap_contrato_updt_pack_protect_string($this->nmgp_dados_form['pk_contrato']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_ap_contrato_updt_pack_protect_string('1') => form_ap_contrato_updt_pack_protect_string("SIM"));
$aLookup[] = array(form_ap_contrato_updt_pack_protect_string('0') => form_ap_contrato_updt_pack_protect_string("NÃO"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['Lookup_ativo'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['Lookup_ativo'][] = '0';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"ativo\"";
          ...
          {
              $this->NM_ajax_info['fldList']['ativo']['valList'][$i] = form_ap_contrato_updt_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['Lookup_fk_classificacao']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['Lookup_fk_classificacao'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['Lookup_fk_classificacao']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['Lookup_fk_classificacao'] = array(); 
}
$aLookup[] = array(form_ap_contrato_updt_pack_protect_string('') => form_ap_contrato_updt_pack_protect_string('SELECIONE'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['Lookup_fk_classificacao'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_ap_contrato_updt_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_ap_contrato_updt_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['Lookup_fk_classificacao'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fk_classificacao']['valList'][$i] = form_ap_contrato_updt_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   { 
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
$_SESSION['scriptcase']['form_ap_contrato_updt']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $this->website = $this->website_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['parms'] = "pk_contrato?#?$this->pk_contrato?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      ...
      { 
          ...
          $qt_geral_reg_form_ap_contrato_updt = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['total'] = $qt_geral_reg_form_ap_contrato_updt;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->pk_contrato))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_ap_contrato_updt = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start'] > $qt_geral_reg_form_ap_contrato_updt)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start'] = $qt_geral_reg_form_ap_contrato_updt; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_ap_contrato_updt) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start'] = 0;
      }
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['parms'] = "pk_contrato?#?$this->pk_contrato?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['sub_dir'][0]  = "" . $_SESSION['pastacliente'];
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['reg_start'] < $qt_geral_reg_form_ap_contrato_updt;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['opcao']   = '';
          }
      } 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
    ...
    include_once("form_ap_contrato_updt_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_filter_form'] . " and (cnpj = '" . $_SESSION['usr_cnpj'] . "') and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_ap_contrato_updt = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['total'] = $qt_geral_reg_form_ap_contrato_updt;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_ap_contrato_updt_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_ap_contrato_updt_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_ap_contrato_updt_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt']['masterValue'] as $cmp_master => $val_master)
        {
?>
