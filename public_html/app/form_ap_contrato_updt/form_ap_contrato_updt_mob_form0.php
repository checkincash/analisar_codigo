...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_ap_contrato_updt/form_ap_contrato_updt_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_ap_contrato_updt_mob_sajax_js.php");
?>
<script type="text/javascript">
...
function summary_atualiza(reg_ini, reg_qtd, reg_tot)
{
 ...
 function nm_field_disabled(Fields, Opt) {
  ...
  for (i=0; i < Field.length; i++)
  {
     ...
     if (F_name == "razao")
     {
        $('input[name="razao"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('input[name="razao"]').addClass("scFormInputDisabled");
        }
        else {
            $('input[name="razao"]').removeClass("scFormInputDisabled");
        }
     }
     if (F_name == "cep")
     {
        $('input[name="cep"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('input[name="cep"]').addClass("scFormInputDisabled");
        }
        else {
            $('input[name="cep"]').removeClass("scFormInputDisabled");
        }
        $('input[id="cep_cep"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('#cep_cep').hide();
        }
        else {
     ...
     if (F_name == "cidade")
     {
        $('input[name="cidade"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('input[name="cidade"]').addClass("scFormInputDisabled");
        }
        else {
            $('input[name="cidade"]').removeClass("scFormInputDisabled");
        }
     }
     if (F_name == "estado")
     {
        $('input[name="estado"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('input[name="estado"]').addClass("scFormInputDisabled");
        }
        else {
            $('input[name="estado"]').removeClass("scFormInputDisabled");
        }
     }
     if (F_name == "bairro")
     {
        $('input[name="bairro"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('input[name="bairro"]').addClass("scFormInputDisabled");
        }
        else {
            $('input[name="bairro"]').removeClass("scFormInputDisabled");
        }
     }
     if (F_name == "rua")
     {
        $('input[name="rua"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('input[name="rua"]').addClass("scFormInputDisabled");
        }
        else {
            $('input[name="rua"]').removeClass("scFormInputDisabled");
        }
     }
     if (F_name == "complemento")
     {
        $('input[name="complemento"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('input[name="complemento"]').addClass("scFormInputDisabled");
        }
        else {
            $('input[name="complemento"]').removeClass("scFormInputDisabled");
        }
     }
     if (F_name == "numero")
     {
...
include_once('form_ap_contrato_updt_mob_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['recarga'];
}
?>
...
<?php
 include_once("form_ap_contrato_updt_mob_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/nm_rpc.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
<form  name="F1" method="post" enctype="multipart/form-data" 
               action="form_ap_contrato_updt_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['insert_validation']; ?>">
<?php
}
?>
...
<input type="hidden" name="pk_contrato" value="<?php  echo $this->form_encode_input($this->pk_contrato) ?>">
<input type="hidden" name="fachada_salva" value="<?php  echo $this->form_encode_input($this->fachada) ?>">
<input type="hidden" name="_sc_force_mobile" id="sc-id-mobile-control" value="" />
<?php
$_SESSION['scriptcase']['error_span_title']['form_ap_contrato_updt_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_ap_contrato_updt_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['fast_search'][2] : "";
?> 
...
<?php echo nmButtonOutput($this->arr_buttons, "bincluir", "nm_atualiza ('incluir');", "nm_atualiza ('incluir');", "sc_b_ins_t", "", "INCLUIR CONTRATO", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "group_2_t");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bcancelar", "" . $this->NM_cancel_insert_new . " document.F5.submit();", "" . $this->NM_cancel_insert_new . " document.F5.submit();", "sc_b_sai_t", "", "VOLTAR", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "group_2_t");?>
  </div>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "document.F6.action='" . $nm_url_saida. "'; document.F6.submit(); return false;", "document.F6.action='" . $nm_url_saida. "'; document.F6.submit(); return false;", "sc_b_sai_t", "", "SAIR", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 
<?php
        $NM_btn = true;
    }
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
   ...
   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont" style="color: 003366">IDENTIFICAÇÃO</TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cnpj_line" id="hidden_field_data_cnpj" style="<?php echo $sStyleHidden_cnpj; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cnpj_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cnpj_label"><span id="id_label_cnpj"><?php echo $this->nm_new_label['cnpj']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['cnpj']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['cnpj'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['razao'] = "Razão Social";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_razao_line" id="hidden_field_data_razao" style="<?php echo $sStyleHidden_razao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_razao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_razao_label"><span id="id_label_razao"><?php echo $this->nm_new_label['razao']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['razao']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['razao'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
$ativo_look = "";
 ...
 if (empty($ativo_look)) { $ativo_look = $this->ativo; }
?>
<span id="id_read_on_ativo" class="css_ativo_line"  style="<?php echo $sStyleReadLab_ativo; ?>"><?php echo $this->form_encode_input($ativo_look); ?></span><span id="id_read_off_ativo" style="<?php echo $sStyleReadInp_ativo; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['Lookup_ativo'][] = '1'; ?>
 <option  value="0" <?php  if ($this->ativo == "0") { echo " selected" ;} ?>>NÃO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['Lookup_ativo'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_senha_usuario_line" id="hidden_field_data_senha_usuario" style="<?php echo $sStyleHidden_senha_usuario; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_senha_usuario_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_senha_usuario_label"><span id="id_label_senha_usuario"><?php echo $this->nm_new_label['senha_usuario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['senha_usuario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['senha_usuario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_retype_senha_line" id="hidden_field_data_retype_senha" style="<?php echo $sStyleHidden_retype_senha; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_retype_senha_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_retype_senha_label"><span id="id_label_retype_senha"><?php echo $this->nm_new_label['retype_senha']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['retype_senha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['retype_senha'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fk_classificacao_line" id="hidden_field_data_fk_classificacao" style="<?php echo $sStyleHidden_fk_classificacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fk_classificacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fk_classificacao_label"><span id="id_label_fk_classificacao"><?php echo $this->nm_new_label['fk_classificacao']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['fk_classificacao']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['fk_classificacao'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['classificacao1'] = "Classificação 1";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['classificacao2'] = "Classificação 2";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php $sStyleHidden_classificacao2_dumb = ('' == $sStyleHidden_classificacao2) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_classificacao2_dumb" style="<?php echo $sStyleHidden_classificacao2_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_telefone_line" id="hidden_field_data_telefone" style="<?php echo $sStyleHidden_telefone; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_telefone_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_telefone_label"><span id="id_label_telefone"><?php echo $this->nm_new_label['telefone']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['telefone']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['telefone'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_seg_m_de_line" id="hidden_field_data_seg_m_de" style="<?php echo $sStyleHidden_seg_m_de; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_seg_m_de_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_seg_m_de_label"><span id="id_label_seg_m_de"><?php echo $this->nm_new_label['seg_m_de']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_seg_m_ate_line" id="hidden_field_data_seg_m_ate" style="<?php echo $sStyleHidden_seg_m_ate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_seg_m_ate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_seg_m_ate_label"><span id="id_label_seg_m_ate"><?php echo $this->nm_new_label['seg_m_ate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_seg_t_de_line" id="hidden_field_data_seg_t_de" style="<?php echo $sStyleHidden_seg_t_de; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_seg_t_de_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_seg_t_de_label"><span id="id_label_seg_t_de"><?php echo $this->nm_new_label['seg_t_de']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_seg_t_ate_line" id="hidden_field_data_seg_t_ate" style="<?php echo $sStyleHidden_seg_t_ate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_seg_t_ate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_seg_t_ate_label"><span id="id_label_seg_t_ate"><?php echo $this->nm_new_label['seg_t_ate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ter_m_de_line" id="hidden_field_data_ter_m_de" style="<?php echo $sStyleHidden_ter_m_de; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ter_m_de_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ter_m_de_label"><span id="id_label_ter_m_de"><?php echo $this->nm_new_label['ter_m_de']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ter_m_ate_line" id="hidden_field_data_ter_m_ate" style="<?php echo $sStyleHidden_ter_m_ate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ter_m_ate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ter_m_ate_label"><span id="id_label_ter_m_ate"><?php echo $this->nm_new_label['ter_m_ate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ter_t_de_line" id="hidden_field_data_ter_t_de" style="<?php echo $sStyleHidden_ter_t_de; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ter_t_de_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ter_t_de_label"><span id="id_label_ter_t_de"><?php echo $this->nm_new_label['ter_t_de']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ter_t_ate_line" id="hidden_field_data_ter_t_ate" style="<?php echo $sStyleHidden_ter_t_ate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ter_t_ate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ter_t_ate_label"><span id="id_label_ter_t_ate"><?php echo $this->nm_new_label['ter_t_ate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_qua_m_de_line" id="hidden_field_data_qua_m_de" style="<?php echo $sStyleHidden_qua_m_de; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qua_m_de_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_qua_m_de_label"><span id="id_label_qua_m_de"><?php echo $this->nm_new_label['qua_m_de']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_qua_m_ate_line" id="hidden_field_data_qua_m_ate" style="<?php echo $sStyleHidden_qua_m_ate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qua_m_ate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_qua_m_ate_label"><span id="id_label_qua_m_ate"><?php echo $this->nm_new_label['qua_m_ate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_qua_t_de_line" id="hidden_field_data_qua_t_de" style="<?php echo $sStyleHidden_qua_t_de; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qua_t_de_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_qua_t_de_label"><span id="id_label_qua_t_de"><?php echo $this->nm_new_label['qua_t_de']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_qua_t_ate_line" id="hidden_field_data_qua_t_ate" style="<?php echo $sStyleHidden_qua_t_ate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qua_t_ate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_qua_t_ate_label"><span id="id_label_qua_t_ate"><?php echo $this->nm_new_label['qua_t_ate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_qui_m_de_line" id="hidden_field_data_qui_m_de" style="<?php echo $sStyleHidden_qui_m_de; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qui_m_de_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_qui_m_de_label"><span id="id_label_qui_m_de"><?php echo $this->nm_new_label['qui_m_de']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_qui_m_ate_line" id="hidden_field_data_qui_m_ate" style="<?php echo $sStyleHidden_qui_m_ate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qui_m_ate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_qui_m_ate_label"><span id="id_label_qui_m_ate"><?php echo $this->nm_new_label['qui_m_ate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_qui_t_de_line" id="hidden_field_data_qui_t_de" style="<?php echo $sStyleHidden_qui_t_de; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qui_t_de_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_qui_t_de_label"><span id="id_label_qui_t_de"><?php echo $this->nm_new_label['qui_t_de']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_qui_t_ate_line" id="hidden_field_data_qui_t_ate" style="<?php echo $sStyleHidden_qui_t_ate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qui_t_ate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_qui_t_ate_label"><span id="id_label_qui_t_ate"><?php echo $this->nm_new_label['qui_t_ate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sex_m_de_line" id="hidden_field_data_sex_m_de" style="<?php echo $sStyleHidden_sex_m_de; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sex_m_de_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sex_m_de_label"><span id="id_label_sex_m_de"><?php echo $this->nm_new_label['sex_m_de']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sex_m_ate_line" id="hidden_field_data_sex_m_ate" style="<?php echo $sStyleHidden_sex_m_ate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sex_m_ate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sex_m_ate_label"><span id="id_label_sex_m_ate"><?php echo $this->nm_new_label['sex_m_ate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sex_t_de_line" id="hidden_field_data_sex_t_de" style="<?php echo $sStyleHidden_sex_t_de; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sex_t_de_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sex_t_de_label"><span id="id_label_sex_t_de"><?php echo $this->nm_new_label['sex_t_de']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sex_t_ate_line" id="hidden_field_data_sex_t_ate" style="<?php echo $sStyleHidden_sex_t_ate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sex_t_ate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sex_t_ate_label"><span id="id_label_sex_t_ate"><?php echo $this->nm_new_label['sex_t_ate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sab_m_de_line" id="hidden_field_data_sab_m_de" style="<?php echo $sStyleHidden_sab_m_de; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sab_m_de_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sab_m_de_label"><span id="id_label_sab_m_de"><?php echo $this->nm_new_label['sab_m_de']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sab_m_ate_line" id="hidden_field_data_sab_m_ate" style="<?php echo $sStyleHidden_sab_m_ate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sab_m_ate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sab_m_ate_label"><span id="id_label_sab_m_ate"><?php echo $this->nm_new_label['sab_m_ate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sab_t_de_line" id="hidden_field_data_sab_t_de" style="<?php echo $sStyleHidden_sab_t_de; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sab_t_de_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sab_t_de_label"><span id="id_label_sab_t_de"><?php echo $this->nm_new_label['sab_t_de']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sab_t_ate_line" id="hidden_field_data_sab_t_ate" style="<?php echo $sStyleHidden_sab_t_ate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sab_t_ate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sab_t_ate_label"><span id="id_label_sab_t_ate"><?php echo $this->nm_new_label['sab_t_ate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dom_m_de_line" id="hidden_field_data_dom_m_de" style="<?php echo $sStyleHidden_dom_m_de; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dom_m_de_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_dom_m_de_label"><span id="id_label_dom_m_de"><?php echo $this->nm_new_label['dom_m_de']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dom_m_ate_line" id="hidden_field_data_dom_m_ate" style="<?php echo $sStyleHidden_dom_m_ate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dom_m_ate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_dom_m_ate_label"><span id="id_label_dom_m_ate"><?php echo $this->nm_new_label['dom_m_ate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dom_t_de_line" id="hidden_field_data_dom_t_de" style="<?php echo $sStyleHidden_dom_t_de; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dom_t_de_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_dom_t_de_label"><span id="id_label_dom_t_de"><?php echo $this->nm_new_label['dom_t_de']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dom_t_ate_line" id="hidden_field_data_dom_t_ate" style="<?php echo $sStyleHidden_dom_t_ate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dom_t_ate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_dom_t_ate_label"><span id="id_label_dom_t_ate"><?php echo $this->nm_new_label['dom_t_ate']; ?></span></span><br>
...
<?php $sStyleHidden_dom_t_ate_dumb = ('' == $sStyleHidden_dom_t_ate) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_dom_t_ate_dumb" style="<?php echo $sStyleHidden_dom_t_ate_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cidade_line" id="hidden_field_data_cidade" style="<?php echo $sStyleHidden_cidade; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cidade_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cidade_label"><span id="id_label_cidade"><?php echo $this->nm_new_label['cidade']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['cidade']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['cidade'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_estado_line" id="hidden_field_data_estado" style="<?php echo $sStyleHidden_estado; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_estado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_estado_label"><span id="id_label_estado"><?php echo $this->nm_new_label['estado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['estado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['estado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_bairro_line" id="hidden_field_data_bairro" style="<?php echo $sStyleHidden_bairro; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bairro_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_bairro_label"><span id="id_label_bairro"><?php echo $this->nm_new_label['bairro']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['bairro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['bairro'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rua_line" id="hidden_field_data_rua" style="<?php echo $sStyleHidden_rua; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rua_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rua_label"><span id="id_label_rua"><?php echo $this->nm_new_label['rua']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['rua']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['rua'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_numero_line" id="hidden_field_data_numero" style="<?php echo $sStyleHidden_numero; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numero_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_numero_label"><span id="id_label_numero"><?php echo $this->nm_new_label['numero']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['numero']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['numero'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_website_line" id="hidden_field_data_website" style="<?php echo $sStyleHidden_website; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_website_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_website_label"><span id="id_label_website"><?php echo $this->nm_new_label['website']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['website']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['php_cmp_required']['website'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_updt_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_ap_contrato_updt_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_ap_contrato_updt_mob");
 parent.scAjaxDetailHeight("form_ap_contrato_updt_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
