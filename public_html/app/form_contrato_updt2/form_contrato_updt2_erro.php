...
$old_error_handler = set_error_handler("form_contrato_updt2_scriptcase_error_handler");

function form_contrato_updt2_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_contrato_updt2']['contr_erro']) && $_SESSION['scriptcase']['form_contrato_updt2']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_contrato_updt2->contr_form_contrato_updt2->Apl_com_erro = true;
            if ($inicial_form_contrato_updt2->contr_form_contrato_updt2->NM_ajax_flag)
            {
                $inicial_form_contrato_updt2->contr_form_contrato_updt2->NM_ajax_info['errList']['geral_form_contrato_updt2'][] = $msg;
                return;
            }
            form_contrato_updt2_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_contrato_updt2_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_contrato_updt2'])  && '' != $_SESSION['scriptcase']['error_icon']['form_contrato_updt2'])  ? $_SESSION['scriptcase']['error_icon']['form_contrato_updt2']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_contrato_updt2']) && '' != $_SESSION['scriptcase']['error_span_title']['form_contrato_updt2']) ? $_SESSION['scriptcase']['error_span_title']['form_contrato_updt2'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_contrato_updt2']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_contrato_updt2']) ? $_SESSION['scriptcase']['error_icon_title']['form_contrato_updt2'] : '';
?>
