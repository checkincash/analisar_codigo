...
class consulta_eventos_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "consulta_eventos.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<consulta_eventos";
...
$_SESSION['scriptcase']['consulta_eventos']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_situacao))
         {
             $this->look_situacao = sc_convert_encoding($this->look_situacao, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " situacao =\"" . $this->trata_dados($this->look_situacao) . "\"";
   }
   //----- data_criacao
   function NM_export_data_criacao()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->data_criacao))
         {
             $this->data_criacao = sc_convert_encoding($this->data_criacao, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " data_criacao =\"" . $this->trata_dados($this->data_criacao) . "\"";
   }
   //----- nomenclatura
   function NM_export_nomenclatura()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->nomenclatura))
         {
             $this->nomenclatura = sc_convert_encoding($this->nomenclatura, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " nomenclatura =\"" . $this->trata_dados($this->nomenclatura) . "\"";
   }
   //----- estado
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_destaque))
         {
             $this->look_destaque = sc_convert_encoding($this->look_destaque, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " destaque =\"" . $this->trata_dados($this->look_destaque) . "\"";
   }
   //----- pk_publicador
   function NM_export_pk_publicador()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->pk_publicador))
         {
             $this->pk_publicador = sc_convert_encoding($this->pk_publicador, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " pk_publicador =\"" . $this->trata_dados($this->pk_publicador) . "\"";
   }
   //----- fk_contrato
   function NM_export_fk_contrato()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->fk_contrato))
         {
             $this->fk_contrato = sc_convert_encoding($this->fk_contrato, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " fk_contrato =\"" . $this->trata_dados($this->fk_contrato) . "\"";
   }
   //----- foto_publicacao
   function NM_export_foto_publicacao()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->foto_publicacao))
         {
             $this->foto_publicacao = sc_convert_encoding($this->foto_publicacao, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " foto_publicacao =\"" . $this->trata_dados($this->foto_publicacao) . "\"";
   }
   //----- texto_publicacao
   function NM_export_texto_publicacao()
   {
         ...
         $this->xml_registro .= " texto_publicacao =\"" . $this->trata_dados($this->texto_publicacao) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
