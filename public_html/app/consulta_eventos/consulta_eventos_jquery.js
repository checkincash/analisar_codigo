...
function ajax_navigate(opc, parm)
{
    ...
    $.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_consulta_eventos').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_consulta_eventos').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_consulta_eventos').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_consulta_eventos').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_consulta_eventos').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_consulta_eventos').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_consulta_eventos').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_consulta_eventos').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_consulta_eventos').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_consulta_eventos').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_consulta_eventos').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_consulta_eventos').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
