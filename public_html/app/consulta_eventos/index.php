<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['consulta_eventos']['glo_nm_perfil']          = "conn_checkin";
   $_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_doc']        = "";
//
class consulta_eventos_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
   ...
   var $Gd_missing;
   var $sc_site_ssl;
   var $link_form_ap_eventos_publicador;
   var $nm_cont_lin;
   var $nm_limite_lin;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['decimal_db'] = "."; 

      $this->nm_cod_apl      = "consulta_eventos"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      //check prod
      if(empty($_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
      //check img
      if(empty($_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_imagens']))
      {
              /*check img*/$_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
      }
      //check tmp
      if(empty($_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_imag_temp']))
      {
              /*check tmp*/$_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
      }
      //check doc
      if(empty($_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_doc']))
      {
              /*check doc*/$_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
      }
      //end check publication with the prod
      $this->sc_site_ssl     = (isset($_SERVER['HTTP_REFERER']) && strtolower(substr($_SERVER['HTTP_REFERER'], 0, 5)) == 'https') ? true : false;
      $this->sc_protocolo    = ($this->sc_site_ssl) ? 'https://' : 'http://';
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['consulta_eventos']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/consulta_eventos';
      ...
      {
          include_once("consulta_eventos_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_add_dyn_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dyn_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dyn_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
      if (isset($_GET['nmgp_opcao']) && $_GET['nmgp_opcao'] == "ajax_aut_comp_dyn_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dyn_search_aut_comp']['cmp'] = $_GET['field'];
          $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['opcao'] = $_GET['origem'];
          $nmgp_opcao = $_GET['origem'];
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['compact_mode']    = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      $Tmp_apl_lig = "form_ap_eventos_publicador";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/form_ap_eventos_publicador_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/form_ap_eventos_publicador_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/form_ap_eventos_publicador_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/form_ap_eventos_publicador_ini.txt");
          if (isset($L_md5[6]) && trim($L_md5[6]) == "LigMd5")
          {
              $this->sc_lig_md5["form_ap_eventos_publicador"] = 'S';
          }
      }
      $this->sc_lig_target["A_@scinf_"] = '_self';
      if ($_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["consulta_eventos"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["consulta_eventos"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      $this->link_form_ap_eventos_publicador =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_ap_eventos_publicador') . "/" ; 
      if ($Tp_init == "Path_sub")
      {
          return;
      }
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['consulta_eventos']['glo_nm_conexao']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['consulta_eventos']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['consulta_eventos']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "consulta_eventos_erro.class.php"); 
      $this->Erro = new consulta_eventos_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('consulta_eventos'); 
// 
...
$_SESSION['scriptcase']['consulta_eventos']['contr_erro'] = 'off'; 
          $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['initialize'] = false;
      } 
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['consulta_eventos']['glo_nm_conexao']) && $_SESSION['scriptcase']['consulta_eventos']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['consulta_eventos']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['consulta_eventos']['glo_nm_perfil']) && $_SESSION['scriptcase']['consulta_eventos']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['consulta_eventos']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['consulta_eventos']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['consulta_eventos']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['consulta_eventos']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['consulta_eventos']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['consulta_eventos']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['consulta_eventos']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['consulta_eventos']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['consulta_eventos']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['consulta_eventos']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['consulta_eventos']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['consulta_eventos']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['consulta_eventos']['glo_nm_conexao'], $this->root . $this->path_prod, 'CheckIn'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['consulta_eventos']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class consulta_eventos_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['consulta_eventos']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['consulta_eventos'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class consulta_eventos_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['consulta_eventos']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['consulta_eventos'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida'] || $Parms_form_pdf)
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_consulta_eventos($cadapar[1]);
                       nm_protect_num_consulta_eventos($cadapar[0], $cadapar[1]);
          ...
          if (isset($usr_cnpj)) 
          {
              ...
              nm_limpa_str_consulta_eventos($_SESSION["usr_cnpj"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini) 
      { 
          $this->Ini = new consulta_eventos_ini(); 
          $this->Ini->init();
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['consulta_eventos']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['consulta_eventos'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['consulta_eventos']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['consulta_eventos']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('consulta_eventos') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['consulta_eventos']['label'] = "EVENTOS";
      ...
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("pt_br");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "consulta_eventos/consulta_eventos_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "consulta_eventos_erro.class.php"); 
      } 
      $this->Erro      = new consulta_eventos_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "consulta_eventos/consulta_eventos_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "consulta_eventos_lookup.class.php"); 
      } 
      $this->Lookup       = new consulta_eventos_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['ajax_nav'] = true;
              $_SESSION['scriptcase']['saida_var']  = true;
              $_SESSION['scriptcase']['saida_html'] = "";
              $this->Ini->Arr_result = array();
              $nmgp_opcao = $_POST['opc'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] = $nmgp_opcao;
              if (isset($_POST['parm']) && $_POST['parm'] == "save_grid")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['save_grid'] = true;
              }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['SC_All_Groupby'] = array('_NM_SC_' => 'grid');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['SC_Ind_Groupby'] = $Ind;
      } 
      $this->Ini->Apl_resumo  = "consulta_eventos_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "consulta_eventos_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['SC_Ind_Groupby'] . ".class.php"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['pdf_det'] = false;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida_treeview'] = false;
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['field_order'][] = "situacao";
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['field_order'][] = "data_criacao";
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['field_order'][] = "nomenclatura";
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['field_order'][] = "estado";
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['field_order'][] = "cidade";
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['field_order'][] = "destaque";
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['field_order'][] = "pk_publicador";
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['field_order'][] = "fk_contrato";
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['field_order'][] = "foto_publicacao";
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['field_order'][] = "texto_publicacao";
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['field_order_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['field_order'];
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['usr_cmp_sel']['pk_publicador'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['usr_cmp_sel']['fk_contrato'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['usr_cmp_sel']['foto_publicacao'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['usr_cmp_sel']['texto_publicacao'] = "off";
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['consulta_eventos']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['consulta_eventos']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['consulta_eventos']['exit'];
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_orig']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] = "inicio" ;  
      }   
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['consulta_eventos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['consulta_eventos']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] = "busca";
          }   
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opc_liga'] = $NMSC_conf_apl;  
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['print_all'] = true;
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "fast_search")  
      { 
          $this->SC_fast_search($GLOBALS["nmgp_fast_search"], $GLOBALS["nmgp_cond_fast_search"], $GLOBALS["nmgp_arg_fast_search"]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq'])
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] = 'igual';
          } 
          else 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['contr_array_resumo'] = "NAO";
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] = 'pesq';
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['orig_pesq'] = 'grid';
          } 
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "dyn_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "dyn_search_clear")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "dyn_search_clear")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['dyn_search_clear'] = true;
          } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] = 'inicio';
          } 
      } 
//
      ...
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['prim_cons'] = true;  
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq_fast'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['contr_total_geral'] = "NAO";
      ...
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida'])
      {
         ...
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_consulta_eventos_html_" . session_id() . "_2.html";
            ...
            {
                $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_consulta_eventos.pdf";
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            }
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_consulta_eventos_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_consulta_eventos_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['word_name']))
          {
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_consulta_eventos_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "consulta_eventos/consulta_eventos_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "consulta_eventos_xls.class.php"); 
          } 
          $this->xls  = new consulta_eventos_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "consulta_eventos/consulta_eventos_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "consulta_eventos_xml.class.php"); 
          } 
          $this->xml  = new consulta_eventos_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "consulta_eventos/consulta_eventos_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "consulta_eventos_csv.class.php"); 
          } 
          $this->csv  = new consulta_eventos_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "consulta_eventos/consulta_eventos_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "consulta_eventos_rtf.class.php"); 
          } 
          $this->rtf  = new consulta_eventos_rtf();
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . consulta_eventos . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new consulta_eventos_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'], 8));
          }
          else
          { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "consulta_eventos_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "consulta_eventos_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new consulta_eventos_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "consulta_eventos/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
          } 
          $this->Res = new consulta_eventos_resumo("out");
          $this->prep_modulos("Res");
          $this->Res->monta_resumo();
      }
      else 
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_consulta_eventos_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "consulta_eventos/consulta_eventos_grid.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "consulta_eventos_grid.class.php"); 
          } 
          $this->grid  = new consulta_eventos_grid();
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['embutida'])
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['ajax_nav'])
         {
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['opcao'] != "ajax_detalhe")  
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['pdf_det'])
            {
            ...
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['pdf_name']))
            {
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['pdf_name']);
            }
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['pdf_file'] = $nm_arquivo_pdf_serv;
}
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if (!is_file($nm_arquivo_pdf_serv))
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          $tmp_cmd = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq_fast'] = "";
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_orig'])) 
          {
              $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_orig']; 
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq_filtro'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq_filtro'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq_filtro'] . ")"; 
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq'] = $tmp_cmd;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['fast_search']);
          return;
      }
      $comando = "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq_fast'] = $comando;
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_orig'])) 
      {
          $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_orig']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['fast_search'][2] = $sv_data;
   }
   ...
   function SC_lookup_destaque($condicao, $campo)
   {
       $data_look = array();
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $data_look['0'] = "Não";
   ...
   function SC_proc_dyn_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['dyn_search'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['dyn_refresh'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           $dats = explode("_DYN_", $cada_f);
           if ($dats[0] == "NM_operador_Dyn")
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['dyn_search_op'] = $dats[1];
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['dyn_search'][] = array('cmp' => $dats[0], 'opc' => $dats[1], 'val' => $val_sv);
           $ix++;
       }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['campos_busca'][$ind] = $dados;
      }
       $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['cond_dyn_search'] = "";
       foreach ($fields as $ind => $dados)
       {
           ...
           if ($dados['field'] == "situacao" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['dyn_search_label']['situacao'];
               $dados['vls'][0] = $dados['vls'][0][0];
               $this->Val_format_1 = $dados['vls'][0];
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "situacao", 'A', '1', $Label_cmp);
           }
           if ($dados['field'] == "destaque" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['dyn_search_label']['destaque'];
               $dados['vls'][0] = $dados['vls'][0][0];
               $this->Val_format_1 = $dados['vls'][0];
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "destaque", 'A', '1', $Label_cmp);
           }
       }
       if (empty($this->Cmd_Dyn_Search)) 
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['cond_pesq']         = "";
           $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['cond_dyn_search']   = "";
           $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['campos_busca']      = array();
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq_fast'])) 
           {
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq'])) 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq_fast'] . ")";
               }
               else 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq_fast'] . ")";
               }
           }
           return;
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq_filtro'] = "( " . $this->Cmd_Dyn_Search . " )";
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_orig'])) 
       {
           $this->Cmd_Dyn_Search = $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_orig'] . " and (" . $this->Cmd_Dyn_Search . ")"; 
       }
       else
       {
           $this->Cmd_Dyn_Search = " where " . $this->Cmd_Dyn_Search; 
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq'] = $this->Cmd_Dyn_Search;
       $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['cond_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['cond_dyn_search'] . $this->Dyn_Serarch_and_or;
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq_fast'])) 
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['where_pesq_fast'] . ")";
       }
       if (NM_is_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['cond_pesq']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['cond_pesq'] = sc_convert_encoding($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['cond_pesq'], $_SESSION['scriptcase']['charset'], "UTF-8");
       }
   }
   function SC_proc_dyn_search_lookup($cond, $vls, $sql, $tp, $tsql, $lab)
   {
       ...
       if (!empty($nm_cmd))
       {
           ...
           if ($cond == "DF" || $cond == "NP")
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['cond_dyn_search'] .= $lab . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $nm_cond . "##*@@";
           }
           else
           {
               $this->Cmd_Dyn_Search .= "(" . $sql . " in (" . $nm_cmd . "))";
               $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['cond_dyn_search'] .= $lab . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
           }
       }
   }
   function SC_proc_dyn_search_all($cond, $vls, $sql, $tp, $tsql, $lab)
   {
       $nm_aspas  = "'";
       $nm_aspas1 = "'";
       if ($tp == "N" && $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['decimal_db'] == ".")
       {
           $nm_aspas  = "";
           $nm_aspas1 = "";
       }
      if ($tp == "DT" || $tp == "DH" || $tp == "HH")
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['SC_sep_date1'];
          }
      }
       $ini_lower = "";
       $end_lower = "";
       ...
       $dados   = $vls[0];
           ...
           if (!empty($nm_cmd))
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos']['cond_dyn_search'] .= $nm_cond;
           }
   }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
$_SESSION['sc_session'][$this->Ini->sc_page]['consulta_eventos'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
?>
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_consulta_eventos($nmgp_val);
            nm_protect_num_consulta_eventos($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['consulta_eventos']['master_pai']) && $_SESSION['sc_session'][$init_filho]['consulta_eventos']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['consulta_eventos']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['consulta_eventos']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['consulta_eventos']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['consulta_eventos']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['consulta_eventos']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['consulta_eventos']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['consulta_eventos']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['consulta_eventos']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['consulta_eventos']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']);
               $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida']) && $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['consulta_eventos']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['consulta_eventos']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['consulta_eventos']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['consulta_eventos']['protect_modal']) && !empty($_SESSION['scriptcase']['consulta_eventos']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['consulta_eventos']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   $_SESSION['sc_session']['consulta_eventos']['show_skip_charts_option'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['skip_charts'] = false;
   }
   if (isset($_GET['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['skip_charts'] = 'N' == $_GET['sc_create_charts'];
   }
   elseif (isset($_POST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['skip_charts'] = 'N' == $_POST['sc_create_charts'];
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "consulta_eventos";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'consulta_eventos' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/consulta_eventos/'))
   {
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['contr_total_geral'] = "NAO";
   }

   $_POST['script_case_init'] = $script_case_init;
   if (isset($nmgp_opcao) && $nmgp_opcao == "busca" && isset($nmgp_orig_pesq))
   {
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['b_sair'] = true;
   }
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'consulta_eventos')
   {
       $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/consulta_eventos_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['opcao'] = $nmgp_opcao ;  
       }   
       ...
       if (!isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['volta_redirect_tp'] = "";
           $nm_url_saida = "consulta_eventos_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['sc_modal'] = true;
               }
               $nm_url_saida = "consulta_eventos_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) 
           {
               $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['opc_psq'] = false ;   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['mostra_edit'] = "N";   
           } 
       ...
       $contr_consulta_eventos = new consulta_eventos_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['opcao'] = "busca";
          $contr_consulta_eventos->NM_ajax_flag = true;
          $contr_consulta_eventos->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['opcao'] = "busca";
          $contr_consulta_eventos->NM_ajax_flag = true;
          $contr_consulta_eventos->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['opcao'] = "busca";
          $contr_consulta_eventos->NM_ajax_flag = true;
          $contr_consulta_eventos->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['consulta_eventos']['opcao'] = "busca";
          $contr_consulta_eventos->NM_ajax_flag = true;
          $contr_consulta_eventos->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_consulta_eventos->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['consulta_eventos']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_consulta_eventos(&$str)
   {
   ...
   function nm_protect_num_consulta_eventos($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function consulta_eventos_pack_protect_string($sString)
   {
