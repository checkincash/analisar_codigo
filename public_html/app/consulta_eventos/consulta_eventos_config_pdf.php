...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['consulta_eventos']['show_skip_charts_option']) || !$_SESSION['sc_session']['consulta_eventos']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
