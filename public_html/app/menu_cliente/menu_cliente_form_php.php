...
class menu_cliente_form_php
{
   ...
   function init()
   {
      ...
      //check prod
      if(!isset($_SESSION['scriptcase']['menu_cliente']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['menu_cliente']['glo_nm_path_prod']))
      {
...
<?php
      ...
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['menu_cliente'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_ap_contrato_updt") . "/?nm_run_menu=1&nm_apl_menu=menu_cliente&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_2")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("consiste_pub") . "/?nm_run_menu=1&nm_apl_menu=menu_cliente&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "&script_case_session=" . session_id() . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="menu_cliente"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "menu_cliente")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'menu_cliente', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
<?php
   ...
   function Gera_sc_init($apl_menu)
   {
        ...
        $this->menu_sc_init = $_SESSION['scriptcase']['menu_cliente']['sc_init'][$apl_menu];
...
SC_dir_app_ini('CheckIn');
$controle = new menu_cliente_form_php();
$controle->init();
?>
