<?php
include_once('menu_cliente_session.php');
session_start();
...
else
{
    ...
    $_SESSION['scriptcase']['menu_cliente']['glo_nm_path_prod'] = "";
    $_SESSION['scriptcase']['menu_cliente']['glo_nm_perfil']    = "";
    $_SESSION['scriptcase']['menu_cliente']['glo_nm_usa_grupo'] = "";

ob_start();

class menu_cliente_class
{
  var $Db;
 ...
 function menu_cliente_menu()
 {
    global $menu_cliente_menuData;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['menu_cliente']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
      ...
      //check prod
      if(empty($_SESSION['scriptcase']['menu_cliente']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['menu_cliente']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_cliente']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_cliente']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_cliente']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_cliente/img";
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('menu_cliente');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_cliente_erro.php");
}
include_once(dirname(__FILE__) . "/menu_cliente_erro.class.php"); 
$this->Erro = new menu_cliente_erro();
$str_path = substr($_SESSION['scriptcase']['menu_cliente']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_cliente']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_cliente']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$menu_cliente_menuData         = array();
$menu_cliente_menuData['path'] = array();
$menu_cliente_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_cliente_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_cliente_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_cliente_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_cliente_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_cliente_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_cliente_menuData['url']['web']   = str_replace("\\", '/', $menu_cliente_menuData['url']['web']);
$menu_cliente_menuData['path']['root'] = substr($menu_cliente_menuData['path']['sys'],  0, -1 * strlen($menu_cliente_menuData['url']['web']));
$menu_cliente_menuData['path']['app']  = substr($menu_cliente_menuData['path']['sys'],  0, strrpos($menu_cliente_menuData['path']['sys'],  '/'));
$menu_cliente_menuData['path']['link'] = substr($menu_cliente_menuData['path']['app'],  0, strrpos($menu_cliente_menuData['path']['app'],  '/'));
$menu_cliente_menuData['path']['link'] = substr($menu_cliente_menuData['path']['link'], 0, strrpos($menu_cliente_menuData['path']['link'], '/')) . '/';
$menu_cliente_menuData['path']['app'] .= '/';
$menu_cliente_menuData['url']['app']   = substr($menu_cliente_menuData['url']['web'],  0, strrpos($menu_cliente_menuData['url']['web'],  '/'));
$menu_cliente_menuData['url']['link']  = substr($menu_cliente_menuData['url']['app'],  0, strrpos($menu_cliente_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_cliente']['glo_nm_usa_grupo'] == "S")
{
    $menu_cliente_menuData['url']['link']  = substr($menu_cliente_menuData['url']['link'], 0, strrpos($menu_cliente_menuData['url']['link'], '/'));
}
$menu_cliente_menuData['url']['link']  .= '/';
$menu_cliente_menuData['url']['app']   .= '/';
...
include_once("menu_cliente_toolbar.php");
...
if ($_SESSION['scriptcase']['menu_cliente']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "menu_cliente";
     $_SESSION['scriptcase']['menu_apls']['menu_cliente'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_cliente']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_cliente']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_cliente']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_cliente']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_cliente']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_cliente']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_cliente']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_cliente']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
{
    $_SESSION['sc_session'][1]['menu_cliente']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_cliente']['init']))
{
    $_SESSION['sc_session'][1]['menu_cliente']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_cliente']['init'];
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_cliente'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_cliente'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_cliente'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
      $_SESSION['scriptcase']['menu_cliente']['contr_erro'] = 'on';
 ?>
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_cliente']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_cliente']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_cliente'))
{
    $_SESSION['sc_session'][1]['menu_cliente']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_cliente'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$menu_cliente_menuData['iframe'] = TRUE;
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_cliente'];
...
{
    $menu_cliente_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "|menu_cliente_form_php.php?sc_item_menu=item_1&sc_apl_menu=form_ap_contrato_updt&sc_apl_link=" . urlencode($menu_cliente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cliente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "|grp__NM__ico__NM__3 - Cadastro de Clientes_mnu.png|" . $this->menu_cliente_target('_self') . "|" . "\n";
}
else
{
    $menu_cliente_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "|||grp__NM__ico__NM__3 - Cadastro de Clientes_mnu.png|_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['consiste_pub']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['consiste_pub']) == "on")
{
    $menu_cliente_menuData['data'] .= "item_2|.|" . $nm_var_lab[1] . "|menu_cliente_form_php.php?sc_item_menu=item_2&sc_apl_menu=consiste_pub&sc_apl_link=" . urlencode($menu_cliente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cliente']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "|grp__NM__ico__NM__6 - Cadastro Empresa_mnu.png|" . $this->menu_cliente_target('_self') . "|" . "\n";
}
else
{
    $menu_cliente_menuData['data'] .= "item_2|.|" . $nm_var_lab[1] . "|||grp__NM__ico__NM__6 - Cadastro Empresa_mnu.png|_self|disabled\n";
}
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_cliente'];
$menu_cliente_menuData['data'] .= "item_3|.|" . $nm_var_lab[2] . "|$saida_apl|" . $nm_var_hint[2] . "|grp__NM__ico__NM__sair.png|_parent|\n";

$menu_cliente_menuData['data'] = array();
$str_disabled = "N";
$str_link = "menu_cliente_form_php.php?sc_item_menu=item_1&sc_apl_menu=form_ap_contrato_updt&sc_apl_link=" . urlencode($menu_cliente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cliente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_ap_contrato_updt']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_ap_contrato_updt']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_cliente_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->menu_cliente_target('_self') . "\"",
        'sc_id'    => "item_1",
        'disabled' => $str_disabled,
    );
$str_disabled = "N";
$str_link = "menu_cliente_form_php.php?sc_item_menu=item_2&sc_apl_menu=consiste_pub&sc_apl_link=" . urlencode($menu_cliente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cliente']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['consiste_pub']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['consiste_pub']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$menu_cliente_menuData['data'][] = array(
    ...
    'icon_aba' => $icon_aba,
    'icon_aba_inactive' => $icon_aba_inactive,
    'target'   => " item-target=\"" . $this->menu_cliente_target('_parent') . "\"",
    'sc_id'    => "item_3",
    'disabled' => $str_disabled,
);

if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_cliente']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_cliente']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_cliente');
    $menu_cliente_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_cliente_help.txt"))
{
    $Arq_WebHelp = file("menu_cliente_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_cliente_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_cliente_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                );
            }
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_cliente']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_cliente']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_cliente_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_cliente']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_cliente_menuData['data'][$i_menu]);
       }
    ...
    $menu_cliente_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_cliente']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_cliente']))
{
    $disable_menu = false;
    foreach ($menu_cliente_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_cliente']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_cliente_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabeçalho HTML */
if ($menu_cliente_menuData['iframe'])
{
    $menu_cliente_menuData['height'] = '100%';
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">

<html<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?> style="height: 100%">
<head>
 <title>menu_cliente</title>
...
{
    $menu_cliente_menuData['height'] = '30px';
}

/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_cliente']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_cliente']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menu_cliente']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
Iframe_atual = "menu_cliente_iframe";
...
<?php
 $seq = 0;
 foreach ($menu_cliente_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'menu_cliente_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    tmp += "</div>";
    var home_style="";
    if(str_id === 'menu_cliente'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_menu_cliente').css('display','none');
    if (str_id == "")
    {
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            Iframe_atual = "menu_cliente_" + Tab_iframes[i] + '_iframe';
        } else {
...
{
    str_target_sv = "";
    if (str_id != "iframe_menu_cliente")
    {
        str_target_sv = str_id + "_iframe";
        str_id        = str_id.replace("menu_cliente_","");
    }
    str_link   = $('#' + str_id).attr('item-href');
    str_target = $('#' + str_id).attr('item-target');
    if (str_target == "menu_cliente_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        str_target = (str_target_sv != "") ? str_target_sv : str_target;
        mudaIframe(str_id);
        if (str_id != "menu_cliente")
        {
            $('#links_abas').css('display','');
        }
        if (str_id != "menu_cliente" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
...
<?php echo $this->nm_show_toolbarmenu($col_span, $saida_apl, $menu_cliente_menuData, $path_imag_cab); ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
      <td <?php echo $strAlign; ?> valign="middle" class="scMenuLine" style='vertical-align:top;' id='idMenuCell'>
       <table style="width:100%;border-collapse: collapse; border-width: 0" cellpadding=0 cellspacing=0><tr><td style="padding: 0">
...
echo $this->menu_cliente_escreveMenu($menu_cliente_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
       </td></tr></table>
<?php
...
<?php echo $this->nm_gera_degrade(2, $bg_line_degrade, $path_imag_cab); ?>    <td style="border-width: 1px; width: 100%; height: 100%; padding: 0px">
      ...
      <iframe id="iframe_menu_cliente" name="menu_cliente_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "http://www.checkincash.com.br/imagem/widescreen.htm"); ?> " ></iframe>
<?php
 foreach ($menu_cliente_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
         echo "      <iframe id=\"iframe_" . $dados_menu['id'] . "\" name= \"menu_cliente_" . $dados_menu['id'] . "_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;width: 100%; height: 100%;\" src=\"\"></iframe>
";
     }
 }
}
...
/* Controle de Target */
function menu_cliente_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    $last      = '';
    $itemClass = ' topfirst';
    $subSize   = 2;
...
function menu_cliente_target($str_target)
{
    global $menu_cliente_menuData;
    ...
    elseif ($menu_cliente_menuData['iframe'])
    {
        return 'menu_cliente_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_cliente_menuData, $path_imag_cab)
{
}
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_cliente_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_cliente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cliente']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_cliente_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_cliente_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_cliente']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_cliente_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        if (!isset($_SESSION['scriptcase']['menu_cliente']['sc_init'][$apl_menu]))
        {
            $_SESSION['scriptcase']['menu_cliente']['sc_init'][$apl_menu] = rand(2, 10000);
        }
        $_SESSION['sc_session'][$_SESSION['scriptcase']['menu_cliente']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['menu_cliente']['sc_init'][$apl_menu];
   }
...
$contr_menu_cliente = new menu_cliente_class;
$contr_menu_cliente->menu_cliente_menu();
