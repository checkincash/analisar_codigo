...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_ap_contrato_publicador_cliente_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function cep_cep(num_cep, campos_cep)
{
   ...
   jsrsExecute("form_ap_contrato_publicador_cliente_mob_cep.php?cep=" + num_cep + "&onchange=s", recebe_cep, "cep", num_cep, false);
}
...
{
    document.getElementById('form_ap_contrato_publicador_cliente_mob_form0').style.width='1px';
    document.getElementById('form_ap_contrato_publicador_cliente_mob_form0').style.height='0px';
    document.getElementById('form_ap_contrato_publicador_cliente_mob_form0').style.display='none';
    document.getElementById('form_ap_contrato_publicador_cliente_mob_form0').style.overflow='scroll';
    document.getElementById('form_ap_contrato_publicador_cliente_mob_form1').style.width='1px';
    document.getElementById('form_ap_contrato_publicador_cliente_mob_form1').style.height='0px';
    document.getElementById('form_ap_contrato_publicador_cliente_mob_form1').style.display='none';
    document.getElementById('form_ap_contrato_publicador_cliente_mob_form1').style.overflow='scroll';
    document.getElementById('form_ap_contrato_publicador_cliente_mob_form2').style.width='1px';
    document.getElementById('form_ap_contrato_publicador_cliente_mob_form2').style.height='0px';
    document.getElementById('form_ap_contrato_publicador_cliente_mob_form2').style.display='none';
    document.getElementById('form_ap_contrato_publicador_cliente_mob_form2').style.overflow='scroll';
