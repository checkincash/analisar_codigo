...
<?php
    if ($nmgp_num_form == "form_ap_contrato_publicador_cliente_form2")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_ap_contrato_publicador_cliente_form2" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_ap_contrato_publicador_cliente_form2')">
     CAMPANHA
    </a>
   </li>
</ul>
