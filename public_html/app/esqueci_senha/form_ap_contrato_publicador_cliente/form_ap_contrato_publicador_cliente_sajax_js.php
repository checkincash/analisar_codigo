...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate pdesconto
  function do_ajax_form_ap_contrato_publicador_cliente_validate_pdesconto()
  {
    var nomeCampo_pdesconto = "pdesconto";
    var var_pdesconto = scAjaxGetFieldSelect(nomeCampo_pdesconto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_contrato_publicador_cliente_validate_pdesconto(var_pdesconto, var_script_case_init, do_ajax_form_ap_contrato_publicador_cliente_validate_pdesconto_cb);
  } // do_ajax_form_ap_contrato_publicador_cliente_validate_pdesconto

  function do_ajax_form_ap_contrato_publicador_cliente_validate_pdesconto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_contrato_publicador_cliente_validate_pdesconto_cb

  // ---------- Validate foto_premiacao
  function do_ajax_form_ap_contrato_publicador_cliente_validate_foto_premiacao()
  {
    var nomeCampo_foto_premiacao = "foto_premiacao";
    var var_foto_premiacao = scAjaxGetFieldText(nomeCampo_foto_premiacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_contrato_publicador_cliente_validate_foto_premiacao(var_foto_premiacao, var_script_case_init, do_ajax_form_ap_contrato_publicador_cliente_validate_foto_premiacao_cb);
  } // do_ajax_form_ap_contrato_publicador_cliente_validate_foto_premiacao

  function do_ajax_form_ap_contrato_publicador_cliente_validate_foto_premiacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_contrato_publicador_cliente_validate_foto_premiacao_cb

  // ---------- Validate texto_premiacao
  function do_ajax_form_ap_contrato_publicador_cliente_validate_texto_premiacao()
  {
    var nomeCampo_texto_premiacao = "texto_premiacao";
    var var_texto_premiacao = scAjaxGetFieldText(nomeCampo_texto_premiacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_contrato_publicador_cliente_validate_texto_premiacao(var_texto_premiacao, var_script_case_init, do_ajax_form_ap_contrato_publicador_cliente_validate_texto_premiacao_cb);
  } // do_ajax_form_ap_contrato_publicador_cliente_validate_texto_premiacao

  function do_ajax_form_ap_contrato_publicador_cliente_validate_texto_premiacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_contrato_publicador_cliente_validate_texto_premiacao_cb
  ...
  function do_ajax_form_ap_contrato_publicador_cliente_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_ap_contrato_publicador_cliente_submit_form(var_fk_contrato, var_situacao, var_nomenclatura, var_data_criacao, var_cep, var_bairro, var_rua, var_numero, var_complemento, var_cidade, var_estado, var_destaque_img, var_destaque, var_foto_publicacao, var_texto_publicacao, var_pdesconto, var_foto_premiacao, var_texto_premiacao, var_foto_publicacao_ul_name, var_foto_publicacao_ul_type, var_foto_premiacao_ul_name, var_foto_premiacao_ul_type, var_foto_publicacao_salva, var_foto_publicacao_limpa, var_foto_premiacao_salva, var_foto_premiacao_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ap_contrato_publicador_cliente_submit_form_cb);
