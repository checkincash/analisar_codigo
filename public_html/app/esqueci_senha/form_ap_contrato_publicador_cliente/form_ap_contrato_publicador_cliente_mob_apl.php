...
$_SESSION['scriptcase']['form_ap_contrato_publicador_cliente_mob']['contr_erro'] = 'off';
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['upload_field_ul_name'][$this->foto_premiacao_ul_name]))
          {
              $this->NM_ajax_info['param']['foto_premiacao_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['upload_field_ul_name'][$this->foto_premiacao_ul_name];
          }
      ...
      elseif (isset($this->foto_premiacao_ul_name) && '' != $this->foto_premiacao_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['upload_field_ul_name'][$this->foto_premiacao_ul_name]))
          {
              $this->foto_premiacao_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['upload_field_ul_name'][$this->foto_premiacao_ul_name];
          }
				...
				if (isset($this->Campos_Mens_erro) && !empty($this->Campos_Mens_erro))
{
    if ($this->NM_ajax_flag)
    {
        $this->NM_ajax_info['redirExit']['action'] = "form_ap_contrato_publicador_cliente_mob_fim.php?script_case_init=" . $this->form_encode_input($this->Ini->sc_page) . "&script_case_session=" . $this->form_encode_input(session_id());
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['sc_outra_jan'])
        {
            $_SESSION['scriptcase']['sc_outra_jan'] = "form_ap_contrato_publicador_cliente_mob";
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['sc_outra_jan'] = false;
        }
        $_SESSION['scriptcase']['form_ap_contrato_publicador_cliente_mob']['contr_erro'] = 'off';
        form_ap_contrato_publicador_cliente_mob_pack_ajax_response();
        exit;
...
<table align="center"><tr><td>
  <form name="Fexit" method=post
        action="form_ap_contrato_publicador_cliente_mob_fim.php"
        target="_Self">
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '5';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '10';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '15';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '20';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '25';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '30';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '35';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '40';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '45';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '50';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '55';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '60';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '65';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '70';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '75';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '80';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '85';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '90';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '95';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['Lookup_pdesconto'][] = '100';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['pdesconto']['valList'][$i] = form_ap_contrato_publicador_cliente_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['scriptcase']['form_ap_contrato_publicador_cliente_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->longitude = $this->longitude_before_qstr;
              ...
              $this->nmgp_refresh_fields = array_diff(array('fk_contrato', 'situacao', 'nomenclatura', 'data_criacao', 'cep', 'bairro', 'rua', 'numero', 'complemento', 'cidade', 'estado', 'destaque_img', 'destaque', 'foto_publicacao', 'texto_publicacao', 'pdesconto', 'foto_premiacao', 'texto_premiacao'), $aDoNotUpdate);
              $this->ajax_return_values();
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out1_foto_premiacao))
       {
        ...
        include_once("form_ap_contrato_publicador_cliente_mob_form2.php");
 }
