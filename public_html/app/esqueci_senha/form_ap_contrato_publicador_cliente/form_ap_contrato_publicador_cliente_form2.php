<div id="form_ap_contrato_publicador_cliente_form2" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '0'; ?>
 <option  value="1" <?php  if ($this->pdesconto == "1") { echo " selected" ;} ?>>1%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '1'; ?>
 <option  value="2" <?php  if ($this->pdesconto == "2") { echo " selected" ;} ?>>2%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '2'; ?>
 <option  value="3" <?php  if ($this->pdesconto == "3") { echo " selected" ;} ?>>3%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '3'; ?>
 <option  value="5" <?php  if ($this->pdesconto == "5") { echo " selected" ;} ?>>5%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '5'; ?>
 <option  value="10" <?php  if ($this->pdesconto == "10") { echo " selected" ;} ?>>10%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '10'; ?>
 <option  value="15" <?php  if ($this->pdesconto == "15") { echo " selected" ;} ?>>15%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '15'; ?>
 <option  value="20" <?php  if ($this->pdesconto == "20") { echo " selected" ;} ?>>20%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '20'; ?>
 <option  value="25" <?php  if ($this->pdesconto == "25") { echo " selected" ;} ?>>25%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '25'; ?>
 <option  value="30" <?php  if ($this->pdesconto == "30") { echo " selected" ;} ?>>30%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '30'; ?>
 <option  value="35" <?php  if ($this->pdesconto == "35") { echo " selected" ;} ?>>35%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '35'; ?>
 <option  value="40" <?php  if ($this->pdesconto == "40") { echo " selected" ;} ?>>40%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '40'; ?>
 <option  value="45" <?php  if ($this->pdesconto == "45") { echo " selected" ;} ?>>45%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '45'; ?>
 <option  value="50" <?php  if ($this->pdesconto == "50") { echo " selected" ;} ?>>50%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '50'; ?>
 <option  value="55" <?php  if ($this->pdesconto == "55") { echo " selected" ;} ?>>55%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '55'; ?>
 <option  value="60" <?php  if ($this->pdesconto == "60") { echo " selected" ;} ?>>60%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '60'; ?>
 <option  value="65" <?php  if ($this->pdesconto == "65") { echo " selected" ;} ?>>65%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '65'; ?>
 <option  value="70" <?php  if ($this->pdesconto == "70") { echo " selected" ;} ?>>70%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '70'; ?>
 <option  value="75" <?php  if ($this->pdesconto == "75") { echo " selected" ;} ?>>75%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '75'; ?>
 <option  value="80" <?php  if ($this->pdesconto == "80") { echo " selected" ;} ?>>80%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '80'; ?>
 <option  value="85" <?php  if ($this->pdesconto == "85") { echo " selected" ;} ?>>85%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '85'; ?>
 <option  value="90" <?php  if ($this->pdesconto == "90") { echo " selected" ;} ?>>90%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '90'; ?>
 <option  value="95" <?php  if ($this->pdesconto == "95") { echo " selected" ;} ?>>95%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '95'; ?>
 <option  value="100" <?php  if ($this->pdesconto == "100") { echo " selected" ;} ?>>100%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['Lookup_pdesconto'][] = '100'; ?>
 </select></span>
</span><?php  }?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente']['dashboard_info']['under_dashboard']))) {
