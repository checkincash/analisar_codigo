...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_cnpj' + iSeqRow).bind('blur', function() { sc_registro_senha_cnpj_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_registro_senha_cnpj_onfocus(this, iSeqRow) });
  $('#id_sc_field_razao' + iSeqRow).bind('blur', function() { sc_registro_senha_razao_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_registro_senha_razao_onfocus(this, iSeqRow) });
  $('#id_sc_field_email' + iSeqRow).bind('blur', function() { sc_registro_senha_email_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_registro_senha_email_onfocus(this, iSeqRow) });
  $('#id_sc_field_senha_usuario' + iSeqRow).bind('blur', function() { sc_registro_senha_senha_usuario_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_registro_senha_senha_usuario_onfocus(this, iSeqRow) });
  $('#id_sc_field_retype_senha' + iSeqRow).bind('blur', function() { sc_registro_senha_retype_senha_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_registro_senha_retype_senha_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_registro_senha_cnpj_onblur(oThis, iSeqRow) {
  do_ajax_registro_senha_mob_validate_cnpj();
  scCssBlur(oThis);
}

function sc_registro_senha_cnpj_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_registro_senha_razao_onblur(oThis, iSeqRow) {
  do_ajax_registro_senha_mob_validate_razao();
  scCssBlur(oThis);
}

function sc_registro_senha_razao_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_registro_senha_email_onblur(oThis, iSeqRow) {
  do_ajax_registro_senha_mob_validate_email();
  scCssBlur(oThis);
}

function sc_registro_senha_email_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_registro_senha_senha_usuario_onblur(oThis, iSeqRow) {
  do_ajax_registro_senha_mob_validate_senha_usuario();
  scCssBlur(oThis);
}

function sc_registro_senha_senha_usuario_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_registro_senha_retype_senha_onblur(oThis, iSeqRow) {
  do_ajax_registro_senha_mob_validate_retype_senha();
  scCssBlur(oThis);
}

function sc_registro_senha_retype_senha_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
