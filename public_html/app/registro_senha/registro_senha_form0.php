...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("registro_senha_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('registro_senha_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['recarga'];
}
?>
...
<?php
 include_once("registro_senha_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['registro_senha'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['registro_senha'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_razao_line" id="hidden_field_data_razao" style="<?php echo $sStyleHidden_razao; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_razao_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="razao" value="<?php echo $this->form_encode_input($razao); ?>"><span id="id_ajax_label_razao"><?php echo nl2br($razao); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_senha_usuario_label" id="hidden_field_label_senha_usuario" style="<?php echo $sStyleHidden_senha_usuario; ?>"><span id="id_label_senha_usuario"><?php echo $this->nm_new_label['senha_usuario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['php_cmp_required']['senha_usuario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['php_cmp_required']['senha_usuario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_senha_usuario_line" id="hidden_field_data_senha_usuario" style="<?php echo $sStyleHidden_senha_usuario; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_senha_usuario_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_retype_senha_label" id="hidden_field_label_retype_senha" style="<?php echo $sStyleHidden_retype_senha; ?>"><span id="id_label_retype_senha"><?php echo $this->nm_new_label['retype_senha']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['php_cmp_required']['retype_senha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['php_cmp_required']['retype_senha'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_retype_senha_line" id="hidden_field_data_retype_senha" style="<?php echo $sStyleHidden_retype_senha; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_retype_senha_line" style="vertical-align: top;padding: 0px">
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['registro_senha']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("registro_senha");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("registro_senha");
 parent.scAjaxDetailHeight("registro_senha", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
