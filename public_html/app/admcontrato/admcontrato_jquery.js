...
function ajax_navigate(opc, parm)
{
    ...
    $.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_admcontrato').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_admcontrato').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_admcontrato').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_admcontrato').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_admcontrato').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_admcontrato').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_admcontrato').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_admcontrato').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_admcontrato').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_admcontrato').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_admcontrato').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_admcontrato').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
          for (i = 0; i < oResp["setValue"].length; i++) {
            if ("sc_grid_body" == oResp["setValue"][i]["field"] && !scrollNavigateReload) {
              $("#sc-ui-grid-body-b8a1b2f9 > tbody").append(oResp["setValue"][i]["value"]);
            }
            else {
