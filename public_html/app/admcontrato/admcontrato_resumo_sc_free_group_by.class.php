...
class admcontrato_resumo
{
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['pdf'] = "on";
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['dashboard_info']['under_dashboard'] ? "off" : "on";
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['dashboard_info']['under_dashboard'] ? "off" : "on";
      $this->nmgp_botoes['word'] = "on";
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['dashboard_info']['under_dashboard'] ? "off" : "on";
      $this->nmgp_botoes['xls'] = "on";
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['where_resumo'] = "";
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['arr_total']['cidade'] = $this->array_total_cidade;
      $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['arr_total']['estado'] = $this->array_total_estado;
      $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       $Lab_estado = "ESTADO";
       $prep_field = array();
       $prep_field['cidade'] = $Lab_cidade;
       $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['labels']['cidade'] = $Lab_cidade; 
       $prep_field['estado'] = $Lab_estado;
       $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['labels']['estado'] = $Lab_estado; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['cidade']['alin'] = "''";
       $Arr_parms['cidade']['link'] = "S";
       $Arr_parms['estado']['alin'] = "''";
       $Arr_parms['estado']['link'] = "S";
       $Arr_parms['cidade']['fill'] = "true";
       $Arr_parms['cidade']['order'] = "label";
       $Arr_parms['cidade']['order_start'] = 'asc';
       $Arr_parms['cidade']['order_invert'] = 'false';
       $Arr_parms['cidade']['order_enabled'] = 'true';
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['cidade'] = array(0 => 'cidade', 1 => '@aspass@');
       $prep_links_fl['estado'] = array(0 => 'estado', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@admcontrato@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['opcao'] = "print";
      ...
      $this->Total   = new admcontrato_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['responsive_chart']['active']) {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_admcontrato_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_admcontrato_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_admcontrato_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "admcontrato/admcontrato_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "admcontrato/admcontrato_config_word.php?nm_cor=AM&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "admcontrato/admcontrato_config_print.php?nm_opc=resumo&nm_cor=AM&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "admcontrato/admcontrato_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnGroupByShow('" . $this->Ini->path_link . "admcontrato/admcontrato_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("admcontrato_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'admcontrato_config_pivot.php?nome_apl=admcontrato&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "admcontrato/admcontrato_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_admcontrato_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "admcontrato/admcontrato_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $pk_contrato = $Busca_temp['pk_contrato']; 
          $tmp_pos = strpos($pk_contrato, "##@@");
          if ($tmp_pos !== false && !is_array($pk_contrato))
          {
              $pk_contrato = substr($pk_contrato, 0, $tmp_pos);
          }
          $fk_classificacao = $Busca_temp['fk_classificacao']; 
          $tmp_pos = strpos($fk_classificacao, "##@@");
          if ($tmp_pos !== false && !is_array($fk_classificacao))
          {
              $fk_classificacao = substr($fk_classificacao, 0, $tmp_pos);
          }
          $classificacao1 = $Busca_temp['classificacao1']; 
          $tmp_pos = strpos($classificacao1, "##@@");
          if ($tmp_pos !== false && !is_array($classificacao1))
          {
              $classificacao1 = substr($classificacao1, 0, $tmp_pos);
          }
          $classificacao2 = $Busca_temp['classificacao2']; 
          $tmp_pos = strpos($classificacao2, "##@@");
          if ($tmp_pos !== false && !is_array($classificacao2))
          {
              $classificacao2 = substr($classificacao2, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($quebra_cidade, $quebra_estado, $quebra_cidade_orig, $quebra_estado_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT cnpj, razao, fantasia, fk_classificacao, classificacao1, classificacao2, str_replace (convert(char(10),datacadastro,102), '.', '-') + ' ' + convert(char(8),datacadastro,20), cidade, estado, email, telefone, ativo, pk_contrato, inscricao from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT cnpj, razao, fantasia, fk_classificacao, classificacao1, classificacao2, datacadastro, cidade, estado, email, telefone, ativo, pk_contrato, inscricao from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     { 
         $nmgp_select = "SELECT cnpj, razao, fantasia, fk_classificacao, classificacao1, classificacao2, convert(char(23),datacadastro,121), cidade, estado, email, telefone, ativo, pk_contrato, inscricao from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT cnpj, razao, fantasia, fk_classificacao, classificacao1, classificacao2, datacadastro, cidade, estado, email, telefone, ativo, pk_contrato, inscricao from " . $this->Ini->nm_tabela; 
     ...
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['admcontrato']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->cnpj = $rs_res->fields[0] ;  
            $this->razao = $rs_res->fields[1] ;  
            $this->fantasia = $rs_res->fields[2] ;  
            $this->fk_classificacao = $rs_res->fields[3] ;  
            $this->classificacao1 = $rs_res->fields[4] ;  
            $this->classificacao2 = $rs_res->fields[5] ;  
            $this->datacadastro = $rs_res->fields[6] ;  
            $this->cidade = $rs_res->fields[7] ;  
            $this->estado = $rs_res->fields[8] ;  
            $this->email = $rs_res->fields[9] ;  
            $this->telefone = $rs_res->fields[10] ;  
            $this->ativo = $rs_res->fields[11] ;  
            $this->pk_contrato = $rs_res->fields[12] ;  
            $this->inscricao = $rs_res->fields[13] ;  
            $this->cidade_orig = $this->cidade;
            $this->estado_orig = $this->estado;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cidade, $this->estado, $this->cidade_orig,  $this->estado_orig);
            }
   }
//
