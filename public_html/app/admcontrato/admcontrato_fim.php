...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CheckIncash_____admcontrato"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CheckIncash_____admcontrato"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admcontrato']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['admcontrato']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['admcontrato']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['admcontrato']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['admcontrato']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['admcontrato']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['admcontrato']['embutida_filho'] as $ind => $sc_init)
          {
