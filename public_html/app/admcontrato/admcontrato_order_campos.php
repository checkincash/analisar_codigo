<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new admcontrato_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class admcontrato_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["datacadastro"]   = "datacadastro";
   $tab_labels["datacadastro"]   = (isset($_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["datacadastro"])) ? $_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["datacadastro"] : "Data cadastro";
   $tab_ger_campos['cnpj'] = "on";
   $tab_def_campos['cnpj'] = "cnpj";
   $tab_converte["cnpj"]   = "cnpj";
   $tab_labels["cnpj"]   = (isset($_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["cnpj"])) ? $_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["cnpj"] : "CNPJ";
   $tab_ger_campos['razao'] = "on";
   $tab_def_campos['razao'] = "razao";
   $tab_converte["razao"]   = "razao";
   $tab_labels["razao"]   = (isset($_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["razao"])) ? $_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["razao"] : "RAZÃO";
   $tab_ger_campos['fk_classificacao'] = "on";
   $tab_def_campos['fk_classificacao'] = "fk_classificacao";
   $tab_converte["fk_classificacao"]   = "fk_classificacao";
   $tab_labels["fk_classificacao"]   = (isset($_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["fk_classificacao"])) ? $_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["fk_classificacao"] : "CATEGORIA";
   $tab_ger_campos['classificacao1'] = "on";
   $tab_def_campos['classificacao1'] = "classificacao1";
   $tab_converte["classificacao1"]   = "classificacao1";
   $tab_labels["classificacao1"]   = (isset($_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["classificacao1"])) ? $_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["classificacao1"] : "CLASSIFICAÇÃO 1";
   $tab_ger_campos['classificacao2'] = "on";
   $tab_def_campos['classificacao2'] = "classificacao2";
   $tab_converte["classificacao2"]   = "classificacao2";
   $tab_labels["classificacao2"]   = (isset($_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["classificacao2"])) ? $_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["classificacao2"] : "CLASSIFICAÇÃO 2";
   $tab_ger_campos['cidade'] = "on";
   $tab_def_campos['cidade'] = "cidade";
   $tab_converte["cidade"]   = "cidade";
   $tab_labels["cidade"]   = (isset($_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["cidade"])) ? $_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["cidade"] : "CIDADE";
   $tab_ger_campos['estado'] = "on";
   $tab_def_campos['estado'] = "estado";
   $tab_converte["estado"]   = "estado";
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["estado"] : "ESTADO";
   $tab_ger_campos['telefone'] = "on";
   $tab_def_campos['telefone'] = "telefone";
   $tab_converte["telefone"]   = "telefone";
   $tab_labels["telefone"]   = (isset($_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["telefone"])) ? $_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["telefone"] : "TELEFONE";
   $tab_ger_campos['ativo'] = "on";
   $tab_def_campos['ativo'] = "ativo";
   $tab_converte["ativo"]   = "ativo";
   $tab_labels["ativo"]   = (isset($_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["ativo"])) ? $_SESSION['sc_session'][$sc_init]['admcontrato']['labels']["ativo"] : "ATIVO";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['admcontrato']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['admcontrato']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['admcontrato']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['admcontrato']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['admcontrato']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['admcontrato']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['admcontrato']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['admcontrato']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['admcontrato']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "admcontrato_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['admcontrato']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['admcontrato']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
