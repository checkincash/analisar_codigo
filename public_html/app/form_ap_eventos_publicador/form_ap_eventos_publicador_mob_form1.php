<div id="form_ap_eventos_publicador_mob_form1" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pseg_line" id="hidden_field_data_pseg" style="<?php echo $sStyleHidden_pseg; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pseg_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pseg_label"><span id="id_label_pseg"><?php echo $this->nm_new_label['pseg']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pseg']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pseg'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = ''; ?>
 <option value="">SELECIONE</option>
 <option  value="0" <?php  if ($this->pseg == "0") { echo " selected" ;} ?>>0%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '0'; ?>
 <option  value="1" <?php  if ($this->pseg == "1") { echo " selected" ;} ?>>1%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '1'; ?>
 <option  value="2" <?php  if ($this->pseg == "2") { echo " selected" ;} ?>>2%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '2'; ?>
 <option  value="3" <?php  if ($this->pseg == "3") { echo " selected" ;} ?>>3%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '3'; ?>
 <option  value="4" <?php  if ($this->pseg == "4") { echo " selected" ;} ?>>4%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '4'; ?>
 <option  value="5" <?php  if ($this->pseg == "5") { echo " selected" ;} ?>>5%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '5'; ?>
 <option  value="6" <?php  if ($this->pseg == "6") { echo " selected" ;} ?>>6%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '6'; ?>
 <option  value="7" <?php  if ($this->pseg == "7") { echo " selected" ;} ?>>7%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '7'; ?>
 <option  value="8" <?php  if ($this->pseg == "8") { echo " selected" ;} ?>>8%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '8'; ?>
 <option  value="9" <?php  if ($this->pseg == "9") { echo " selected" ;} ?>>9%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '9'; ?>
 <option  value="10" <?php  if ($this->pseg == "10") { echo " selected" ;} ?>>10%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '10'; ?>
 <option  value="15" <?php  if ($this->pseg == "15") { echo " selected" ;} ?>>15%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '15'; ?>
 <option  value="20" <?php  if ($this->pseg == "20") { echo " selected" ;} ?>>20%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '20'; ?>
 <option  value="25" <?php  if ($this->pseg == "25") { echo " selected" ;} ?>>25%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '25'; ?>
 <option  value="30" <?php  if ($this->pseg == "30") { echo " selected" ;} ?>>30%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '30'; ?>
 <option  value="35" <?php  if ($this->pseg == "35") { echo " selected" ;} ?>>35%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '35'; ?>
 <option  value="40" <?php  if ($this->pseg == "40") { echo " selected" ;} ?>>40%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '40'; ?>
 <option  value="45" <?php  if ($this->pseg == "45") { echo " selected" ;} ?>>45%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '45'; ?>
 <option  value="50" <?php  if ($this->pseg == "50") { echo " selected" ;} ?>>50%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '50'; ?>
 <option  value="55" <?php  if ($this->pseg == "55") { echo " selected" ;} ?>>55%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '55'; ?>
 <option  value="60" <?php  if ($this->pseg == "60") { echo " selected" ;} ?>>60%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '60'; ?>
 <option  value="65" <?php  if ($this->pseg == "65") { echo " selected" ;} ?>>65%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '65'; ?>
 <option  value="70" <?php  if ($this->pseg == "70") { echo " selected" ;} ?>>70%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '70'; ?>
 <option  value="75" <?php  if ($this->pseg == "75") { echo " selected" ;} ?>>75%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '75'; ?>
 <option  value="80" <?php  if ($this->pseg == "80") { echo " selected" ;} ?>>80%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '80'; ?>
 <option  value="85" <?php  if ($this->pseg == "85") { echo " selected" ;} ?>>85%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '85'; ?>
 <option  value="90" <?php  if ($this->pseg == "90") { echo " selected" ;} ?>>90%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '90'; ?>
 <option  value="95" <?php  if ($this->pseg == "95") { echo " selected" ;} ?>>95%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '95'; ?>
 <option  value="100" <?php  if ($this->pseg == "100") { echo " selected" ;} ?>>100%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '100'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = ''; ?>
 <option value="">SELECIONE</option>
 <option  value="0" <?php  if ($this->pter == "0") { echo " selected" ;} ?>>0%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '0'; ?>
 <option  value="1" <?php  if ($this->pter == "1") { echo " selected" ;} ?>>1%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '1'; ?>
 <option  value="2" <?php  if ($this->pter == "2") { echo " selected" ;} ?>>2%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '2'; ?>
 <option  value="3" <?php  if ($this->pter == "3") { echo " selected" ;} ?>>3%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '3'; ?>
 <option  value="4" <?php  if ($this->pter == "4") { echo " selected" ;} ?>>4%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '4'; ?>
 <option  value="5" <?php  if ($this->pter == "5") { echo " selected" ;} ?>>5%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '5'; ?>
 <option  value="6" <?php  if ($this->pter == "6") { echo " selected" ;} ?>>6%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '6'; ?>
 <option  value="7" <?php  if ($this->pter == "7") { echo " selected" ;} ?>>7%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '7'; ?>
 <option  value="8" <?php  if ($this->pter == "8") { echo " selected" ;} ?>>8%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '8'; ?>
 <option  value="9" <?php  if ($this->pter == "9") { echo " selected" ;} ?>>9%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '9'; ?>
 <option  value="10" <?php  if ($this->pter == "10") { echo " selected" ;} ?>>10%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '10'; ?>
 <option  value="15" <?php  if ($this->pter == "15") { echo " selected" ;} ?>>15%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '15'; ?>
 <option  value="20" <?php  if ($this->pter == "20") { echo " selected" ;} ?>>20%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '20'; ?>
 <option  value="25" <?php  if ($this->pter == "25") { echo " selected" ;} ?>>25%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '25'; ?>
 <option  value="30" <?php  if ($this->pter == "30") { echo " selected" ;} ?>>30%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '30'; ?>
 <option  value="35" <?php  if ($this->pter == "35") { echo " selected" ;} ?>>35%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '35'; ?>
 <option  value="40" <?php  if ($this->pter == "40") { echo " selected" ;} ?>>40%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '40'; ?>
 <option  value="45" <?php  if ($this->pter == "45") { echo " selected" ;} ?>>45%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '45'; ?>
 <option  value="50" <?php  if ($this->pter == "50") { echo " selected" ;} ?>>50%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '50'; ?>
 <option  value="55" <?php  if ($this->pter == "55") { echo " selected" ;} ?>>55%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '55'; ?>
 <option  value="60" <?php  if ($this->pter == "60") { echo " selected" ;} ?>>60%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '60'; ?>
 <option  value="65" <?php  if ($this->pter == "65") { echo " selected" ;} ?>>65%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '65'; ?>
 <option  value="70" <?php  if ($this->pter == "70") { echo " selected" ;} ?>>70%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '70'; ?>
 <option  value="75" <?php  if ($this->pter == "75") { echo " selected" ;} ?>>75%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '75'; ?>
 <option  value="80" <?php  if ($this->pter == "80") { echo " selected" ;} ?>>80%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '80'; ?>
 <option  value="85" <?php  if ($this->pter == "85") { echo " selected" ;} ?>>85%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '85'; ?>
 <option  value="90" <?php  if ($this->pter == "90") { echo " selected" ;} ?>>90%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '90'; ?>
 <option  value="95" <?php  if ($this->pter == "95") { echo " selected" ;} ?>>95%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '95'; ?>
 <option  value="100" <?php  if ($this->pter == "100") { echo " selected" ;} ?>>100%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '100'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pqua_line" id="hidden_field_data_pqua" style="<?php echo $sStyleHidden_pqua; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pqua_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pqua_label"><span id="id_label_pqua"><?php echo $this->nm_new_label['pqua']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pqua']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pqua'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = ''; ?>
 <option value="">SELECIONE</option>
 <option  value="0" <?php  if ($this->pqua == "0") { echo " selected" ;} ?>>0%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '0'; ?>
 <option  value="1" <?php  if ($this->pqua == "1") { echo " selected" ;} ?>>1%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '1'; ?>
 <option  value="2" <?php  if ($this->pqua == "2") { echo " selected" ;} ?>>2%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '2'; ?>
 <option  value="3" <?php  if ($this->pqua == "3") { echo " selected" ;} ?>>3%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '3'; ?>
 <option  value="4" <?php  if ($this->pqua == "4") { echo " selected" ;} ?>>4%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '4'; ?>
 <option  value="5" <?php  if ($this->pqua == "5") { echo " selected" ;} ?>>5%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '5'; ?>
 <option  value="6" <?php  if ($this->pqua == "6") { echo " selected" ;} ?>>6%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '6'; ?>
 <option  value="7" <?php  if ($this->pqua == "7") { echo " selected" ;} ?>>7%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '7'; ?>
 <option  value="8" <?php  if ($this->pqua == "8") { echo " selected" ;} ?>>8%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '8'; ?>
 <option  value="9" <?php  if ($this->pqua == "9") { echo " selected" ;} ?>>9%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '9'; ?>
 <option  value="10" <?php  if ($this->pqua == "10") { echo " selected" ;} ?>>10%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '10'; ?>
 <option  value="15" <?php  if ($this->pqua == "15") { echo " selected" ;} ?>>15%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '15'; ?>
 <option  value="20" <?php  if ($this->pqua == "20") { echo " selected" ;} ?>>20%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '20'; ?>
 <option  value="25" <?php  if ($this->pqua == "25") { echo " selected" ;} ?>>25%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '25'; ?>
 <option  value="30" <?php  if ($this->pqua == "30") { echo " selected" ;} ?>>30%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '30'; ?>
 <option  value="35" <?php  if ($this->pqua == "35") { echo " selected" ;} ?>>35%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '35'; ?>
 <option  value="40" <?php  if ($this->pqua == "40") { echo " selected" ;} ?>>40%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '40'; ?>
 <option  value="45" <?php  if ($this->pqua == "45") { echo " selected" ;} ?>>45%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '45'; ?>
 <option  value="50" <?php  if ($this->pqua == "50") { echo " selected" ;} ?>>50%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '50'; ?>
 <option  value="55" <?php  if ($this->pqua == "55") { echo " selected" ;} ?>>55%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '55'; ?>
 <option  value="60" <?php  if ($this->pqua == "60") { echo " selected" ;} ?>>60%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '60'; ?>
 <option  value="65" <?php  if ($this->pqua == "65") { echo " selected" ;} ?>>65%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '65'; ?>
 <option  value="70" <?php  if ($this->pqua == "70") { echo " selected" ;} ?>>70%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '70'; ?>
 <option  value="75" <?php  if ($this->pqua == "75") { echo " selected" ;} ?>>75%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '75'; ?>
 <option  value="80" <?php  if ($this->pqua == "80") { echo " selected" ;} ?>>80%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '80'; ?>
 <option  value="85" <?php  if ($this->pqua == "85") { echo " selected" ;} ?>>85%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '85'; ?>
 <option  value="90" <?php  if ($this->pqua == "90") { echo " selected" ;} ?>>90%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '90'; ?>
 <option  value="95" <?php  if ($this->pqua == "95") { echo " selected" ;} ?>>95%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '95'; ?>
 <option  value="100" <?php  if ($this->pqua == "100") { echo " selected" ;} ?>>100%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '100'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pqui_line" id="hidden_field_data_pqui" style="<?php echo $sStyleHidden_pqui; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pqui_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pqui_label"><span id="id_label_pqui"><?php echo $this->nm_new_label['pqui']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pqui']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pqui'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = ''; ?>
 <option value="">SELECIONE</option>
 <option  value="0" <?php  if ($this->pqui == "0") { echo " selected" ;} ?>>0%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '0'; ?>
 <option  value="1" <?php  if ($this->pqui == "1") { echo " selected" ;} ?>>1%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '1'; ?>
 <option  value="2" <?php  if ($this->pqui == "2") { echo " selected" ;} ?>>2%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '2'; ?>
 <option  value="3" <?php  if ($this->pqui == "3") { echo " selected" ;} ?>>3%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '3'; ?>
 <option  value="4" <?php  if ($this->pqui == "4") { echo " selected" ;} ?>>4%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '4'; ?>
 <option  value="5" <?php  if ($this->pqui == "5") { echo " selected" ;} ?>>5%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '5'; ?>
 <option  value="6" <?php  if ($this->pqui == "6") { echo " selected" ;} ?>>6%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '6'; ?>
 <option  value="7" <?php  if ($this->pqui == "7") { echo " selected" ;} ?>>7%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '7'; ?>
 <option  value="8" <?php  if ($this->pqui == "8") { echo " selected" ;} ?>>8%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '8'; ?>
 <option  value="9" <?php  if ($this->pqui == "9") { echo " selected" ;} ?>>9%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '9'; ?>
 <option  value="10" <?php  if ($this->pqui == "10") { echo " selected" ;} ?>>10%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '10'; ?>
 <option  value="15" <?php  if ($this->pqui == "15") { echo " selected" ;} ?>>15%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '15'; ?>
 <option  value="20" <?php  if ($this->pqui == "20") { echo " selected" ;} ?>>20%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '20'; ?>
 <option  value="25" <?php  if ($this->pqui == "25") { echo " selected" ;} ?>>25%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '25'; ?>
 <option  value="30" <?php  if ($this->pqui == "30") { echo " selected" ;} ?>>30%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '30'; ?>
 <option  value="35" <?php  if ($this->pqui == "35") { echo " selected" ;} ?>>35%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '35'; ?>
 <option  value="40" <?php  if ($this->pqui == "40") { echo " selected" ;} ?>>40%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '40'; ?>
 <option  value="45" <?php  if ($this->pqui == "45") { echo " selected" ;} ?>>45%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '45'; ?>
 <option  value="50" <?php  if ($this->pqui == "50") { echo " selected" ;} ?>>50%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '50'; ?>
 <option  value="55" <?php  if ($this->pqui == "55") { echo " selected" ;} ?>>55%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '55'; ?>
 <option  value="60" <?php  if ($this->pqui == "60") { echo " selected" ;} ?>>60%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '60'; ?>
 <option  value="65" <?php  if ($this->pqui == "65") { echo " selected" ;} ?>>65%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '65'; ?>
 <option  value="70" <?php  if ($this->pqui == "70") { echo " selected" ;} ?>>70%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '70'; ?>
 <option  value="75" <?php  if ($this->pqui == "75") { echo " selected" ;} ?>>75%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '75'; ?>
 <option  value="80" <?php  if ($this->pqui == "80") { echo " selected" ;} ?>>80%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '80'; ?>
 <option  value="85" <?php  if ($this->pqui == "85") { echo " selected" ;} ?>>85%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '85'; ?>
 <option  value="90" <?php  if ($this->pqui == "90") { echo " selected" ;} ?>>90%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '90'; ?>
 <option  value="95" <?php  if ($this->pqui == "95") { echo " selected" ;} ?>>95%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '95'; ?>
 <option  value="100" <?php  if ($this->pqui == "100") { echo " selected" ;} ?>>100%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '100'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = ''; ?>
 <option value="">SELECIONE</option>
 <option  value="0" <?php  if ($this->psex == "0") { echo " selected" ;} ?>>0%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '0'; ?>
 <option  value="1" <?php  if ($this->psex == "1") { echo " selected" ;} ?>>1%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '1'; ?>
 <option  value="2" <?php  if ($this->psex == "2") { echo " selected" ;} ?>>2%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '2'; ?>
 <option  value="3" <?php  if ($this->psex == "3") { echo " selected" ;} ?>>3%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '3'; ?>
 <option  value="4" <?php  if ($this->psex == "4") { echo " selected" ;} ?>>4%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '4'; ?>
 <option  value="5" <?php  if ($this->psex == "5") { echo " selected" ;} ?>>5%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '5'; ?>
 <option  value="6" <?php  if ($this->psex == "6") { echo " selected" ;} ?>>6%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '6'; ?>
 <option  value="7" <?php  if ($this->psex == "7") { echo " selected" ;} ?>>7%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '7'; ?>
 <option  value="8" <?php  if ($this->psex == "8") { echo " selected" ;} ?>>8%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '8'; ?>
 <option  value="9" <?php  if ($this->psex == "9") { echo " selected" ;} ?>>9%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '9'; ?>
 <option  value="10" <?php  if ($this->psex == "10") { echo " selected" ;} ?>>10%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '10'; ?>
 <option  value="15" <?php  if ($this->psex == "15") { echo " selected" ;} ?>>15%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '15'; ?>
 <option  value="20" <?php  if ($this->psex == "20") { echo " selected" ;} ?>>20%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '20'; ?>
 <option  value="25" <?php  if ($this->psex == "25") { echo " selected" ;} ?>>25%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '25'; ?>
 <option  value="30" <?php  if ($this->psex == "30") { echo " selected" ;} ?>>30%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '30'; ?>
 <option  value="35" <?php  if ($this->psex == "35") { echo " selected" ;} ?>>35%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '35'; ?>
 <option  value="40" <?php  if ($this->psex == "40") { echo " selected" ;} ?>>40%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '40'; ?>
 <option  value="45" <?php  if ($this->psex == "45") { echo " selected" ;} ?>>45%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '45'; ?>
 <option  value="50" <?php  if ($this->psex == "50") { echo " selected" ;} ?>>50%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '50'; ?>
 <option  value="55" <?php  if ($this->psex == "55") { echo " selected" ;} ?>>55%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '55'; ?>
 <option  value="60" <?php  if ($this->psex == "60") { echo " selected" ;} ?>>60%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '60'; ?>
 <option  value="65" <?php  if ($this->psex == "65") { echo " selected" ;} ?>>65%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '65'; ?>
 <option  value="70" <?php  if ($this->psex == "70") { echo " selected" ;} ?>>70%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '70'; ?>
 <option  value="75" <?php  if ($this->psex == "75") { echo " selected" ;} ?>>75%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '75'; ?>
 <option  value="80" <?php  if ($this->psex == "80") { echo " selected" ;} ?>>80%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '80'; ?>
 <option  value="85" <?php  if ($this->psex == "85") { echo " selected" ;} ?>>85%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '85'; ?>
 <option  value="90" <?php  if ($this->psex == "90") { echo " selected" ;} ?>>90%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '90'; ?>
 <option  value="95" <?php  if ($this->psex == "95") { echo " selected" ;} ?>>95%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '95'; ?>
 <option  value="100" <?php  if ($this->psex == "100") { echo " selected" ;} ?>>100%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '100'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_psab_line" id="hidden_field_data_psab" style="<?php echo $sStyleHidden_psab; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_psab_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_psab_label"><span id="id_label_psab"><?php echo $this->nm_new_label['psab']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['psab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['psab'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = ''; ?>
 <option value="">SELECIONE</option>
 <option  value="0" <?php  if ($this->psab == "0") { echo " selected" ;} ?>>0%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '0'; ?>
 <option  value="1" <?php  if ($this->psab == "1") { echo " selected" ;} ?>>1%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '1'; ?>
 <option  value="2" <?php  if ($this->psab == "2") { echo " selected" ;} ?>>2%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '2'; ?>
 <option  value="3" <?php  if ($this->psab == "3") { echo " selected" ;} ?>>3%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '3'; ?>
 <option  value="4" <?php  if ($this->psab == "4") { echo " selected" ;} ?>>4%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '4'; ?>
 <option  value="5" <?php  if ($this->psab == "5") { echo " selected" ;} ?>>5%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '5'; ?>
 <option  value="6" <?php  if ($this->psab == "6") { echo " selected" ;} ?>>6%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '6'; ?>
 <option  value="7" <?php  if ($this->psab == "7") { echo " selected" ;} ?>>7%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '7'; ?>
 <option  value="8" <?php  if ($this->psab == "8") { echo " selected" ;} ?>>8%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '8'; ?>
 <option  value="9" <?php  if ($this->psab == "9") { echo " selected" ;} ?>>9%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '9'; ?>
 <option  value="10" <?php  if ($this->psab == "10") { echo " selected" ;} ?>>10%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '10'; ?>
 <option  value="15" <?php  if ($this->psab == "15") { echo " selected" ;} ?>>15%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '15'; ?>
 <option  value="20" <?php  if ($this->psab == "20") { echo " selected" ;} ?>>20%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '20'; ?>
 <option  value="25" <?php  if ($this->psab == "25") { echo " selected" ;} ?>>25%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '25'; ?>
 <option  value="30" <?php  if ($this->psab == "30") { echo " selected" ;} ?>>30%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '30'; ?>
 <option  value="35" <?php  if ($this->psab == "35") { echo " selected" ;} ?>>35%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '35'; ?>
 <option  value="40" <?php  if ($this->psab == "40") { echo " selected" ;} ?>>40%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '40'; ?>
 <option  value="45" <?php  if ($this->psab == "45") { echo " selected" ;} ?>>45%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '45'; ?>
 <option  value="50" <?php  if ($this->psab == "50") { echo " selected" ;} ?>>50%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '50'; ?>
 <option  value="55" <?php  if ($this->psab == "55") { echo " selected" ;} ?>>55%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '55'; ?>
 <option  value="60" <?php  if ($this->psab == "60") { echo " selected" ;} ?>>60%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '60'; ?>
 <option  value="65" <?php  if ($this->psab == "65") { echo " selected" ;} ?>>65%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '65'; ?>
 <option  value="70" <?php  if ($this->psab == "70") { echo " selected" ;} ?>>70%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '70'; ?>
 <option  value="75" <?php  if ($this->psab == "75") { echo " selected" ;} ?>>75%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '75'; ?>
 <option  value="80" <?php  if ($this->psab == "80") { echo " selected" ;} ?>>80%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '80'; ?>
 <option  value="85" <?php  if ($this->psab == "85") { echo " selected" ;} ?>>85%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '85'; ?>
 <option  value="90" <?php  if ($this->psab == "90") { echo " selected" ;} ?>>90%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '90'; ?>
 <option  value="95" <?php  if ($this->psab == "95") { echo " selected" ;} ?>>95%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '95'; ?>
 <option  value="100" <?php  if ($this->psab == "100") { echo " selected" ;} ?>>100%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '100'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pdom_line" id="hidden_field_data_pdom" style="<?php echo $sStyleHidden_pdom; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pdom_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pdom_label"><span id="id_label_pdom"><?php echo $this->nm_new_label['pdom']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pdom']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pdom'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = ''; ?>
 <option value="">SELECIONE</option>
 <option  value="0" <?php  if ($this->pdom == "0") { echo " selected" ;} ?>>0%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '0'; ?>
 <option  value="1" <?php  if ($this->pdom == "1") { echo " selected" ;} ?>>1%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '1'; ?>
 <option  value="2" <?php  if ($this->pdom == "2") { echo " selected" ;} ?>>2%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '2'; ?>
 <option  value="3" <?php  if ($this->pdom == "3") { echo " selected" ;} ?>>3%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '3'; ?>
 <option  value="4" <?php  if ($this->pdom == "4") { echo " selected" ;} ?>>4%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '4'; ?>
 <option  value="5" <?php  if ($this->pdom == "5") { echo " selected" ;} ?>>5%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '5'; ?>
 <option  value="6" <?php  if ($this->pdom == "6") { echo " selected" ;} ?>>6%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '6'; ?>
 <option  value="7" <?php  if ($this->pdom == "7") { echo " selected" ;} ?>>7%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '7'; ?>
 <option  value="8" <?php  if ($this->pdom == "8") { echo " selected" ;} ?>>8%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '8'; ?>
 <option  value="9" <?php  if ($this->pdom == "9") { echo " selected" ;} ?>>9%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '9'; ?>
 <option  value="10" <?php  if ($this->pdom == "10") { echo " selected" ;} ?>>10%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '10'; ?>
 <option  value="15" <?php  if ($this->pdom == "15") { echo " selected" ;} ?>>15%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '15'; ?>
 <option  value="20" <?php  if ($this->pdom == "20") { echo " selected" ;} ?>>20%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '20'; ?>
 <option  value="25" <?php  if ($this->pdom == "25") { echo " selected" ;} ?>>25%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '25'; ?>
 <option  value="30" <?php  if ($this->pdom == "30") { echo " selected" ;} ?>>30%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '30'; ?>
 <option  value="35" <?php  if ($this->pdom == "35") { echo " selected" ;} ?>>35%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '35'; ?>
 <option  value="40" <?php  if ($this->pdom == "40") { echo " selected" ;} ?>>40%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '40'; ?>
 <option  value="45" <?php  if ($this->pdom == "45") { echo " selected" ;} ?>>45%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '45'; ?>
 <option  value="50" <?php  if ($this->pdom == "50") { echo " selected" ;} ?>>50%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '50'; ?>
 <option  value="55" <?php  if ($this->pdom == "55") { echo " selected" ;} ?>>55%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '55'; ?>
 <option  value="60" <?php  if ($this->pdom == "60") { echo " selected" ;} ?>>60%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '60'; ?>
 <option  value="65" <?php  if ($this->pdom == "65") { echo " selected" ;} ?>>65%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '65'; ?>
 <option  value="70" <?php  if ($this->pdom == "70") { echo " selected" ;} ?>>70%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '70'; ?>
 <option  value="75" <?php  if ($this->pdom == "75") { echo " selected" ;} ?>>75%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '75'; ?>
 <option  value="80" <?php  if ($this->pdom == "80") { echo " selected" ;} ?>>80%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '80'; ?>
 <option  value="85" <?php  if ($this->pdom == "85") { echo " selected" ;} ?>>85%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '85'; ?>
 <option  value="90" <?php  if ($this->pdom == "90") { echo " selected" ;} ?>>90%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '90'; ?>
 <option  value="95" <?php  if ($this->pdom == "95") { echo " selected" ;} ?>>95%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '95'; ?>
 <option  value="100" <?php  if ($this->pdom == "100") { echo " selected" ;} ?>>100%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '100'; ?>
 </select></span>
</span><?php  }?>
...
<?php $sStyleHidden_pdom_dumb = ('' == $sStyleHidden_pdom) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_pdom_dumb" style="<?php echo $sStyleHidden_pdom_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_destaque_img_line" id="hidden_field_data_destaque_img" style="<?php echo $sStyleHidden_destaque_img; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_destaque_img_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_destaque_img_label"><span id="id_label_destaque_img"><?php echo $this->nm_new_label['destaque_img']; ?></span></span><br><?php
...
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_destaque_img_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_destaque_img_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
?> 
    ...
    <TD class="scFormDataOdd css_destaque_line" id="hidden_field_data_destaque" style="<?php echo $sStyleHidden_destaque; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_destaque_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_destaque_label"><span id="id_label_destaque"><?php echo $this->nm_new_label['destaque']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_destaque'][] = '1'; ?>
<?php  if (in_array("1", $this->destaque_1))  { echo " checked" ;} ?> onClick="" >Em Destaque</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_destaque_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_destaque_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php $sStyleHidden_destaque_dumb = ('' == $sStyleHidden_destaque) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_destaque_dumb" style="<?php echo $sStyleHidden_destaque_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php $sStyleHidden_foto_publicacao_dumb = ('' == $sStyleHidden_foto_publicacao) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_foto_publicacao_dumb" style="<?php echo $sStyleHidden_foto_publicacao_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<TABLE align="center" id="hidden_bloco_5" class="scFormTable" width="100%" style="height: 100%;">   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock" style="text-align: center; vertical-align: middle">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="center" valign="middle" class="scFormBlockFont">É RECOMENDÁVEL QUE O TEXTO DA PUBLICAÇÃO  QUE SERÁ INSERIDO ABAIXO SEJA UM TEXTO CURTO COM NO MÁXIMO 5 LINHAS</TD>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] != "R")
{
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script> 
<?php
 $NM_pag_atual = "form_ap_eventos_publicador_mob_form0";
 if (isset($this->nmgp_ancora) && $this->nmgp_ancora != "")
 {
     $NM_pag_atual = "form_ap_eventos_publicador_mob_form" . $this->nmgp_ancora;
 }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_ap_eventos_publicador_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_ap_eventos_publicador_mob");
 parent.scAjaxDetailHeight("form_ap_eventos_publicador_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
