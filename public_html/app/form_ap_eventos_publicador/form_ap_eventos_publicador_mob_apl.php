<?php
//
class form_ap_eventos_publicador_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['texto_premiacao']))
          {
              $this->texto_premiacao = $this->NM_ajax_info['param']['texto_premiacao'];
          }
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_ap_eventos_publicador_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->usr_cnpj)) 
          {
              $_SESSION['usr_cnpj'] = $this->usr_cnpj;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_ap_eventos_publicador_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['initialize'])
          {
              $_SESSION['scriptcase']['form_ap_eventos_publicador_mob']['contr_erro'] = 'on';
         ?>
...
<?php
$_SESSION['scriptcase']['form_ap_eventos_publicador_mob']['contr_erro'] = 'off';
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob'][$I_conf]  = $Conf_opt;
              }
          }
          }
          $this->Ini->init2();
      ...
      $_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['upload_field_info']['foto_publicacao'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_ap_eventos_publicador_mob',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_ap_eventos_publicador_mob']['upload_field_info']['foto_premiacao'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_ap_eventos_publicador_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_ap_eventos_publicador_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_ap_eventos_publicador_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_ap_eventos_publicador_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_ap_eventos_publicador_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_ap_eventos_publicador_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_ap_eventos_publicador_mob']['label'] = "CHECK-IN cash ";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_ap_eventos_publicador_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_ap_eventos_publicador_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_ap_eventos_publicador_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['upload_field_ul_name'][$this->foto_publicacao_ul_name]))
          {
              $this->NM_ajax_info['param']['foto_publicacao_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['upload_field_ul_name'][$this->foto_publicacao_ul_name];
          }
      ...
      elseif (isset($this->foto_publicacao_ul_name) && '' != $this->foto_publicacao_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['upload_field_ul_name'][$this->foto_publicacao_ul_name]))
          {
              $this->foto_publicacao_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['upload_field_ul_name'][$this->foto_publicacao_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ap_eventos_publicador_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_ap_eventos_publicador_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_ap_eventos_publicador_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_ap_eventos_publicador_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_ap_eventos_publicador/form_ap_eventos_publicador_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_ap_eventos_publicador_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_ap_eventos_publicador_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_ap_eventos_publicador_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_ap_eventos_publicador/form_ap_eventos_publicador_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_ap_eventos_publicador_mob_erro.class.php"); 
      }
      $this->Erro      = new form_ap_eventos_publicador_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['opcao']))
         { 
             if ($this->pk_publicador != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_ap_eventos_publicador_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['final'];
      }
      else
      {
      }
...
$_SESSION['scriptcase']['form_ap_eventos_publicador_mob']['contr_erro'] = 'off'; 
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dados_select'];
     }
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          form_ap_eventos_publicador_mob_pack_ajax_response();
          exit;
      }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dados_select']['destaque']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->destaque = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dados_select']['destaque'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['recarga'] = $this->nmgp_opcao;
      }
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_ap_eventos_publicador_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_ap_eventos_publicador_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_ap_eventos_publicador_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_ap_eventos_publicador_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_ap_eventos_publicador_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_ap_eventos_publicador_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_fk_contrato(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
               if (!empty($this->fk_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_fk_contrato']) && !in_array($this->fk_contrato, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_fk_contrato']))
               {
    ...
    function ValidateField_nomenclatura(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['nomenclatura']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['nomenclatura'] == "on")) 
      { 
    ...
    function ValidateField_cep(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['cep']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['cep'] == "on") 
           { 
              $Campos_Falta[] = "CEP" ; 
              if (!isset($Campos_Erros['cep']))
              {
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['bairro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['bairro'] == "on")) 
      { 
          if ($this->bairro == "")  
          { 
              $Campos_Falta[] =  "BAIRRO" ; 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['rua']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['rua'] == "on")) 
      { 
          if ($this->rua == "")  
          { 
              $Campos_Falta[] =  "RUA" ; 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['numero']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['numero'] == "on")) 
      { 
          if ($this->numero == "")  
          { 
              $Campos_Falta[] =  "NUMERO" ; 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['cidade']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['cidade'] == "on")) 
      { 
          if ($this->cidade == "")  
          { 
              $Campos_Falta[] =  "CIDADE" ; 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['estado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['estado'] == "on")) 
      { 
          if ($this->estado == "")  
          { 
              $Campos_Falta[] =  "ESTADO" ; 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['abreviatura']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['abreviatura'] == "on")) 
      { 
          if ($this->abreviatura == "")  
          { 
    ...
    function ValidateField_pseg(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pseg']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pseg'] == "on")
        { 
    ...
    function ValidateField_pter(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pter']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pter'] == "on")
        { 
          $Campos_Falta[] = "TERÇA" ;
    ...
    function ValidateField_pqua(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pqua']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pqua'] == "on")
        { 
          $Campos_Falta[] = "QUARTA" ;
    ...
    function ValidateField_pqui(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pqui']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pqui'] == "on")
        { 
          $Campos_Falta[] = "QUINTA" ;
    ...
    function ValidateField_psex(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['psex']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['psex'] == "on")
        { 
          $Campos_Falta[] = "SEXTA" ;
    ...
    function ValidateField_psab(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['psab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['psab'] == "on")
        { 
          $Campos_Falta[] = "SÁBADO" ;
    ...
    function ValidateField_pdom(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pdom']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['php_cmp_required']['pdom'] == "on")
        { 
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'form_ap_eventos_publicador_mob_doc_name.php';
              }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['pk_publicador']['keyVal'] = form_ap_eventos_publicador_mob_pack_protect_string($this->nmgp_dados_form['pk_publicador']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_fk_contrato']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_fk_contrato'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_fk_contrato']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_fk_contrato'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_ap_eventos_publicador_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_fk_contrato'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fk_contrato']['valList'][$i] = form_ap_eventos_publicador_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('0') => form_ap_eventos_publicador_mob_pack_protect_string("Ativo"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('1') => form_ap_eventos_publicador_mob_pack_protect_string("Inativo"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_situacao'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_situacao'][] = '1';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['situacao']['valList'][$i] = form_ap_eventos_publicador_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('0') => form_ap_eventos_publicador_mob_pack_protect_string("0%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('1') => form_ap_eventos_publicador_mob_pack_protect_string("1%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('2') => form_ap_eventos_publicador_mob_pack_protect_string("2%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('3') => form_ap_eventos_publicador_mob_pack_protect_string("3%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('4') => form_ap_eventos_publicador_mob_pack_protect_string("4%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('5') => form_ap_eventos_publicador_mob_pack_protect_string("5%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('6') => form_ap_eventos_publicador_mob_pack_protect_string("6%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('7') => form_ap_eventos_publicador_mob_pack_protect_string("7%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('8') => form_ap_eventos_publicador_mob_pack_protect_string("8%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('9') => form_ap_eventos_publicador_mob_pack_protect_string("9%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('10') => form_ap_eventos_publicador_mob_pack_protect_string("10%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('15') => form_ap_eventos_publicador_mob_pack_protect_string("15%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('20') => form_ap_eventos_publicador_mob_pack_protect_string("20%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('25') => form_ap_eventos_publicador_mob_pack_protect_string("25%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('30') => form_ap_eventos_publicador_mob_pack_protect_string("30%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('35') => form_ap_eventos_publicador_mob_pack_protect_string("35%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('40') => form_ap_eventos_publicador_mob_pack_protect_string("40%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('45') => form_ap_eventos_publicador_mob_pack_protect_string("45%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('50') => form_ap_eventos_publicador_mob_pack_protect_string("50%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('55') => form_ap_eventos_publicador_mob_pack_protect_string("55%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('60') => form_ap_eventos_publicador_mob_pack_protect_string("60%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('65') => form_ap_eventos_publicador_mob_pack_protect_string("65%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('70') => form_ap_eventos_publicador_mob_pack_protect_string("70%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('75') => form_ap_eventos_publicador_mob_pack_protect_string("75%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('80') => form_ap_eventos_publicador_mob_pack_protect_string("80%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('85') => form_ap_eventos_publicador_mob_pack_protect_string("85%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('90') => form_ap_eventos_publicador_mob_pack_protect_string("90%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('95') => form_ap_eventos_publicador_mob_pack_protect_string("95%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('100') => form_ap_eventos_publicador_mob_pack_protect_string("100%"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '4';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '5';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '6';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '7';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '8';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '9';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '10';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '15';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '20';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '25';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '30';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '35';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '40';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '45';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '50';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '55';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '60';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '65';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '70';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '75';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '80';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '85';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '90';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '95';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pseg'][] = '100';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"pseg\"";
          ...
          {
              $this->NM_ajax_info['fldList']['pseg']['valList'][$i] = form_ap_eventos_publicador_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('95') => form_ap_eventos_publicador_mob_pack_protect_string("95%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('100') => form_ap_eventos_publicador_mob_pack_protect_string("100%"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '4';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '5';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '6';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '7';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '8';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '9';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '10';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '15';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '20';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '25';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '30';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '35';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '40';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '45';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '50';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '55';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '60';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '65';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '70';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '75';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '80';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '85';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '90';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '95';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pter'][] = '100';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"pter\"";
          ...
          {
              $this->NM_ajax_info['fldList']['pter']['valList'][$i] = form_ap_eventos_publicador_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('95') => form_ap_eventos_publicador_mob_pack_protect_string("95%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('100') => form_ap_eventos_publicador_mob_pack_protect_string("100%"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '4';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '5';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '6';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '7';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '8';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '9';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '10';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '15';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '20';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '25';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '30';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '35';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '40';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '45';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '50';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '55';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '60';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '65';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '70';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '75';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '80';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '85';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '90';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '95';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqua'][] = '100';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"pqua\"";
          ...
          {
              $this->NM_ajax_info['fldList']['pqua']['valList'][$i] = form_ap_eventos_publicador_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('95') => form_ap_eventos_publicador_mob_pack_protect_string("95%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('100') => form_ap_eventos_publicador_mob_pack_protect_string("100%"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '4';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '5';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '6';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '7';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '8';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '9';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '10';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '15';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '20';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '25';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '30';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '35';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '40';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '45';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '50';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '55';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '60';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '65';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '70';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '75';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '80';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '85';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '90';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '95';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pqui'][] = '100';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"pqui\"";
          ...
          {
              $this->NM_ajax_info['fldList']['pqui']['valList'][$i] = form_ap_eventos_publicador_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('95') => form_ap_eventos_publicador_mob_pack_protect_string("95%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('100') => form_ap_eventos_publicador_mob_pack_protect_string("100%"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '4';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '5';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '6';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '7';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '8';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '9';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '10';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '15';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '20';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '25';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '30';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '35';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '40';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '45';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '50';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '55';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '60';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '65';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '70';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '75';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '80';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '85';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '90';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '95';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psex'][] = '100';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"psex\"";
          ...
          {
              $this->NM_ajax_info['fldList']['psex']['valList'][$i] = form_ap_eventos_publicador_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('95') => form_ap_eventos_publicador_mob_pack_protect_string("95%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('100') => form_ap_eventos_publicador_mob_pack_protect_string("100%"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '4';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '5';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '6';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '7';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '8';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '9';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '10';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '15';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '20';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '25';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '30';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '35';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '40';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '45';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '50';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '55';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '60';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '65';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '70';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '75';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '80';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '85';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '90';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '95';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_psab'][] = '100';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"psab\"";
          ...
          {
              $this->NM_ajax_info['fldList']['psab']['valList'][$i] = form_ap_eventos_publicador_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('95') => form_ap_eventos_publicador_mob_pack_protect_string("95%"));
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('100') => form_ap_eventos_publicador_mob_pack_protect_string("100%"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '4';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '5';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '6';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '7';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '8';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '9';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '10';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '15';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '20';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '25';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '30';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '35';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '40';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '45';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '50';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '55';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '60';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '65';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '70';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '75';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '80';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '85';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '90';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '95';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_pdom'][] = '100';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"pdom\"";
          ...
          {
              $this->NM_ajax_info['fldList']['pdom']['valList'][$i] = form_ap_eventos_publicador_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_ap_eventos_publicador_mob_pack_protect_string('1') => form_ap_eventos_publicador_mob_pack_protect_string("Em Destaque"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['Lookup_destaque'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['destaque']['valList'][$i] = form_ap_eventos_publicador_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   { 
       ...
       { 
           ...
           $out_foto_publicacao = $this->Ini->path_imag_temp . "/sc_foto_publicacao_300300" . $md5_foto_publicacao . ".gif" ;  
           if (is_file($this->Ini->root . $out_foto_publicacao))  
           { 
               $NM_img_time = filemtime($this->Ini->root . $out_foto_publicacao) + 0; 
               if ($this->Ini->nm_timestamp < $NM_img_time)  
   ...
   function ajax_return_values_pk_publicador($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
$_SESSION['scriptcase']['form_ap_eventos_publicador_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $this->abreviatura = $this->abreviatura_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['parms'] = "pk_publicador?#?$this->pk_publicador?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_ap_eventos_publicador_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['total'] = $qt_geral_reg_form_ap_eventos_publicador_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->pk_publicador))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_ap_eventos_publicador_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start'] > $qt_geral_reg_form_ap_eventos_publicador_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start'] = $qt_geral_reg_form_ap_eventos_publicador_mob; 
          }
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['total'] + 1; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      if ($this->nmgp_opcao != "novo" && $this->nmgp_opcao != "nada" && $this->nmgp_opcao != "refresh_insert") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['parms'] = "pk_publicador?#?$this->pk_publicador?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['sub_dir'][0]  = "" . $_SESSION['pastacliente'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['sub_dir'][1]  = "" . $_SESSION['pastaclientepremio'];
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['reg_start'] < $qt_geral_reg_form_ap_eventos_publicador_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dados_select'];
...
//-- 
   ...
   {  
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(pk_publicador) from " . $this->Ini->nm_tabela . " where pk_publicador < $this->pk_publicador" . $str_where_filter; 
         $rs = $this->Db->Execute("select max(pk_publicador) from " . $this->Ini->nm_tabela . " where pk_publicador < $this->pk_publicador" . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(pk_publicador) from " . $this->Ini->nm_tabela . " where pk_publicador < $this->pk_publicador" . $str_where_filter; 
     ...
     { 
         $this->pk_publicador = substr($this->Db->qstr($rs->fields[0]), 1, -1); 
         $rs->Close();  
         $this->nmgp_opcao = "igual";  
         return ;  
     } 
...
//-- 
   ...
   {  
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(pk_publicador) from " . $this->Ini->nm_tabela . " where pk_publicador > $this->pk_publicador" . $str_where_filter; 
         $rs = $this->Db->Execute("select min(pk_publicador) from " . $this->Ini->nm_tabela . " where pk_publicador > $this->pk_publicador" . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(pk_publicador) from " . $this->Ini->nm_tabela . " where pk_publicador > $this->pk_publicador" . $str_where_filter; 
...
//-- 
   ...
   {   
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(pk_publicador) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
         $rs = $this->Db->Execute("select min(pk_publicador) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(pk_publicador) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
...
//-- 
   ...
   { 
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(pk_publicador) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
         $rs = $this->Db->Execute("select max(pk_publicador) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(pk_publicador) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
...
function cep_onChange($texto_premiacao)
{
$_SESSION['scriptcase']['form_ap_eventos_publicador_mob']['contr_erro'] = 'on';
...
$original_rua = $this->rua;
$original_bairro = $this->bairro;
$original_texto_premiacao = $this->texto_premiacao;
...
$modificado_texto_premiacao = $this->texto_premiacao;
...
if ($original_texto_premiacao !== $modificado_texto_premiacao || isset($this->nmgp_cmp_readonly['texto_premiacao']) || (isset($bFlagRead_texto_premiacao) && $bFlagRead_texto_premiacao))
{
    $this->ajax_return_values_texto_premiacao(true);
}
form_ap_eventos_publicador_mob_pack_ajax_response();
exit;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out1_foto_publicacao))
       {
        ...
        include_once("form_ap_eventos_publicador_mob_form0.php");
        include_once("form_ap_eventos_publicador_mob_form1.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_ap_eventos_publicador_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['total'] = $qt_geral_reg_form_ap_eventos_publicador_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_ap_eventos_publicador_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_ap_eventos_publicador_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_ap_eventos_publicador_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['retorno_edit'] = "";
   }
