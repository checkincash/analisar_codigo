  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ap_eventos_publicador_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_ap_eventos_publicador_mob_validate_fk_contrato()
  {
    var nomeCampo_fk_contrato = "fk_contrato";
    var var_fk_contrato = scAjaxGetFieldSelect(nomeCampo_fk_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_fk_contrato(var_fk_contrato, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_fk_contrato_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_fk_contrato

  function do_ajax_form_ap_eventos_publicador_mob_validate_fk_contrato_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_fk_contrato_cb

  // ---------- Validate situacao
  function do_ajax_form_ap_eventos_publicador_mob_validate_situacao()
  {
    var nomeCampo_situacao = "situacao";
    var var_situacao = scAjaxGetFieldSelect(nomeCampo_situacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_situacao(var_situacao, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_situacao_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_situacao

  function do_ajax_form_ap_eventos_publicador_mob_validate_situacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_situacao_cb

  // ---------- Validate nomenclatura
  function do_ajax_form_ap_eventos_publicador_mob_validate_nomenclatura()
  {
    var nomeCampo_nomenclatura = "nomenclatura";
    var var_nomenclatura = scAjaxGetFieldText(nomeCampo_nomenclatura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_nomenclatura(var_nomenclatura, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_nomenclatura_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_nomenclatura

  function do_ajax_form_ap_eventos_publicador_mob_validate_nomenclatura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_nomenclatura_cb

  // ---------- Validate data_criacao
  function do_ajax_form_ap_eventos_publicador_mob_validate_data_criacao()
  {
    var nomeCampo_data_criacao = "data_criacao";
    var var_data_criacao = scAjaxGetFieldText(nomeCampo_data_criacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_data_criacao(var_data_criacao, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_data_criacao_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_data_criacao

  function do_ajax_form_ap_eventos_publicador_mob_validate_data_criacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_data_criacao_cb

  // ---------- Validate cep
  function do_ajax_form_ap_eventos_publicador_mob_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_cep(var_cep, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_cep_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_cep

  function do_ajax_form_ap_eventos_publicador_mob_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cep";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_cep_cb

  // ---------- Validate bairro
  function do_ajax_form_ap_eventos_publicador_mob_validate_bairro()
  {
    var nomeCampo_bairro = "bairro";
    var var_bairro = scAjaxGetFieldText(nomeCampo_bairro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_bairro(var_bairro, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_bairro_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_bairro

  function do_ajax_form_ap_eventos_publicador_mob_validate_bairro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bairro";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_bairro_cb

  // ---------- Validate rua
  function do_ajax_form_ap_eventos_publicador_mob_validate_rua()
  {
    var nomeCampo_rua = "rua";
    var var_rua = scAjaxGetFieldText(nomeCampo_rua);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_rua(var_rua, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_rua_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_rua

  function do_ajax_form_ap_eventos_publicador_mob_validate_rua_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "rua";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_rua_cb

  // ---------- Validate numero
  function do_ajax_form_ap_eventos_publicador_mob_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_numero(var_numero, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_numero_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_numero

  function do_ajax_form_ap_eventos_publicador_mob_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "numero";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_numero_cb

  // ---------- Validate complemento
  function do_ajax_form_ap_eventos_publicador_mob_validate_complemento()
  {
    var nomeCampo_complemento = "complemento";
    var var_complemento = scAjaxGetFieldText(nomeCampo_complemento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_complemento(var_complemento, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_complemento_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_complemento

  function do_ajax_form_ap_eventos_publicador_mob_validate_complemento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_complemento_cb

  // ---------- Validate cidade
  function do_ajax_form_ap_eventos_publicador_mob_validate_cidade()
  {
    var nomeCampo_cidade = "cidade";
    var var_cidade = scAjaxGetFieldText(nomeCampo_cidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_cidade(var_cidade, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_cidade_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_cidade

  function do_ajax_form_ap_eventos_publicador_mob_validate_cidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cidade";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_cidade_cb

  // ---------- Validate estado
  function do_ajax_form_ap_eventos_publicador_mob_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldText(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_estado(var_estado, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_estado_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_estado

  function do_ajax_form_ap_eventos_publicador_mob_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "estado";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_estado_cb

  // ---------- Validate abreviatura
  function do_ajax_form_ap_eventos_publicador_mob_validate_abreviatura()
  {
    var nomeCampo_abreviatura = "abreviatura";
    var var_abreviatura = scAjaxGetFieldText(nomeCampo_abreviatura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_abreviatura(var_abreviatura, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_abreviatura_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_abreviatura

  function do_ajax_form_ap_eventos_publicador_mob_validate_abreviatura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_abreviatura_cb

  // ---------- Validate pseg
  function do_ajax_form_ap_eventos_publicador_mob_validate_pseg()
  {
    var nomeCampo_pseg = "pseg";
    var var_pseg = scAjaxGetFieldSelect(nomeCampo_pseg);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_pseg(var_pseg, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_pseg_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_pseg

  function do_ajax_form_ap_eventos_publicador_mob_validate_pseg_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pseg";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_pseg_cb

  // ---------- Validate pter
  function do_ajax_form_ap_eventos_publicador_mob_validate_pter()
  {
    var nomeCampo_pter = "pter";
    var var_pter = scAjaxGetFieldSelect(nomeCampo_pter);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_pter(var_pter, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_pter_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_pter

  function do_ajax_form_ap_eventos_publicador_mob_validate_pter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pter";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_pter_cb

  // ---------- Validate pqua
  function do_ajax_form_ap_eventos_publicador_mob_validate_pqua()
  {
    var nomeCampo_pqua = "pqua";
    var var_pqua = scAjaxGetFieldSelect(nomeCampo_pqua);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_pqua(var_pqua, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_pqua_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_pqua

  function do_ajax_form_ap_eventos_publicador_mob_validate_pqua_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pqua";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_pqua_cb

  // ---------- Validate pqui
  function do_ajax_form_ap_eventos_publicador_mob_validate_pqui()
  {
    var nomeCampo_pqui = "pqui";
    var var_pqui = scAjaxGetFieldSelect(nomeCampo_pqui);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_pqui(var_pqui, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_pqui_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_pqui

  function do_ajax_form_ap_eventos_publicador_mob_validate_pqui_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pqui";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_pqui_cb

  // ---------- Validate psex
  function do_ajax_form_ap_eventos_publicador_mob_validate_psex()
  {
    var nomeCampo_psex = "psex";
    var var_psex = scAjaxGetFieldSelect(nomeCampo_psex);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_psex(var_psex, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_psex_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_psex

  function do_ajax_form_ap_eventos_publicador_mob_validate_psex_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "psex";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_psex_cb

  // ---------- Validate psab
  function do_ajax_form_ap_eventos_publicador_mob_validate_psab()
  {
    var nomeCampo_psab = "psab";
    var var_psab = scAjaxGetFieldSelect(nomeCampo_psab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_psab(var_psab, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_psab_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_psab

  function do_ajax_form_ap_eventos_publicador_mob_validate_psab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "psab";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_psab_cb

  // ---------- Validate pdom
  function do_ajax_form_ap_eventos_publicador_mob_validate_pdom()
  {
    var nomeCampo_pdom = "pdom";
    var var_pdom = scAjaxGetFieldSelect(nomeCampo_pdom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_pdom(var_pdom, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_pdom_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_pdom

  function do_ajax_form_ap_eventos_publicador_mob_validate_pdom_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pdom";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_pdom_cb

  // ---------- Validate destaque_img
  function do_ajax_form_ap_eventos_publicador_mob_validate_destaque_img()
  {
    var nomeCampo_destaque_img = "destaque_img";
    var var_destaque_img = scAjaxGetFieldText(nomeCampo_destaque_img);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_destaque_img(var_destaque_img, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_destaque_img_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_destaque_img

  function do_ajax_form_ap_eventos_publicador_mob_validate_destaque_img_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_destaque_img_cb

  // ---------- Validate destaque
  function do_ajax_form_ap_eventos_publicador_mob_validate_destaque()
  {
    var nomeCampo_destaque = "destaque";
    var var_destaque = scAjaxGetFieldCheckbox(nomeCampo_destaque, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_destaque(var_destaque, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_destaque_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_destaque

  function do_ajax_form_ap_eventos_publicador_mob_validate_destaque_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_destaque_cb

  // ---------- Validate foto_publicacao
  function do_ajax_form_ap_eventos_publicador_mob_validate_foto_publicacao()
  {
    var nomeCampo_foto_publicacao = "foto_publicacao";
    var var_foto_publicacao = scAjaxGetFieldText(nomeCampo_foto_publicacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_foto_publicacao(var_foto_publicacao, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_foto_publicacao_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_foto_publicacao

  function do_ajax_form_ap_eventos_publicador_mob_validate_foto_publicacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_foto_publicacao_cb

  // ---------- Validate texto_publicacao
  function do_ajax_form_ap_eventos_publicador_mob_validate_texto_publicacao()
  {
    var nomeCampo_texto_publicacao = "texto_publicacao";
    var var_texto_publicacao = scAjaxGetFieldText(nomeCampo_texto_publicacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ap_eventos_publicador_mob_validate_texto_publicacao(var_texto_publicacao, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_validate_texto_publicacao_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_validate_texto_publicacao

  function do_ajax_form_ap_eventos_publicador_mob_validate_texto_publicacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ap_eventos_publicador_mob_validate_texto_publicacao_cb

  // ---------- Event onchange cep
  function do_ajax_form_ap_eventos_publicador_mob_event_cep_onchange()
  {
    ...
    var var_texto_premiacao = scAjaxGetFieldText("texto_premiacao");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_ap_eventos_publicador_mob_event_cep_onchange(var_cep, var_cidade, var_estado, var_rua, var_bairro, var_texto_premiacao, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_event_cep_onchange_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_event_cep_onchange

  function do_ajax_form_ap_eventos_publicador_mob_event_cep_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cep";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_ap_eventos_publicador_mob_event_cep_onchange_cb
  ...
  // ---------- Form
  function do_ajax_form_ap_eventos_publicador_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ap_eventos_publicador_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_ap_eventos_publicador_mob_submit_form(var_fk_contrato, var_situacao, var_nomenclatura, var_data_criacao, var_cep, var_bairro, var_rua, var_numero, var_complemento, var_cidade, var_estado, var_abreviatura, var_pseg, var_pter, var_pqua, var_pqui, var_psex, var_psab, var_pdom, var_destaque_img, var_destaque, var_foto_publicacao, var_texto_publicacao, var_pk_publicador, var_foto_publicacao_ul_name, var_foto_publicacao_ul_type, var_foto_publicacao_salva, var_foto_publicacao_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ap_eventos_publicador_mob_submit_form_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_submit_form

  function do_ajax_form_ap_eventos_publicador_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_ap_eventos_publicador_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_ap_eventos_publicador_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_ap_eventos_publicador_mob_navigate_form(var_pk_publicador, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ap_eventos_publicador_mob_navigate_form_cb);
  } // do_ajax_form_ap_eventos_publicador_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_eventos_publicador_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ap_eventos_publicador_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_ap_eventos_publicador_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
{
?>
    do_ajax_form_ap_eventos_publicador_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_ap_eventos_publicador_mob_navigate_form_cb
  function sc_hide_form_ap_eventos_publicador_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "psab": {"label": "SÁBADO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
