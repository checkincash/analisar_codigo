...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'estado':
      case 'abreviatura':
        sc_exib_ocult_pag('form_ap_contrato_publicador_cliente_form0');
        break;
      case 'pseg':
      case 'pter':
      case 'pqua':
      ...
      case 'texto_publicacao':
        sc_exib_ocult_pag('form_ap_contrato_publicador_cliente_form1');
        break;
    }
  }
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_foto_publicacao" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_ap_contrato_publicador_cliente_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
