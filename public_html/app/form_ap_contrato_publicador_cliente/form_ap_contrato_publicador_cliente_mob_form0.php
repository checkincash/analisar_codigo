...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_abreviatura_line" id="hidden_field_data_abreviatura" style="<?php echo $sStyleHidden_abreviatura; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_abreviatura_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_abreviatura_label"><span id="id_label_abreviatura"><?php echo $this->nm_new_label['abreviatura']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['php_cmp_required']['abreviatura']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ap_contrato_publicador_cliente_mob']['php_cmp_required']['abreviatura'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
