...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_pseg' + iSeqRow).bind('blur', function() { sc_form_ap_contrato_publicador_cliente_pseg_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_ap_contrato_publicador_cliente_pseg_onfocus(this, iSeqRow) });
  $('#id_sc_field_pter' + iSeqRow).bind('blur', function() { sc_form_ap_contrato_publicador_cliente_pter_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_ap_contrato_publicador_cliente_pter_onfocus(this, iSeqRow) });
  $('#id_sc_field_pqua' + iSeqRow).bind('blur', function() { sc_form_ap_contrato_publicador_cliente_pqua_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_ap_contrato_publicador_cliente_pqua_onfocus(this, iSeqRow) });
  $('#id_sc_field_pqui' + iSeqRow).bind('blur', function() { sc_form_ap_contrato_publicador_cliente_pqui_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_ap_contrato_publicador_cliente_pqui_onfocus(this, iSeqRow) });
  $('#id_sc_field_psex' + iSeqRow).bind('blur', function() { sc_form_ap_contrato_publicador_cliente_psex_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_ap_contrato_publicador_cliente_psex_onfocus(this, iSeqRow) });
  $('#id_sc_field_psab' + iSeqRow).bind('blur', function() { sc_form_ap_contrato_publicador_cliente_psab_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_ap_contrato_publicador_cliente_psab_onfocus(this, iSeqRow) });
  $('#id_sc_field_pdom' + iSeqRow).bind('blur', function() { sc_form_ap_contrato_publicador_cliente_pdom_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_ap_contrato_publicador_cliente_pdom_onfocus(this, iSeqRow) });
  $('#id_sc_field_abreviatura' + iSeqRow).bind('blur', function() { sc_form_ap_contrato_publicador_cliente_abreviatura_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_ap_contrato_publicador_cliente_abreviatura_onfocus(this, iSeqRow) });
...
function sc_form_ap_contrato_publicador_cliente_pseg_onblur(oThis, iSeqRow) {
  do_ajax_form_ap_contrato_publicador_cliente_mob_validate_pseg();
  scCssBlur(oThis);
}

function sc_form_ap_contrato_publicador_cliente_pseg_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_ap_contrato_publicador_cliente_pter_onblur(oThis, iSeqRow) {
  do_ajax_form_ap_contrato_publicador_cliente_mob_validate_pter();
  scCssBlur(oThis);
}

function sc_form_ap_contrato_publicador_cliente_pter_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_ap_contrato_publicador_cliente_pqua_onblur(oThis, iSeqRow) {
  do_ajax_form_ap_contrato_publicador_cliente_mob_validate_pqua();
  scCssBlur(oThis);
}

function sc_form_ap_contrato_publicador_cliente_pqua_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_ap_contrato_publicador_cliente_pqui_onblur(oThis, iSeqRow) {
  do_ajax_form_ap_contrato_publicador_cliente_mob_validate_pqui();
  scCssBlur(oThis);
}

function sc_form_ap_contrato_publicador_cliente_pqui_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_ap_contrato_publicador_cliente_psex_onblur(oThis, iSeqRow) {
  do_ajax_form_ap_contrato_publicador_cliente_mob_validate_psex();
  scCssBlur(oThis);
}

function sc_form_ap_contrato_publicador_cliente_psex_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_ap_contrato_publicador_cliente_psab_onblur(oThis, iSeqRow) {
  do_ajax_form_ap_contrato_publicador_cliente_mob_validate_psab();
  scCssBlur(oThis);
}

function sc_form_ap_contrato_publicador_cliente_psab_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_ap_contrato_publicador_cliente_pdom_onblur(oThis, iSeqRow) {
  do_ajax_form_ap_contrato_publicador_cliente_mob_validate_pdom();
  scCssBlur(oThis);
}

function sc_form_ap_contrato_publicador_cliente_pdom_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_ap_contrato_publicador_cliente_abreviatura_onblur(oThis, iSeqRow) {
  do_ajax_form_ap_contrato_publicador_cliente_mob_validate_abreviatura();
  scCssBlur(oThis);
}

function sc_form_ap_contrato_publicador_cliente_abreviatura_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
