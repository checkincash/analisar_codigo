...
class menupadrao_form_php
{
   ...
   function init()
   {
      ...
      //check prod
      if(!isset($_SESSION['scriptcase']['menupadrao']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['menupadrao']['glo_nm_path_prod']))
      {
...
<?php
      ...
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['menupadrao'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_ap_contrato_updt") . "/?nm_run_menu=1&nm_apl_menu=menupadrao&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_2")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("consiste_pub") . "/?nm_run_menu=1&nm_apl_menu=menupadrao&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "&script_case_session=" . session_id() . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="menupadrao"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "menupadrao")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'menupadrao', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
SC_dir_app_ini('CheckIn');
$controle = new menupadrao_form_php();
$controle->init();
?>
