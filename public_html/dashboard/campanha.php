                                        ...
                                        <div class="x_panel">
                                            <div class="x_title">
                                                ...
                                                <ul class="nav navbar-right panel_toolbox">
                                                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                                                    <li>
                                                        <input id="chkRegAtivo" type="checkbox" <?= $checkedRegAtivo; ?> class="js-switch" title="Contrato Ativo?" disabled="disabled"/>
                                                    </li>
                                                </ul>
                                                <div class="clearfix"></div>
                                            </div>
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="x_panel">
                                    <div class="x_title">
                                        ...
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li class="pull-right">
                                                <input id="chkDestaque" type="checkbox" class="flat" <?= $checkedDestaque; ?> disabled="disabled">
                                            </li>
                                        </ul>
                                        <div class="clearfix"></div>
                                    </div>
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <div class="form-group">
                                            <textarea id="txtPubTexto" rows="4" class="form-control" placeholder="INSIRA O TEXTO"><?= $publicacao->texto_publicacao; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
