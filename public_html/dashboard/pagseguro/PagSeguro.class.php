...
class PagSeguro {
    ...
    private $email = "checkin.tecnologia@gmail.com";
    private $token_sandbox = "4B9BC3EBE58548CC87D0FDC1353A384F";
    private $token_oficial = "3BE2D67982F449EBAE8C4D27B2D96926";
    private $url_retorno = "";
    //URL OFICIAL
...
//            return $this->url_redirect . $dados['codigo_pagseguro'];
//        }
...
//            exit;
        ...
        return $this->url_redirect . $xml_obj->code;
    }
