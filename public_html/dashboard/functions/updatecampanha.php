...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $publicacao = $contratoPubDAO->select('*', "fk_contrato = ".$_SESSION['dash_contrato']->pk_contrato)->fetch(PDO::FETCH_OBJ);
    ...
    $contratoPub->situacao = $publicacao->situacao;
    $contratoPub->destaque = $publicacao->destaque;
    ...
    $contratoPub->abreviatura = $publicacao->abreviatura;
    ...
    if(!empty($imagem)) {
        $pastaImg = "../../app/_lib/file/img/imagempub/".$_SESSION['dash_contrato']->cnpj;
