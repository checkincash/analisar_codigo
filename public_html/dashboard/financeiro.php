...
$lancamentos = $financeiroDAO->select('*', "contrato = $contrato->pk_contrato AND status <= 1")->fetchAll(PDO::FETCH_OBJ);
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
                                        ...
                                        <tr>
                                            ...
                                            <?  if($lancamento->status == 0) { ?>
                                                <form method="POST" target="pagseguro" action="https://sandbox.pagseguro.uol.com.br/v2/checkout/payment.html">
                                                    ...
                                                    <input name="itemDescription1" type="hidden" value="<?= $lancamento->referencia." ". date('Y-m', strtotime($lancamento->vencimento)); ?> CHECK-INcash">  
