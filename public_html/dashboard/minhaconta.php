...
<html lang="pt-br">
    <head>
        ...
        <title>CHECK-INcash | Minha Conta</title>
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <form class="form-horizontal form-label-left input_mask">
                                                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                            <input type="text" class="form-control has-feedback-left" id="txtCNPJ" placeholder="CNPJ" value="<?= $contrato->cnpj; ?>" data-inputmask="'mask': '(999.999.999-99)|(99.999.999/9999-99)', 'keepStatic': true" readonly="true">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                            <input type="text" class="form-control has-feedback-left" id="txtRazao" placeholder="Razão Social" value="<?= $contrato->razao; ?>" readonly="true">
                                                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                                        </div>
                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        ...
                                        <ul class="nav navbar-right panel_toolbox">
                                            ...
                                            <li>
                                                <input id="chkAtivo" type="checkbox" <?= $checkedAtivo; ?> class="js-switch" title="Contrato Ativo?" disabled="disabled"/>
                                            </li>
                                        </ul>
                                        <div class="clearfix"></div>
                                    </div>
                                    ...
                                    <div class="x_content">
                                        <div class="col-xs-12">
                                            <form class="form-horizontal form-label-left input_mask">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                    <input type="text" class="form-control" id="txtCEP" placeholder="CEP" value="<?= $contrato->cep; ?>" data-inputmask="'mask': '99999-999'" readonly="true">
                                                </div>

                                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                                    <input type="text" class="form-control" id="txtBairro" placeholder="BAIRRO" value="<?= $contrato->bairro; ?>" readonly="true">
                                                </div>

                                                <div class="col-sm-8 col-xs-12 form-group has-feedback">
                                                    <input type="text" class="form-control" id="txtRua" placeholder="RUA" value="<?= $contrato->rua; ?>" readonly="true">
                                                </div>

                                                <div class="col-sm-4 col-xs-12 form-group has-feedback">
                                                    <input type="text" class="form-control" id="txtNumero" placeholder="Nº" value="<?= $contrato->numero; ?>" readonly="true">
                                                </div>

                                                <div class="col-sm-8 col-xs-12 form-group has-feedback">
                                                    <input type="text" class="form-control" id="txtCidade" placeholder="CIDADE" value="<?= $contrato->cidade; ?>" readonly="true">
                                                </div>

                                                <div class="col-sm-4 col-xs-12 form-group has-feedback">
                                                    <input type="text" class="form-control" id="txtEstado" placeholder="ESTADO" value="<?= $contrato->estado; ?>" readonly="true">
                                                </div>

                                                <div class="col-xs-12 form-group has-feedback">
                                                    <input type="text" class="form-control" id="txtComplemento" placeholder="COMPLEMENTO" value="<?= $contrato->complemento; ?>" readonly="true">
                                                </div>
