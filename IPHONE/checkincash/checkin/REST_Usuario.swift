...
class REST{
    ...
    // Recupera ID
    class func loadUsersID(onComplete: @escaping ([Usuario]) -> Void, onError: @escaping (listERROR) ->Void){
        
        
        guard let url = URL(string: usuarioPathReadOne + "?email=" + "lolo@lolo.com.br") else {
