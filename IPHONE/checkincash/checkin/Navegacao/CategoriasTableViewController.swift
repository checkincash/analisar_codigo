...
class CategoriasTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
       ...
       let url: URL = URL(string: "https://www.checkincash.com.br/api/lojas/recupera_categorias.php")!
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let categoriaReuso = "categoriaReuso"
        let cell = tableView.dequeueReusableCell(withIdentifier: categoriaReuso, for: indexPath)

        let item = self.listData[indexPath.row]
        cell.textLabel?.text = item["descricao"] as? String
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        tableView.deselectRow(at: indexPath, animated: true)
         ...
         // Atualiza o arquivo de preferencias do usuário
         let item = self.listData[indexPath.row]
         let categoria = item["pk_classificacao"] as? String
         arquivodeconfiguracoes.codigocategoria = Int( categoria! )!
    }
